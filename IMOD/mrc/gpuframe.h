...
class FrameGPU {
 ...
 private:
  ...
  int mBindTexForSums;        // Flag to bind textures to summing arrays
  int mMaxTex1D;              // Maximum elements in 1D texture
  ...
  int mAvgRowColSuperFac;     // Super-res factor for averaging pad of bad row/column
...
// Be sure to add new items to noframegpu.h
extern "C" {
