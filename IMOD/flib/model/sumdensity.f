...
c       
     ...
     &    call exitError ('READING MODEL FILE')
      allocate(insideIndex(max_obj_num), insideCont(max_obj_num), levels(max_obj_num),
     &    iSurface(max_obj_num), stat = ierr)
