...
program tiltxcorr
  ...
  integer*4 niceFrame, newImod, putImodMaxes, putModelName, putImageRef, numberInList
  ...
  options(1) = &
      ...
      'reference:ReferenceFile:FN:@rview:ReferenceView:I:@'// &
      'second:SecondPeakBoxSize:IP:@size:SizeOfPatchesXandY:IP:@'// &
