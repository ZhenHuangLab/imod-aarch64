                                ...
                                int inside, int bco, int tco)
{
  ...
  /* Single or 2-point close contours cannot be meshed to each other; two single-point
     open contours cannot be meshed */
  if ((!openObj && tdim < 3 && bdim < 3) || (openObj && tdim < 2 && bdim < 2))
    return NULL;
