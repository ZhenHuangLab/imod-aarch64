...
[[]]
if.not.var.clear-view.bn.show-min/max-for-raw-stack=
if.not.var.clear-view.wait.process.clip-stats=done
bn.create-fixed-stack=
wait.process.ccd-eraser=done
if.not.var.clear-view.bn.show-min/max-for-fixed-stack=
if.not.var.clear-view.wait.process.clip-stats=done
...
assert.exists.file=%{dataset}%{axis}_peak.mod~
# Run 3dmod
if.not.var.clear-view.bn.view-x-ray-model=
# Check values
...
# Run 3dmod
if.not.var.clear-view.bn.create-manual-replacement-model=
cb.manual-replacement=off
