...
[[]]
bn.directory=
file-chooser.directory=%{testdir}
[[if = test-gui]]
...
assert.exists.file=%{dataset}_AvgVol_1P3.mrc
assert.exists.file=%{dataset}_Ref2.mrc
assert.exists.file=unMasked%{dataset}_Ref1.mrc
...
file-chooser.volume=%{dataset}-a.rec
bn.volume-table-1-model=
file-chooser.model=%{dataset}-a.mod
...
file-chooser.volume=%{dataset}-b.rec
bn.volume-table-3-model=
file-chooser.model=%{dataset}-b.mod
...
file-chooser.initial-motl=%{dataset}-a-initMOTL.csv
bn.volume-table-2-initial=
file-chooser.initial-motl=%{dataset}-b-initMOTL.csv
...
[[if = test-gui]]
  ...
  #value is copied from spinner to text field when text field is empty
  assert.tf.in-volume=2
  cb.file-names-are-templates=off
  sp.in-volume=3
  cb.file-names-are-templates=on
  assert.tf.in-volume=2
...
[[if = test-gui]]
  ...
  bn.remake-averages=
	...
	if.not.var.clear-view.bn.open-averages-in-3dmod=
[[]]
...
file-chooser.user-supplied-file=unMasked%{dataset}_Ref1.mrc
...
file-chooser.user-supplied-binary-file=unMasked%{dataset}_Ref1.mrc
