...
public final class DatasetFiles {
  ...
  public static final String PATCH_VECTOR_CCC_MODEL =
    PATCH_VECTOR_STRING + "_ccc" + MODEL_EXT;
   ...
   * @deprecated 5/9/2019
   */
  private static final String FULL_ALIGNED_EXT = ".ali";
  public static final String CTF_PLOTTER_EXT = ".defocus";
  public static final String SIMPLE_DEFOCUS_EXT = "_simple" + CTF_PLOTTER_EXT;
  /**
   * @deprecated 5/9/2019
   */
  private static final String CTF_CORRECTION_EXT = "_ctfcorr" + FULL_ALIGNED_EXT;
  ...
  public static File getOriginalStack(BaseManager manager, AxisID axisID) {
    ...
    return FileType.ORIGINAL_RAW_STACK.getFile(manager, axisID);
  }

  public static File getStack(BaseManager manager, AxisID axisID) {
    return getStack(manager, manager.getPropertyUserDir(), manager.getBaseMetaData(),
      axisID);
  }

  public static File getStack(final BaseManager manager, String propertyUserDir,
    BaseMetaData metaData, AxisID axisID) {
    return new File(propertyUserDir, getStackName(manager, metaData, axisID));
  }

  public static String getStackName(BaseManager manager, AxisID axisID) {
    return getStackName(manager, manager.getBaseMetaData(), axisID);
  }

  private static String getStackName(final BaseManager manager, BaseMetaData metaData,
    AxisID axisID) {
    return FileType.RAW_STACK.getFileName(manager, axisID);
  }
  ...
  /**
   * @deprecated 7/14/19 unused function
   * @param manager
   * @param axisID
   * @return
   */
  public static String getTomogramName(BaseManager manager, AxisID axisID) {
    return FileType.TILT_OUTPUT.getFileName(manager, axisID);
  }

  public static File getTomogram(BaseManager manager, AxisID axisID) {
    return FileType.TILT_OUTPUT.getFile(manager, axisID);
  }
  ...
  public static File getRotatedTomogram(BaseManager manager, File tomogram) {
    ...
    return new File(manager.getPropertyUserDir(),
      tomogramName.substring(0, tomogramName.lastIndexOf('.')) + ROTATED_TOMO_EXT);
  }
  ...
  public static File getDatasetFile(BaseManager manager, AxisID axisID, String fileExt) {
    ...
    axisID = correctAxisID(metaData, axisID);
    return new File(manager.getPropertyUserDir(),
      metaData.getName() + axisID.getExtension() + fileExt);
  }
  ...
  public static String getPrealignedStackName(BaseManager manager, AxisID axisID) {
    BaseMetaData metaData = manager.getBaseMetaData();
    return FileType.PREALIGNED_STACK.getFileName(manager, axisID);
  }
  ...
  public static File getRaptorFiducialModel(BaseManager manager, AxisID axisID) {
    return new File(manager.getPropertyUserDir(),
      getRaptorFiducialModelName(manager, axisID));
  }
  ...
  public static String getJoinFileName(boolean trial, BaseManager manager) {
    if (trial) {
      return FileType.TRIAL_JOIN.getFileName(manager, AxisID.ONLY);
    }
    return FileType.JOIN.getFileName(manager, AxisID.ONLY);
  ...
  public static File getMatlabParamFile(BaseManager manager) {
    return new File(manager.getPropertyUserDir(),
      manager.getBaseMetaData().getName() + MATLAB_PARAM_FILE_EXT);
  }
  ...
  /**
  * @deprecated 7/13/2020 unnecessary function
  * @param manager
  * @return
  */
  public static String getModeledJoinFileName(BaseManager manager) {
    return FileType.MODELED_JOIN.getFileName(manager, AxisID.ONLY);
  ...
  public static File getModeledJoinFile(JoinManager manager) {
    return FileType.MODELED_JOIN.getFile(manager, AxisID.ONLY);
   ...
   * @deprecated 5/9/2019
   */
  private static String getFullAlignedStackFileName(BaseManager manager, AxisID axisID) {
    BaseMetaData metaData = manager.getBaseMetaData();
    axisID = correctAxisID(metaData, axisID);
   ...
   * @deprecated 5/9/2019
   */
  private static String getErasedFiducialsFileName(BaseManager manager, AxisID axisID) {
    BaseMetaData metaData = manager.getBaseMetaData();
    axisID = correctAxisID(metaData, axisID);
   ...
   * @deprecated 5/9/2019
   */
  private static String getErasedFiducialsFileExtension() {
   ...
   * @deprecated 5/9/2019
   */
  private static String getCtfCorrectionFileName(BaseManager manager, AxisID axisID) {
    BaseMetaData metaData = manager.getBaseMetaData();
    axisID = correctAxisID(metaData, axisID);
  ...
  public static File getCtfCorrectionFile(BaseManager manager, AxisID axisID) {
    return new File(manager.getPropertyUserDir(),
      getCtfCorrectionFileName(manager, axisID));
  }
  ...
  public static File getShellScript(BaseManager manager, String commandName,
    ...
    return new File(manager.getPropertyUserDir(),
      commandName + axisID.getExtension() + ".csh");
  }
  ...
  public static File getCalibrationDir(BaseManager manager, String propertyUserDir,
    ...
    if (calibrationDir == null) {
      String calibDirVar = EnvironmentVariable.INSTANCE.getValue(manager, propertyUserDir,
        EnvironmentVariable.CALIB_DIR, axisID);
