...
public final class SerialSectionsStartupData {
  ...
  private boolean mdocMetadataFileStatus = false;
  ...
  public void setMdocMetadataFileStatus(final boolean input) {
    mdocMetadataFileStatus = input;
  }
  ...
  public void getBlendParameters(final BlendmontParam param, final BaseManager manager) {
    ...
    param.setImageInputFile(FileType.PREBLEND_OUTPUT_MRC.deriveFileName(getRootName(),
      AxisType.SINGLE_AXIS, AxisID.ONLY, metaData.getImageFilenameStyle(),
      metaData.getRawImageStackExtension()));
  ...
  private void getParameters(final BlendmontParam param, final BaseManager manager) {
    ...
    BaseMetaData metaData = manager.getBaseMetaData();
    param.setPieceListInput(
      FileType.PIECE_LIST.deriveFileName(getRootName(), AxisType.SINGLE_AXIS, AxisID.ONLY,
  ...
  public File getParamFile() {
    ...
    return new File(stack.getParentFile(),
      rootName + DataFileType.SERIAL_SECTIONS.extension);
  }
  ...
  public boolean getMdocMetadataFile() {
    return mdocMetadataFileStatus;
  }
