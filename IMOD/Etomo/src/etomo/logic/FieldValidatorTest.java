...
public class FieldValidatorTest extends TestCase {
  ...
  private static final String POSITIVE_ELEMENT_MSG =
    "NumberMustBePostive effects elements now";
  ...
  public void testValidateString() {
    ...
    testValidateNumberMustBePositive(INT_ZERO, fieldType, false, null,
      POSITIVE_ELEMENT_MSG);
    testValidateNumberMustBePositive(INT_NEG, fieldType, false, null,
      POSITIVE_ELEMENT_MSG);
    ...
    testValidate(INT_PAIR_INVALID_NUMBER0, fieldType, true, INT_PAIR_INVALID_NUMBER0,
      msg);
    ...
    testValidate(INT_ARRAY_INVALID_NUMBER, fieldType, true, INT_ARRAY_INVALID_NUMBER,
      msg);
  ...
  public void testValidateInteger() {
    ...
    testValidateMinimum(-1, "-2", fieldType, false, null, "min must be <= to value");
    testValidateMinimum(1, " 2", fieldType, true, "2", "min must be <= to value");
    testValidateMaximum(1, "2", fieldType, false, null, "max must be >= to value");
    testValidateMaximum(1, "-2 ", fieldType, true, "-2", "max must be >= to value");
  }
  ...
  public void testValidateFloatingPoint() {
    ...
    testValidateMinimum(-1.2, ".3", fieldType, false, null, "min must be <= to value");
    testValidateMinimum(1.2, " 3.4", fieldType, true, "3.4", "min must be <= to value");
    testValidateMaximum(1, "2.3", fieldType, false, null, "max must be >= to value");
    testValidateMaximum(1, ".2 ", fieldType, true, ".2", "max must be >= to value");
  }
  ...
  public void testValidateIntegerPair() {
    ...
    testValidateMinimum(-1, "2,-3", fieldType, false, null, "min must be <= to value");
    testValidateMinimum(1, " 2,3", fieldType, true, "2,3", "min must be <= to value");
    testValidateMaximum(1, "-2,3", fieldType, false, null, "max must be >= to value");
    testValidateMaximum(1, "-2,-3 ", fieldType, true, "-2,-3", "max must be >= to value");
  }
  ...
  public void testValidateFloatingPointArray() {
    ...
    testValidate(INT_ARRAY_IGNORED_SYNTAX_ERROR, fieldType, true,
      INT_ARRAY_IGNORED_SYNTAX_ERROR.trim(), IGNORED_SYNTAX_ERROR_MSG);
    testValidate(INT_ARRAY_INVALID_FLOAT, fieldType, true, INT_ARRAY_INVALID_FLOAT.trim(),
      VALID_ARRAY_MSG);
    testValidate(INT_ARRAY_INVALID_NUMBER, fieldType, false, null, INVALID_NUMBER_MSG);
    testValidate(LIST_EMPTY, fieldType, false, null, ARRAY_SYNTAX_MSG);
    testValidate(INT_LIST, fieldType, false, null, ARRAY_SYNTAX_MSG);
  ...
  public void testValidateIntegerList() {
    ...
    testValidate(INT_LIST_INVALID_FLOAT, fieldType, false, null,
      FLOAT_NOT_COMPATIBLE_MSG);
  ...
  private void testValidate(final String testString, final FieldType fieldType,
    ...
    try {
      if (shouldSucceed) {
        assertEquals(msg, outputString, FieldValidator.validateText(testString, fieldType,
  ...
  private void testValidateRequired(final String testString, final FieldType fieldType,
    ...
    try {
      if (shouldSucceed) {
        ...
        FieldValidator.validateText(testString, fieldType, null, null, true, false, false,
          null, null);
      }
    }
    catch (FieldValidationFailedException e) {
  ...
  private void testValidateNumberMustBePositive(final String testString,
    ...
    final String msg) {
    ValidationSet validationSet = new ValidationSet(fieldType);
    validationSet.setNumberMustBePositive(true);
    try {
      if (shouldSucceed) {
        assertEquals(msg, outputString, FieldValidator.validateText(testString, fieldType,
          null, null, false, false, false, validationSet, null));
      }
      else {
        FieldValidator.validateText(testString, fieldType, null, null, false, false,
          false, validationSet, null);
      }
    }
    catch (FieldValidationFailedException e) {
      if (shouldSucceed) {
  ...
  private void testValidateMinimum(final double min, final String testString,
    final FieldType fieldType, final boolean shouldSucceed, final String outputString,
    final String msg) {
    ValidationSet validationSet = new ValidationSet(fieldType);
    validationSet.setMinimum(min);
    try {
      if (shouldSucceed) {
        assertEquals(msg, outputString, FieldValidator.validateText(testString, fieldType,
          null, null, false, false, false, validationSet, null));
  ...
  private void testValidateMaximum(final int max, final String testString,
    final FieldType fieldType, final boolean shouldSucceed, final String outputString,
    final String msg) {
    ValidationSet validationSet = new ValidationSet(fieldType);
    validationSet.setMaximum(max);
    try {
      if (shouldSucceed) {
        assertEquals(msg, outputString, FieldValidator.validateText(testString, fieldType,
          null, null, false, false, false, validationSet, null));
