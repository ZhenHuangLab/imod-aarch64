...
* <p> $Log$ </p>
*/
public class Directive implements DirectiveInterface {
  ...
  private final DirectiveDescrChoiceList choiceList;
  ...
  void write(final LogFile logFile, LogFile.WriterId id)
  ...
  static final class BooleanValue extends Value {
    ...
    public boolean equals(final BooleanValue input) {
      if (debug.isExtra()) {
  ...
  static final class NumericValue extends Value {
    ...
    public boolean equals(final NumericValue input) {
      if (input == null) {
        return value.isNull();
      }
  ...
  static final class NumericPairValue extends Value {
    ...
    public boolean equals(final NumericPairValue input) {
      if (input == null) {
        return value.isNull();
      }
      return value.equals(input.value);
  ...
  static final class StringValue extends Value {
    ...
    public boolean equals(final StringValue input) {
    ...
    public void set(double[] input) {
      if (input == null) {
        ...
        StringBuffer buffer = new StringBuffer();
        for (int i = 0; i < input.length; i++) {
          buffer.append((i > 0 ? "," : "") + (input[i] == EtomoNumber.INTEGER_NULL_VALUE
            ? " " : String.valueOf(input[i])));
        }
        if (buffer.length() > 0) {
