...
final class Comment extends Statement {
  ...
  void wrapValue(final String noWrapPrefix, final String wrapPrefix, final String divider,
    final String defaultDivider, final int minLength, final int wrapLength) {}
  ...
  public String getString() {
    ...
    return AutodocTokenizer.COMMENT_CHAR + "";
  }
