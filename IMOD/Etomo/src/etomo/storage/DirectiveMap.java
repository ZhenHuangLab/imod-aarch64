...
* <p> $Log$ </p>
*/
public final class DirectiveMap implements DirectiveMapInterface {
  ...
  public Directive getDirective(final DirectiveDef directiveDef) {
    if (directiveDef == null) {
      return null;
    }
    return map.get(directiveDef.getStandardKey());
  }

  public Directive getDirectiveFromPair(final DirectiveDef directiveDef,
    final AxisID pairAxisID) {
    if (directiveDef == null) {
      return null;
    }
    return map.get(directiveDef.switchStandardKey(pairAxisID));
  }
