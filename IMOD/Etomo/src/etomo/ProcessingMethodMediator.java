...
public final class ProcessingMethodMediator {
  ...
  public ProcessingMethod
    getRunMethodForParallelPanel(final ProcessingMethod parallelPanelMethod) {
    if (processInterface != null) {
  ...
  public ProcessingMethod
    getSecondaryRunMethodForParallelPanel(final ProcessingMethod parallelPanelMethod) {
    if (processInterface != null) {
   ...
   */
  public ProcessingMethod
    getRunMethodForProcessInterface(final ProcessingMethod processInterfaceMethod) {
    if (parallelPanel != null) {
