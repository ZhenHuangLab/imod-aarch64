...
public final class ToolsProcessManager extends BaseProcessManager {
  ...
  public String gpuTiltTest(GpuTiltTestParam param, AxisID axisID)
    ...
    BackgroundProcess backgroundProcess =
      startBackgroundProcess(param.getCommand(), axisID, ProcessName.GPU_TILT_TEST, null);
  ...
  public String flatten(final WarpVolParam param, final AxisID axisID,
    ...
    final FileType fileType) throws AxisBusyException {
    ...
    Matchvol1ProcessMonitor monitor =
      Matchvol1ProcessMonitor.getFlattenInstance(manager, axisID, fileType);
  ...
  public String flattenWarp(final FlattenWarpParam param,
    final ProcessResultDisplay processResultDisplay, final ProcessSeries processSeries,
    final AxisID axisID) throws AxisBusyException {
