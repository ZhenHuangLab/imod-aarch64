...
/**
 * <p>Description: process monitor for xcorr</p>
 * 
...
class XcorrProcessWatcher implements ProcessMonitor {
   ...
   * @param id
   */
  XcorrProcessWatcher(ApplicationManager applicationManager, AxisID axisID,
    boolean blendmont) {
    this.applicationManager = applicationManager;
    this.axisID = axisID;
    this.blendmont = blendmont;
    busyStatusMediator = applicationManager.getBusyStatusMediator();
  ...
  public void run() {
    ...
    TiltxcorrProcessWatcher tiltxcorrMonitor =
      new TiltxcorrProcessWatcher(applicationManager, axisID, blendmont);
