 ...
 */
 ...
 class VolcombineProcessMonitor extends LogFileProcessMonitor {
   ...
   * @param id
   */
   VolcombineProcessMonitor(BaseManager manager, AxisID id) {
    super(manager, id);
   ...
   * sections
   */
   void findNSections() throws InterruptedException, LogFile.LockException,
      IOException {
