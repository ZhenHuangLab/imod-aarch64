...
class PrenewstProcessMonitor extends FileSizeProcessMonitor {
  public static final String rcsid =
    "$Id$";

  private final ApplicationManager applicationManager;

  PrenewstProcessMonitor(ApplicationManager appMgr, AxisID id) {
  ...
  boolean calcFileSize() throws InvalidParameterException, IOException {
    ...
    MRCHeader rawStack = MRCHeader.getInstance(manager, axisID, FileType.RAW_STACK);
  ...
  void reloadWatchedFile() {
    ...
    watchedFile = FileType.PREALIGNED_STACK.getFile(manager, axisID);
  }
}