 ...
 * @version $Revision$
 */
 class IntermittentSystemProgram {
  ...
  private IntermittentSystemProgram(BaseManager manager, String propertyUserDir,
   ...
   static IntermittentSystemProgram getStartInstance(BaseManager manager,
   ...
   * @return
   */
   static IntermittentSystemProgram getIntermittentInstance(BaseManager manager,
  ...
  void setAcceptInputWhileRunning(boolean acceptInputWhileRunning) {
   ...
   void setCurrentStdInput(String input) throws IOException {
   ...
   */
   String[] getStdError(IntermittentProcessMonitor monitor) {
    return program.getStdError(monitor);
  }

   void msgDroppedMonitor(IntermittentProcessMonitor monitor) {
