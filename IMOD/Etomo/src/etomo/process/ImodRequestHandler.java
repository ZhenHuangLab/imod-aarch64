...
class ImodRequestHandler implements Runnable {
  ...
  //one instance per ImodManager
   final static Hashtable instances = new Hashtable();

  private final BaseImodManager imodManager;
  private boolean stop = false;
  private boolean running = true;

  private ImodRequestHandler(BaseImodManager imodManager) {
    this.imodManager = imodManager;
  }

  static ImodRequestHandler getInstance(BaseImodManager imodManager) {
