...
public final class ParallelManager extends BaseManager {
  ...
  public ParallelManager(final String paramFileName, final DialogType dialogType) {
    super();
    this.metaData =
      new ParallelMetaData(this, getLogProperties(), dialogType == DialogType.PARALLEL,
  ...
  boolean startNextProcess(final UIComponent uiComponent, final AxisID axisID,
    ...
    ProcessSeries processSeries, final DialogType dialogType, ProcessDisplay display) {
  ...
  public void openParallelDialog() {
    ...
    String actionMessage =
      Utilities.prepareDialogActionMessage(DialogType.PARALLEL, AxisID.ONLY, null);
  ...
  public void openAnisotropicDiffusionDialog() {
    ...
    String actionMessage = Utilities
      .prepareDialogActionMessage(DialogType.ANISOTROPIC_DIFFUSION, AxisID.ONLY, null);
    if (actionMessage != null) {
      System.err.println(actionMessage);
    }
  }
  ...
  public final void processchunks(final ProcessResultDisplay processResultDisplay,
    ...
    ProcesschunksParam param =
      new ProcesschunksParam(this, AxisID.ONLY, rootName, outputImageFileType);
  ...
  private AnisotropicDiffusionParam updateAnisotropicDiffusionParamForVaryingK(
    ...
    AnisotropicDiffusionParam param =
      new AnisotropicDiffusionParam(this, AnisotropicDiffusionParam.Mode.VARYING_K);
  ...
  private AnisotropicDiffusionParam updateAnisotropicDiffusionParam(
    ...
    AnisotropicDiffusionParam param =
      new AnisotropicDiffusionParam(this, AnisotropicDiffusionParam.Mode.FULL);
    if (!anisotropicDiffusionDialog.getParameters(param, doValidation)) {
      return null;
    }
  ...
  public boolean setupAnisotropicDiffusion(final boolean doValidation) {
    try {
      ...
      e.printStackTrace();
      uiHarness.openMessageDialog(this,
        "Anisotropic diffusion comscripts could not be created", "Write Comscript Error",
        AxisID.ONLY);
      return false;
    }
    catch (IOException e) {
  ...
  public void anisotropicDiffusionVaryingIteration(final String subdirName,
    ...
    AnisotropicDiffusionParam param =
      updateAnisotropicDiffusionParamForVaryingIteration(subdirName, true);
    if (param == null) {
      if (processSeries != null) {
        processSeries.endSeries();
      }
  ...
  private boolean validateTestVolume(AnisotropicDiffusionParam param) {
    ...
    try {
      ...
      long size =
        Math.round(testVolumeHeader.getNColumns() / 1024.0 * testVolumeHeader.getNRows()
          * testVolumeHeader.getNSections() * ChunksetupParam.MEMORY_TO_VOXEL / 1024.0);
      if (size > 0 && size > anisotropicDiffusionDialog.getMemoryPerChunk().intValue()) {
        UIHarness.INSTANCE.openMessageDialog(this,
          "Processing this test volume would require " + size
            ...
            + AnisotropicDiffusionDialog.MEMORY_PER_CHUNK_LABEL + "\" spinner in the "
  ...
  public void anisotropicDiffusionVaryingK(final String subdirName,
    ...
    try {
      anisotropicDiffusionParam =
        updateAnisotropicDiffusionParamForVaryingK(subdirName, true);
    ...
    ProcesschunksParam param =
      new ProcesschunksParam(this, AxisID.ONLY, ProcessName.ANISOTROPIC_DIFFUSION, null);
  ...
  private boolean setNewParamFile() {
    ...
    if (workingDir.endsWith(" ")) {
      uiHarness.openMessageDialog(this,
        "The directory, " + workingDir + ", cannot be used because it ends with a space.",
        "Unusable Directory Name", AxisID.ONLY);
      return false;
    }
