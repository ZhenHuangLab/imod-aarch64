...
public final class PanelHeader implements Expandable, ConstPanelHeaderSettings {
  ...
  private boolean saveMoreLessState = true;

  public static PanelHeader getInstance(final String title, final Expandable expandable,
  ...
  public static PanelHeader getAdvancedBasicInstance(final String title,
  ...
  public static PanelHeader getAdvancedBasicInstance(final String title,
    ...
    return new PanelHeader(title, expandable, true, false, dialogType, true,
      globalAdvancedButton, true, false, true);
  }
  ...
  static PanelHeader getAdvancedBasicOnlyInstance(final String title,
    ...
    return new PanelHeader(title, expandable, true, false, dialogType, false,
      globalAdvancedButton, true, emptyWhenBasic, true);
  }

  static PanelHeader getAdvancedBasicOnlyNoSeparatorInstance(final String title,
    final Expandable expandable, final DialogType dialogType,
    final GlobalExpandButton globalAdvancedButton, final boolean emptyWhenBasic) {
    return new PanelHeader(title, expandable, true, false, dialogType, false,
      globalAdvancedButton, true, emptyWhenBasic, false);
  }
  ...
  private PanelHeader(final String title, final Expandable expandable,
    ...
    final boolean titled, final boolean emptyWhenBasic, final boolean useSeparator) {
    ...
    if (openClose) {
      ...
      btnOpenClose =
        ExpandButton.getExpandedInstance(expandable, this, ExpandButton.Type.OPEN);
    ...
    if (moreLess) {
      ...
      constraints.weighty = 0.0;
      btnMoreLess =
        ExpandButton.getExpandedInstance(expandable, null, ExpandButton.Type.MORE);
  ...
  void setText(final String text) {
    ...
    setNameFromText(text);
  }

  void setText(final String text, final String additionalText) {
    cellTitle.setText(text + " " + additionalText);
    setNameFromText(text);
  }

  private void setNameFromText(final String text) {
    if (btnOpenClose != null) {
      btnOpenClose.setName(text);
    }
    if (btnAdvancedBasic != null) {
      btnAdvancedBasic.setName(text);
    }
    if (btnMoreLess != null) {
      btnMoreLess.setName(text);
    }
  }
  ...
  public boolean equalsOpenClose(final ExpandButton button) {
    return button == btnOpenClose;
  }

  public boolean equalsAdvancedBasic(final ExpandButton button) {
  ...
  public void getState(final PanelHeaderState state) {
    if (state == null) {
      return;
    }
    if (btnOpenClose != null) {
    ...
    if (btnMoreLess != null && saveMoreLessState) {
   ...
   * @param state
   */
  public void setState(final ConstPanelHeaderState state) {
    if (state == null) {
      return;
    }
    if (btnOpenClose != null) {
  ...
  void setSaveMoreLessState(final boolean input) {
    saveMoreLessState = input;
  }
  ...
  void setButtonStates(final BaseScreenState screenState, final boolean defaultIsOpen) {
    ...
    if (btnOpenClose != null) {
      btnOpenClose.setButtonState(screenState
        .getButtonState(btnOpenClose.createButtonStateKey(dialogType), defaultIsOpen));
    }
    if (btnAdvancedBasic != null) {
      btnAdvancedBasic.setButtonState(
        screenState.getButtonState(btnAdvancedBasic.createButtonStateKey(dialogType)));
    }
    if (btnMoreLess != null && saveMoreLessState) {
      btnMoreLess.setButtonState(
        screenState.getButtonState(btnMoreLess.createButtonStateKey(dialogType)));
    }
  }
