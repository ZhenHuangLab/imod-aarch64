 ...
 * <p> </p>
 */
 final class SectionTableRow implements Highlightable {
   ...
   * @param rowNumber
   */
   SectionTableRow(JoinManager manager, SectionTablePanel table, int rowNumber,
   ...
   SectionTableRow(JoinManager manager, SectionTablePanel table,
 ...
 void selectHighlightButton() {
   highlighterButton.setSelected(true);
 }
  ...
  String getInvalidReason() {
   ...
   boolean equalsSetupSection(File section) {
   ...
   boolean equalsJoinSection(File section) {
  ...
  public boolean equals(ConstSectionTableRowData thatData) {
   ...
   boolean equalsSample(ConstSectionTableRowData thatData) {
    retrieveData(false);
