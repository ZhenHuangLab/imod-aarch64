 ...
 * <p>Description: </p>
 *
 * <p>Copyright: Copyright (c) 2002 - 2016 by the Regents of the University of Colorado</p>
 * 
 ...
 * <p> </p>
 */
public final class BeadtrackPanel
  implements Expandable, Run3dmodButtonContainer, BeadTrackDisplay {
  ...
  private final LabeledTextField ltfViewSkipList =
    new LabeledTextField(FieldType.INTEGER_LIST, VIEW_SKIP_LIST_LABEL + ": ");
  private final LabeledTextField ltfAdditionalViewSets =
    new LabeledTextField(FieldType.INTEGER_LIST, "Separate view groups: ");
  private final LabeledTextField ltfTiltAngleGroupSize =
    new LabeledTextField(FieldType.INTEGER, "Tilt angle group size: ");
  private final LabeledTextField ltfTiltAngleGroups =
    new LabeledTextField(FieldType.INTEGER_TRIPLE, "Non-default tilt angle groups: ");
  private final LabeledTextField ltfMagnificationGroupSize =
    new LabeledTextField(FieldType.INTEGER, "Magnification group size: ");
  private final LabeledTextField ltfMagnificationGroups =
    new LabeledTextField(FieldType.INTEGER_TRIPLE, "Non-default magnification groups: ");
  private final LabeledTextField ltfNMinViews =
    new LabeledTextField(FieldType.INTEGER, "Minimum # of views for tilt alignment: ");
  private final LabeledTextField ltfBeadDiameter =
    new LabeledTextField(FieldType.FLOATING_POINT, "Unbinned bead diameter: ");
  private final CheckBox cbLightBeads = new CheckBox(LIGHT_BEADS_LABEL);
  CheckBox cbFillGaps = new CheckBox("Fill seed model gaps");
  private final LabeledTextField ltfMaxGap =
    new LabeledTextField(FieldType.INTEGER, "Maximum gap size: ");
  ...
  private final LabeledTextField ltfSearchBoxPixels =
    new LabeledTextField(FieldType.INTEGER_PAIR, "Search box size (pixels): ");
  private final LabeledTextField ltfMaxFiducialsAvg =
    new LabeledTextField(FieldType.INTEGER, "Maximum # of views for fiducial avg.: ");
  private final LabeledTextField ltfFiducialExtrapolationParams =
    new LabeledTextField(FieldType.INTEGER_PAIR, "Fiducial extrapolation limits: ");
  private final LabeledTextField ltfRescueAttemptParams =
    new LabeledTextField(FieldType.FLOATING_POINT_PAIR, "Rescue attempt criteria: ");
  ...
  private final LabeledTextField ltfRescueRelaxtionParams =
    new LabeledTextField(FieldType.FLOATING_POINT_PAIR, "Rescue relaxation factors: ");
  ...
  private final LabeledTextField ltfMeanResidChangeLimits =
    new LabeledTextField(FieldType.INTEGER_PAIR, "Residual change limits: ");
  private final LabeledTextField ltfDeletionParams =
    new LabeledTextField(FieldType.FLOATING_POINT_PAIR, "Deletion residual parameters: ");
  private final LabeledTextField ltfDensityRelaxationPostFit =
    new LabeledTextField(FieldType.FLOATING_POINT, "Second pass density relaxation: ");
  ...
  private final LabeledTextField ltfLocalAreaTargetSize =
    new LabeledTextField(FieldType.INTEGER, "Local area size: ");
  private final LabeledTextField ltfMinBeadsInArea =
    new LabeledTextField(FieldType.INTEGER, "Minimum beads in area: ");
  private final LabeledTextField ltfMinOverlapBeads =
    new LabeledTextField(FieldType.INTEGER, "Minimum beads overlapping: ");
  private final LabeledTextField ltfMaxViewsInAlign =
    new LabeledTextField(FieldType.INTEGER, "Max. # views to include in align: ");
  private final LabeledTextField ltfRoundsOfTracking =
    new LabeledTextField(FieldType.INTEGER, "Rounds of tracking: ");
  private final CheckBox cbSobelFilterCentering =
    new CheckBox("Refine center with Sobel filter");
  // ScalableSigmaForSobel replaced KernelSigmaForSobel.
  private final LabeledTextField ltfScalableSigmaForSobel =
    new LabeledTextField(FieldType.FLOATING_POINT, "Sobel sigma relative to bead size: ");
  private final TextEfield tfLowPassCutoffInverseNm = TextEfield.getLabeledInstance(
    "Overall low-pass filter cutoff (/nm): ", FieldType.FLOATING_POINT);
  ...
  private final BeadtrackPanelActionListener actionListener =
    new BeadtrackPanelActionListener(this);
  ...
  private BeadtrackPanel(final ApplicationManager manager, AxisID id,
    ...
    expertParametersHeader =
      PanelHeader.getInstance("Expert Parameters", this, dialogType);
    header = PanelHeader.getAdvancedBasicInstance("Beadtracker", this, dialogType,
      globalAdvancedButton);
    tfLowPassCutoffInverseNm.setPreferredSize(tfLowPassCutoffInverseNm.getPreferredSize(),
      70);
    ltfScalableSigmaForSobel.setMaxDecimalPlaces(3);
    ...
    panelBeadtrackBody.add(ltfScalableSigmaForSobel.getContainer());
    panelBeadtrackBody.add(tfLowPassCutoffInverseNm.getComponent());
    panelBeadtrackBody.add(Box.createRigidArea(FixedDim.x0_y2));
    ...
    pnlSobelFilterCentering
      .setLayout(new BoxLayout(pnlSobelFilterCentering, BoxLayout.X_AXIS));
    pnlSobelFilterCentering.add(cbSobelFilterCentering.getComponent());
    pnlSobelFilterCentering.add(Box.createHorizontalGlue());

    pnlExpertParametersBody
      .setLayout(new BoxLayout(pnlExpertParametersBody, BoxLayout.Y_AXIS));
  ...
  static BeadtrackPanel getInstance(ApplicationManager manager, AxisID id,
    DialogType dialogType, GlobalExpandButton globalAdvancedButton) {
    BeadtrackPanel instance =
      new BeadtrackPanel(manager, id, dialogType, globalAdvancedButton);
   ...
   */
  void setParameters(BeadtrackParam beadtrackParams, final boolean forTransferFid) {
    ...
    ltfScalableSigmaForSobel.setText(beadtrackParams.getScalableSigmaForSobel());
    if (ltfScalableSigmaForSobel.isEmpty()) {
      EtomoNumber kernelSigmaForSobel = new EtomoNumber(EtomoNumber.Type.DOUBLE);
      kernelSigmaForSobel.set(beadtrackParams.getKernelSigmaForSobel());
      if (!kernelSigmaForSobel.isNull()) {
        // Convert kernelSigmaForSobel into ScalableSigmaForSobel.
        beadtrackParams.convertKernelSigmaForSobelToScalableSigmaForSobel(
          manager.getMetaData().getFiducialDiameter(), FileType.PREALIGNED_STACK);
        ltfScalableSigmaForSobel.setText(beadtrackParams.getScalableSigmaForSobel());
      }
    }
    tfLowPassCutoffInverseNm.setText(beadtrackParams.getLowPassCutoffInverseNm());
    ...
    if (!forTransferFid) {
      ...
      ltfMinTiltRangeToFindAxis
        .setText(beadtrackParams.getMinTiltRangeToFindAxis().toString());
      ltfMinTiltRangeToFindAngle
        .setText(beadtrackParams.getMinTiltRangeToFindAngles().toString());
      ...
      ltfFiducialExtrapolationParams
        .setText(beadtrackParams.getFiducialExtrapolationParams());
      ltfRescueAttemptParams.setText(beadtrackParams.getRescueAttemptParams());
      ltfMinRescueDistance
        .setText(beadtrackParams.getDistanceRescueCriterion().toString());
      ltfRescueRelaxtionParams.setText(beadtrackParams.getRescueRelaxationParams());
      ltfResidualDistanceLimit
        .setText(beadtrackParams.getPostFitRescueResidual().toString());
      ltfDensityRelaxationPostFit
        .setText(beadtrackParams.getDensityRelaxationPostFit().toString());
  ...
  public boolean getParameters(BeadtrackParam beadtrackParams, final boolean doValidation)
    ...
    try {
      ...
      beadtrackParams
        .setScalableSigmaForSobel(ltfScalableSigmaForSobel.getText(doValidation));
      beadtrackParams
        .setLowPassCutoffInverseNm(tfLowPassCutoffInverseNm.getText(doValidation));
      beadtrackParams.setImagesAreBinned(UIExpertUtilities.INSTANCE
        .getStackBinning(manager, axisID, FileType.PREALIGNED_STACK));
      ...
      try {
        ...
        beadtrackParams
          .setMagnificationGroups(ltfMagnificationGroups.getText(doValidation));
        ...
        beadtrackParams.setFiducialExtrapolationParams(
          ltfFiducialExtrapolationParams.getText(doValidation));

        badParameter = ltfRescueAttemptParams.getLabel();
        beadtrackParams
          .setRescueAttemptParams(ltfRescueAttemptParams.getText(doValidation));

        badParameter = ltfRescueRelaxtionParams.getLabel();
        beadtrackParams
          .setRescueRelaxationParams(ltfRescueRelaxtionParams.getText(doValidation));

        badParameter = ltfMeanResidChangeLimits.getLabel();
        beadtrackParams
          .setMeanResidChangeLimits(ltfMeanResidChangeLimits.getText(doValidation));
        ...
        try {
          ...
          String errorMessage = beadtrackParams
            .setTiltDefaultGrouping(ltfTiltAngleGroupSize.getText(doValidation))
          ...
          errorMessage = beadtrackParams
            .setMagDefaultGrouping(ltfMagnificationGroupSize.getText(doValidation))
            .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage =
            beadtrackParams.setMinViewsForTiltalign(ltfNMinViews.getText(doValidation))
              .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage =
            beadtrackParams.setMaxBeadsToAverage(ltfMaxFiducialsAvg.getText(doValidation))
              .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage = beadtrackParams
            .setDistanceRescueCriterion(ltfMinRescueDistance.getText(doValidation))
            .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage = beadtrackParams
            .setPostFitRescueResidual(ltfResidualDistanceLimit.getText(doValidation))
            .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage = beadtrackParams
            .setMaxRescueDistance(ltfMaxRescueDistance.getText(doValidation))
            .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage = beadtrackParams
            .setMinTiltRangeToFindAxis(ltfMinTiltRangeToFindAxis.getText(doValidation))
            .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage = beadtrackParams
            .setMinTiltRangeToFindAngles(ltfMinTiltRangeToFindAngle.getText(doValidation))
            .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage =
            beadtrackParams.setBeadDiameter(ltfBeadDiameter.getText(doValidation))
              .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage = beadtrackParams
            .setLocalAreaTargetSize(ltfLocalAreaTargetSize.getText(doValidation))
            .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage =
            beadtrackParams.setMinBeadsInArea(ltfMinBeadsInArea.getText(doValidation))
              .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage =
            beadtrackParams.setMinOverlapBeads(ltfMinOverlapBeads.getText(doValidation))
              .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage =
            beadtrackParams.setMaxViewsInAlign(ltfMaxViewsInAlign.getText(doValidation))
              .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
          ...
          errorMessage =
            beadtrackParams.setRoundsOfTracking(ltfRoundsOfTracking.getText(doValidation))
              .validate(badParameter);
          if (errorMessage != null) {
            UIHarness.INSTANCE.openMessageDialog(manager, errorMessage, errorTitle,
              axisID);
        ...
        if (skipList.length() > 0) {
          if (skipList.matches(".*\\s+.*")) {
            UIHarness.INSTANCE.openMessageDialog(manager,
              VIEW_SKIP_LIST_LABEL + " cannot contain embedded spaces.", "Entry Error",
              axisID);
            return;
          }
        }
  ...
  private void setEnabled() {
    ...
    ltfScalableSigmaForSobel.setEnabled(cbSobelFilterCentering.isSelected());
  }
  ...
  private void setToolTipText() {
    ...
    try {
      autodoc =
        AutodocFactory.getInstance(manager, AutodocFactory.BEADTRACK, axisID, false);
    }
    ...
    tfLowPassCutoffInverseNm.setTooltip(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.LOW_PASS_CUTOFF_INVERSE_NM));
    ltfViewSkipList.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.SKIP_VIEW_LIST_KEY));
    ltfAdditionalViewSets.setToolTipText(
    ...
    ltfTiltAngleGroups.setToolTipText(
    ...
    ltfMagnificationGroups.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MAGNIFICATION_GROUPS_KEY));
    ltfNMinViews
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.N_MIN_VIEWS_KEY));
    ltfBeadDiameter
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.BEAD_DIAMETER_KEY));
    cbLightBeads
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.LIGHT_BEADS_KEY));
    cbFillGaps
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.FILL_GAPS_KEY));
    ltfMaxGap
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MAX_GAP_KEY));
    ltfMinTiltRangeToFindAxis.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MIN_TILT_RANGE_TO_FIND_AXIS_KEY));
    ltfMinTiltRangeToFindAngle.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MIN_TILT_RANGE_TO_FIND_ANGLES_KEY));
    ltfSearchBoxPixels.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.SEARCH_BOX_PIXELS_KEY));
    ltfMaxFiducialsAvg.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MAX_FIDUCIALS_AVG_KEY));
    ltfFiducialExtrapolationParams.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.FIDUCIAL_EXTRAPOLATION_PARAMS_KEY));
    ltfRescueAttemptParams.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.RESCUE_ATTEMPT_PARAMS_KEY));
    ltfMinRescueDistance.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MIN_RESCUE_DISTANCE_KEY));
    ltfRescueRelaxtionParams.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.RESCUE_RELAXATION_PARAMS_KEY));
    ltfResidualDistanceLimit.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.RESIDUAL_DISTANCE_LIMIT_KEY));
    ltfDensityRelaxationPostFit.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.DENSITY_RELAXATION_POST_FIT_KEY));
    ltfMaxRescueDistance.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MAX_RESCUE_DISTANCE_KEY));
    ltfMeanResidChangeLimits.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MEAN_RESID_CHANGE_LIMITS_KEY));
    ltfDeletionParams.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.DELETION_PARAMS_KEY));

    cbLocalAreaTracking.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.LOCAL_AREA_TRACKING_KEY));
    ltfLocalAreaTargetSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.LOCAL_AREA_TARGET_SIZE_KEY));
    ltfMinBeadsInArea.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MIN_BEADS_IN_AREA_KEY));
    ltfMinOverlapBeads.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MIN_OVERLAP_BEADS_KEY));
    ltfMaxViewsInAlign.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.MAX_VIEWS_IN_ALIGN_KEY));
    ltfRoundsOfTracking.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.ROUNDS_OF_TRACKING_KEY));
    cbSobelFilterCentering.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.SOBEL_FILTER_CENTERING_KEY));
    ltfScalableSigmaForSobel.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, BeadtrackParam.SCALABLE_SIGMA_FOR_SOBEL_KEY));
