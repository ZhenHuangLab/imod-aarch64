...
public abstract class ReconUIExpert implements UIExpert {
   ...
   * @param axisID
   */
  final void processchunks(final BaseManager manager, final AbstractParallelDialog dialog,
    final ProcessResultDisplay processResultDisplay, final ProcessSeries processSeries,
    final String processName, final FileKey outputImageFileKey,
    ...
    ProcesschunksParam param =
      new ProcesschunksParam(manager, axisID, processName, outputImageFileKey);
