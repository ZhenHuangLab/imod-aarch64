 ...
 * <p>Description: </p>
 * 
 * <p>Copyright: Copyright 1006 - 2016 by the Regents of the University of Colorado</p>
 * 
 ...
 * <p> </p>
 */
final class Spinner implements UIComponent, SwingComponent {
  ...
  /**
   * Sets minimum, current value, and step to 1.
   * @param label
   * @param maximum
   * @return
   */
  static Spinner getLabeledInstance(final String label, final int maximum) {
    return new Spinner(label, true, 1, 1, maximum, 1);
  }
