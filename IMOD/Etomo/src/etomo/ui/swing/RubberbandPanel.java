...
final class RubberbandPanel {
  ...
  private final LabeledTextField ltfXMin =
    new LabeledTextField(FieldType.INTEGER, "X min: ");
  private final LabeledTextField ltfXMax =
    new LabeledTextField(FieldType.INTEGER, "X max: ");
  private final LabeledTextField ltfYMin =
    new LabeledTextField(FieldType.INTEGER, "Y min: ");
  private final LabeledTextField ltfYMax =
    new LabeledTextField(FieldType.INTEGER, "Y max: ");
  private final LabeledTextField ltfZMin =
    new LabeledTextField(FieldType.INTEGER, "Z min: ");
  private final LabeledTextField ltfZMax =
    new LabeledTextField(FieldType.INTEGER, "Z max: ");
  ...
  static RubberbandPanel getInstance(BaseManager manager, RubberbandContainer container,
    ...
    RubberbandPanel instance =
      new RubberbandPanel(manager, container, imodKey, borderLabel, buttonLabel,
        xMinTooltip, xMaxTooltip, yMinTooltip, yMaxTooltip, "", "", null, true, false);
  ...
  static RubberbandPanel getNoButtonInstance(final BaseManager manager,
    final RubberbandContainer container, final String imodKey, final String borderLabel,
    final String buttonLabel, final String xMinTooltip, final String xMaxTooltip,
    final String yMinTooltip, final String yMaxTooltip, final boolean lockPanel) {
  ...
  void setXMin(final String input) {
    ltfXMin.setText(input);
  }

  void setXMax(final String input) {
    ltfXMax.setText(input);
  }

  void setYMin(final String input) {
    ltfYMin.setText(input);
  }

  void setYMax(final String input) {
    ltfYMax.setText(input);
  }
  ...
  private void setMinAndMax(Vector coordinates) {
    ...
    while (index < size) {
      if (ImodProcess.RUBBERBAND_RESULTS_STRING
        ...
        if (container != null) {
          container.setRubberbandContainerZMin((String) coordinates.get(index));
        }
        index++;
        if (index >= size) {
          return;
        ...
        if (container != null) {
          container.setRubberbandContainerZMax((String) coordinates.get(index));
        }
        return;
      }
    }
  ...
  boolean getScaleParameters(TrimvolParam trimvolParam, final boolean doValidation) {
    if (lockPanel) {
      return true;
    }
    try {
  ...
  void getParameters(ParallelMetaData metaData) {
    if (lockPanel) {
      return;
    }
  ...
  void setParameters(TrimvolParam param) {
    if (lockPanel) {
      return;
    }
  ...
  void initScaleParameters(TrimvolParam trimvolParam) {
    if (lockPanel) {
      return;
    }
    XYParam xyParam = trimvolParam.getScaleXYParam();
  ...
  void setParameters(ParallelMetaData metaData) {
    if (lockPanel) {
      return;
    }
