 ...
 * <p> </p>
 */
public final class SpacedPanel {
 ...
 public static SpacedPanel getInstance(final boolean yAxisPadding) {
 ...
 public final void setBoxLayout(final int axis) {
    this.axis = axis;
  ...
  public final void add(final Container container) {
    panel.add(container);
    addSpacing();
  }
