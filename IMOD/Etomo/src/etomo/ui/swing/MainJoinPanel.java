...
public class MainJoinPanel extends MainPanel {
  ...
  void createAxisPanelA(AxisID axisID, final AxisProgressPanel axisProgressPanel) {
    axisPanelA = new JoinProcessPanel((JoinManager) manager, axisID, axisProgressPanel);
  }
  ...
  final void setState(ProcessState processState, AxisID axisID,
