...
public abstract class ProcessDialog implements AbstractParallelDialog {
  ...
  final SingleLineButton btnCancel = new SingleLineButton("Cancel");
  final SingleLineButton btnExecute = new SingleLineButton("Execute");
  final GlobalExpandButton btnAdvanced =
    GlobalExpandButton.getInstance("Advanced", "Basic");

  final SingleLineButton btnPostpone;
  ...
  public ProcessDialog(final ApplicationManager appManager, final AxisID axisID,
    ...
    this(appManager, axisID, dialogType, true);
  }
   ...
   */
  public ProcessDialog(final ApplicationManager appManager, final AxisID axisID,
    DialogType dialogType, final boolean usePostpone) {
    ...
    setToolTipText();
    if (usePostpone) {
      btnPostpone = new SingleLineButton("Postpone");
    }
    else {
      btnPostpone = null;
    }
