...
final class HeaderCell extends Cell
  implements TableComponent, UIComponent, SwingComponent {
  static final ColorUIResource background = new ColorUIResource(204, 204, 204);
  ...
  void addTooltip(final String text) {
    ...
    if (tooltip == null) {
      ...
      cell.setToolTipText(tooltip + " & " + TooltipFormatter.INSTANCE.format(text));
    }
  }
