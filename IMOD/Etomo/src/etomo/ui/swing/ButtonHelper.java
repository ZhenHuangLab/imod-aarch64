 ...
 */
 final class ButtonHelper {
  ...
  static final Dimension MULTI_LINE_BUTTON_DIM =
  ...
  final static void setStandardSize(final AbstractButton button) {
   ...
   */
  static void printDefaultUIResource(final String type) {
   ...
   *
   */
  static void printDefaultUIResource() {
    java.util.Enumeration keys = UIManager.getDefaults().keys();
    while (keys.hasMoreElements()) {
      Object key = keys.nextElement();
      Object value = UIManager.get(key);
