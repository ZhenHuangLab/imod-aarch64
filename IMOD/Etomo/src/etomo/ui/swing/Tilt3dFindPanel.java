...
final class Tilt3dFindPanel extends AbstractTiltPanel {
  ...
  private static final String CENTER_TO_CENTER_THICKNESS_LABEL =
    "Center to center thickness";
  private static final String ADDITION_UNBINNED_DIAMETERS_TO_ADD =
    "Additional unbinned diameters to add ";
  ...
  private final LabeledTextField ltfAdditionalDiameters =
    new LabeledTextField(FieldType.INTEGER, ADDITION_UNBINNED_DIAMETERS_TO_ADD + ": ");
  ...
  static Tilt3dFindPanel getInstance(final ApplicationManager manager,
    ...
    Tilt3dFindPanel instance =
      new Tilt3dFindPanel(manager, axisID, dialogType, parent, extraButton);
  ...
  void setParameters(ConstTiltalignParam param, boolean initialize) {
    ...
    TaAnglesLog taAnglesLog =
      TaAnglesLog.getInstance(manager.getPropertyUserDir(), manager, axisID);
