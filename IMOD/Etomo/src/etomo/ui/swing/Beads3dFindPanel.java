 ...
 * <p> </p>
 */
final class Beads3dFindPanel
  implements NewstackOrBlendmont3dFindParent, Tilt3dFindParent, Expandable {
  ...
  Beads3dFindPanel(final ApplicationManager manager, final AxisID axisID,
    ...
    if (manager.getMetaData().getViewType() == ViewType.MONTAGE) {
      newstackOrBlendmont3dFindPanel =
        Blendmont3dFindPanel.getInstance(manager, axisID, dialogType, this);
    }
    else {
      newstackOrBlendmont3dFindPanel =
        Newstack3dFindPanel.getInstance(manager, axisID, dialogType, this);
    }
    tilt3dFindPanel = Tilt3dFindPanel.getInstance(manager, axisID, dialogType, this,
      newstackOrBlendmont3dFindPanel.get3dmodButton());
    findBeads3dPanel =
      FindBeads3dPanel.getInstance(manager, axisID, dialogType, globalAdvancedButton);
  ...
  static Beads3dFindPanel getInstance(final ApplicationManager manager,
    ...
    Beads3dFindPanel instance =
      new Beads3dFindPanel(manager, axisID, dialogType, globalAdvancedButton);
    instance.createPanel();
    return instance;
  }

  void reregisterProcessingMethodMediator() {
    tilt3dFindPanel.reregisterProcessingMethodMediator();
  }
  ...
  private void createPanel() {
    ...
    pnlGenerateTomogramBody
      .setLayout(new BoxLayout(pnlGenerateTomogramBody, BoxLayout.Y_AXIS));
  ...
  public void tilt3dFindAction(final ProcessResultDisplay processResultDisplay,
    ...
    if (!manager.equalsBinning(axisID, newstackOrBlendmont3dFindPanel.getBinning(),
      ...
      ProcessSeries processSeries =
        new ProcessSeries(manager, axisID, dialogType, tilt3dFindPanel);
