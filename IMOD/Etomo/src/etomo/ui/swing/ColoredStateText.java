 ...
 */
 ...
 class ColoredStateText {
  ...
  private int currentSelected = -1;
   ...
   ColoredStateText(String[] labels, Color[] colors)
   ...
   ColoredStateText(Color[] colors) {
    nItems = colors.length;
    this.colors = colors;
  }

   void setSelected(int index) throws InvalidParameterException {
