...
class JoinProcessPanel extends AxisProcessPanel {
  /**
  * @param joinManager
  * @param axis
  */
  JoinProcessPanel(final JoinManager joinManager, final AxisID axis,
    final AxisProgressPanel axisProgressPanel) {
    super(axis, joinManager, true, true, InterfaceType.JOIN, false, axisProgressPanel);
