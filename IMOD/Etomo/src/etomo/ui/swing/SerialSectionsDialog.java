...
* <p> $Log$ </p>
*/
public final class SerialSectionsDialog
  implements ContextMenu, Run3dmodButtonContainer, AutoAlignmentDisplay {
  ...
  private final CheckBox cbPreblendVerySloppyMontage =
    new CheckBox("Treat as very sloppy montage");
  private final Run3dmodButton btnPreblend =
    Run3dmodButton.getDeferred3dmodInstance("Make Blended Stack", this);
  private final Run3dmodButton btn3dmodPreblend =
    Run3dmodButton.get3dmodInstance("Open Blended Stack", this);
  private final MultiLineButton btnFixEdges = new MultiLineButton("Fix Edges With Midas");
  private final MultiLineButton btn3dmodPrealign =
    Run3dmodButton.get3dmodInstance("Open Stack", this);
  private final ButtonGroup bgXftoxgAlignment = new ButtonGroup();
  private final RadioButton rbNoOptions =
    new RadioButton("Local fitting (retain trends)", bgXftoxgAlignment);
  private final RadioButton rbHybridFitsTranslations =
    new RadioButton("Remove trends in translation", XftoxgParam.HybridFits.TRANSLATIONS,
      bgXftoxgAlignment);
  private final RadioButton rbHybridFitsTranslationsRotations =
    new RadioButton("Remove trends in translation & rotation",
      XftoxgParam.HybridFits.TRANSLATIONS_ROTATIONS, bgXftoxgAlignment);
  private final RadioButton rbNumberToFitGlobalAlignment =
    new RadioButton("Global alignments (remove all trends)",
      XftoxgParam.NumberToFit.GLOBAL_ALIGNMENT, bgXftoxgAlignment);
  private final Run3dmodButton btnAlign =
    Run3dmodButton.getDeferred3dmodInstance("Make Aligned Stack", this);
  private final Run3dmodButton btn3dmodAlign =
    Run3dmodButton.get3dmodInstance("Open Aligned Stack", this);
  private CheckBoxSpinner cbsReferenceSection =
    CheckBoxSpinner.getInstance("Reference section for alignment: ");
  private LabeledTextField ltfSizeX =
    new LabeledTextField(FieldType.INTEGER, SIZE_LABEL + "X: ");
  private LabeledTextField ltfSizeY = new LabeledTextField(FieldType.INTEGER, "Y: ");
  private LabeledTextField ltfShiftX =
    new LabeledTextField(FieldType.FLOATING_POINT, SHIFT_LABEL + "X: ");
  private LabeledTextField ltfShiftY =
    new LabeledTextField(FieldType.FLOATING_POINT, "Y: ");
  ...
  private CheckTextField ctfPreblendRobustFitCriterion = CheckTextField
    .getInstance(FieldType.FLOATING_POINT, "Robust fitting with criterion: ");
  private final Spinner spMidasBinning = Spinner.getLabeledInstance("Binning: ", 1, 1, 8);
  private final Run3dmodButton btn3dmodRawStack =
    Run3dmodButton.get3dmodInstance("Open Raw Stack", this);
  private final CheckBox cbPreblendReadInXcorrs =
    new CheckBox("Use existing edge displacement file (.ecd)");
  ...
  public void
    setAutoAlignmentController(final AutoAlignmentController autoAlignmentController) {
  ...
  private void createPanel() {
    ...
    JPanel pnlPreblendVerySloppyBlend = new JPanel();
    ...
    MRCHeader header =
      MRCHeader.getInstance(manager.getPropertyUserDir(), stack.getName(), axisID);
    try {
      header.read(manager);
    ...
    cbPreblendReadInXcorrs.setSelected(FileType.PIECE_SHIFTS.exists(manager, axisID));
    // root panel
    ...
    pnlTabBodyArray[index]
      .setLayout(new BoxLayout(pnlTabBodyArray[index], BoxLayout.Y_AXIS));
    pnlTabBodyArray[index].add(pnlPreblendReadInXcorrs);
    pnlTabBodyArray[index].add(pnlPreblendVerySloppyBlend);
    pnlTabBodyArray[index].add(pnlPreblendRobustFitCriterion);
    ...
    pnlPreblendReadInXcorrs
      .setLayout(new BoxLayout(pnlPreblendReadInXcorrs, BoxLayout.X_AXIS));
    pnlPreblendReadInXcorrs.add(cbPreblendReadInXcorrs.getComponent());
    pnlPreblendReadInXcorrs.add(Box.createHorizontalGlue());
    // preblend very sloppy blend
    pnlPreblendVerySloppyBlend
      .setLayout(new BoxLayout(pnlPreblendVerySloppyBlend, BoxLayout.X_AXIS));
    pnlPreblendVerySloppyBlend.add(cbPreblendVerySloppyMontage.getComponent());
    pnlPreblendVerySloppyBlend.add(Box.createHorizontalGlue());
    // PreblendRobustFitCriterion
    pnlPreblendRobustFitCriterion
      .setLayout(new BoxLayout(pnlPreblendRobustFitCriterion, BoxLayout.X_AXIS));
    pnlPreblendRobustFitCriterion.add(ctfPreblendRobustFitCriterion.getRootComponent());
    pnlPreblendRobustFitCriterion.add(Box.createHorizontalStrut(215));
    // initial blend buttons
    pnlInitialBlendButtons
      .setLayout(new BoxLayout(pnlInitialBlendButtons, BoxLayout.X_AXIS));
    ...
    pnlMidas.add(Box.createRigidArea(FixedDim.x0_y5));
    pnlMidas.add(new JLabel("Replaces the edge displacement file (.ecd)."));
    // midas binning
    ...
    pnlXftoxgAlignment
      .setBorder(new EtchedBorder("Stack alignment transforms").getBorder());
  ...
  private void addListeners() {
    ...
    cbPreblendReadInXcorrs.addActionListener(listener);
  }

  /**
   * The purpose of this function is to have Midas button enabled whether or not Initial
   * Auto-Alignment succeeds. 
   */
  ...
  public boolean getParameters(final SerialSectionsMetaData metaData,
    ...
    try {
      metaData.setRobustFitCriterion(ctfPreblendRobustFitCriterion.getText(doValidation));
      ...
      metaData.setHybridFitsTranslationsRotations(
      ...
      metaData.setUseReferenceSection(
        cbsReferenceSection.isSelected() && cbsReferenceSection.isCheckBoxEnabled());
      ...
      metaData.setPreblendVerySloppyMontage(cbPreblendVerySloppyMontage.isSelected());
  ...
  public void setParameters(final ConstSerialSectionsMetaData metaData) {
    ctfPreblendRobustFitCriterion.setText(metaData.getRobustFitCriterion());
    ...
    rbHybridFitsTranslationsRotations
      .setSelected(metaData.isHybridFitsTranslationsRotations());
    ...
    cbPreblendVerySloppyMontage.setSelected(metaData.isPreblendVerySloppyMontage());
  ...
  public boolean isPreblendRobustFitting() {
    return ctfPreblendRobustFitCriterion.isSelected();
  }

  public String getPreblendRobustFitting() {
    return ctfPreblendRobustFitCriterion.getText();
  }
  ...
  public void setPreblendReadInXcorrs(final boolean readInXcorrs) {
    cbPreblendReadInXcorrs.setSelected(readInXcorrs);
    updateDisplay();
  }

  public void setPreblendParameters(final BlendmontParam param) {
    cbPreblendVerySloppyMontage.setSelected(param.isVerySloppyMontage());
    ctfPreblendRobustFitCriterion.setSelected(param.isRobustFitCriterion());
    if (ctfPreblendRobustFitCriterion.isSelected()) {
      ctfPreblendRobustFitCriterion.setText(param.getRobustFitCriterion());
    }
    // ReadInXcorrs:
  ...
  public boolean getPreblendParameters(final BlendmontParam param,
    final boolean doValidation) {
    try {
      param.setVerySloppyMontage(cbPreblendVerySloppyMontage.isEnabled()
        && cbPreblendVerySloppyMontage.isSelected());
      if (ctfPreblendRobustFitCriterion.isSelected()) {
        param.setRobustFitCriterion(ctfPreblendRobustFitCriterion.getText(doValidation));
      }
      else {
        param.resetRobustFitCriterion();
      }
      param.setReadInXcorrs(cbPreblendReadInXcorrs.isSelected());
      return true;
    }
    catch (FieldValidationFailedException e) {
      return false;
  ...
  public boolean getBlendParameters(final BlendmontParam param,
    final boolean doValidation) {
    try {
      if (ltfSizeX.isEmpty() && ltfSizeY.isEmpty() && ltfShiftX.isEmpty()
        ...
        param.setStartingAndEndingXAndY(
          TomogramTool.getStartingAndEndingXAndY(FileType.PREBLEND_OUTPUT_MRC,
            ltfSizeX.getText(doValidation), ltfShiftX.getText(doValidation),
            ltfSizeY.getText(doValidation), ltfShiftY.getText(doValidation), manager,
            axisID, ltfSizeX.getQuotedLabel(), ltfShiftX.getQuotedLabel(),
  ...
  public void getParameters(final XftoxgParam param) {
    if (rbNoOptions.isSelected()) {
      ...
      || rbHybridFitsTranslationsRotations.isSelected()) {
      param
        .setHybridFits(((RadioButton.RadioButtonModel) bgXftoxgAlignment.getSelection())
          .getEnumeratedType());
      param.resetNumberToFit();
    }
      ...
      param.resetHybridFits();
      param
        .setNumberToFit(((RadioButton.RadioButtonModel) bgXftoxgAlignment.getSelection())
          .getEnumeratedType());
    }
  ...
  private void updateDisplay() {
    cbsReferenceSection.setCheckBoxEnabled(
      rbNumberToFitGlobalAlignment.isSelected() && !referenceSectionProblem);
    boolean enable =
      !cbsReferenceSection.isCheckBoxEnabled() || !cbsReferenceSection.isSelected();
    ...
    cbPreblendVerySloppyMontage.setEnabled(!cbPreblendReadInXcorrs.isSelected());
  }
  ...
  private void tabChangeWarning() {
    if (curTab == Tab.INITIAL_BLEND) {
      TransformsTool.checkUpToDateEdgeFunctionsFile(
        manager.getState().getInvalidEdgeFunctions().is(), manager, axisID,
  ...
  public void popUpContextMenu(final MouseEvent mouseEvent) {
    ...
    if (curTab == Tab.INITIAL_BLEND) {
      ...
      if (stack != null && !DatasetTool.isOneBy(manager.getPropertyUserDir(),
        stack.getName(), manager, axisID)) {
        graph = new TomodataplotsParam.Task[] {
          TomodataplotsParam.Task.SERIAL_SECTIONS_MEAN_MAX };
      }
    }
    ...
    ContextPopup contextPopup =
      new ContextPopup(pnlRoot, mouseEvent, anchor, ContextPopup.SERIAL_GUIDE,
        manPageLabel, manPage, logFileLabel, logFile, graph, manager, axisID, true);
  }
  ...
  private void setTooltips() {
    ...
    rbHybridFitsTranslationsRotations
      .setToolTipText("Eliminate shifts and rotations between images, retain trends in "
        + "size changes (" + XftoxgParam.HYBRID_FITS_KEY + " option "
        + rbHybridFitsTranslationsRotations.getEnumeratedType() + ")");
    rbNumberToFitGlobalAlignment.setToolTipText(
      "Eliminate all trends with a global alignment (" + XftoxgParam.NUMBER_TO_FIT_KEY
        + " option " + rbNumberToFitGlobalAlignment.getEnumeratedType() + ")");
    ...
    try {
      if (viewType == ViewType.MONTAGE) {
        autodoc =
          AutodocFactory.getInstance(manager, AutodocFactory.BLENDMONT, axisID, false);
        cbPreblendVerySloppyMontage
          .setToolTipText("Overlaps between images vary substantially; use for "
            + "montages taken with stage movement.");
        ctfPreblendRobustFitCriterion
        ...
        spBinByFactor.setToolTipText(
          EtomoAutodoc.getTooltip(autodoc, BlendmontParam.BIN_BY_FACTOR_KEY));
        cbFillWithZero
          .setToolTipText("Sets " + BlendmontParam.FILL_VALUE_KEY + " to zero.  "
            + EtomoAutodoc.getTooltip(autodoc, BlendmontParam.FILL_VALUE_KEY));
      }
      else {
        autodoc =
          AutodocFactory.getInstance(manager, AutodocFactory.NEWSTACK, axisID, false);
        spBinByFactor
          .setToolTipText(EtomoAutodoc.getTooltip(autodoc, NewstParam.BIN_BY_FACTOR_KEY));
