...
public final class PostProcessingDialog extends ProcessDialog implements ContextMenu {
  ...
  private PostProcessingDialog(final ApplicationManager appMgr,
    ...
    trimvolPanel =
      new TrimvolPanel(applicationManager, axisID, dialogType, trimvolInputFileMissing);
  ...
  public static PostProcessingDialog getInstance(final ApplicationManager manager,
    final boolean trimvolInputFileMissing) {
    PostProcessingDialog instance =
      new PostProcessingDialog(manager, trimvolInputFileMissing);
  ...
  public void initParameters(final TrimvolParam param) {
    trimvolPanel.initParameters(param);
  }
  ...
  public TrimvolDisplay getTrimvolDisplay() {
    return trimvolPanel;
  }

  public boolean setStartupWarnings(final TrimvolInputFileState inputFileState) {
    return trimvolPanel.setStartupWarnings(inputFileState);
  }
   ...
   * @param squeezevolParam
   */
  public boolean getParameters(SqueezevolParam squeezevolParam,
