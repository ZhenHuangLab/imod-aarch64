...
class UIUtilities {
  ...
  static File chooseFile(final Component component, final File dir,
    final BrowsingDirectory browsingDirectory,final FileFilter fileFilter) {
    JFileChooser chooser = new FileChooser(null, dir, browsingDirectory);
    ...
    if (returnVal == JFileChooser.APPROVE_OPTION) {
      ...
      if (browsingDirectory != null && file != null) {
        browsingDirectory.setBrowsingDir(file.getParentFile());
      }
    }
    return file;
  }
   ...
   * @param component
   */
  static void addWithXSpace(Container panel, Component component) {
    panel.add(component);
   ...
   * @param component
   */
  static void addWithYSpace(Container panel, Component component) {
    panel.add(component);
   ...
   * @param dim
   */
  static void addWithSpace(Container panel, Component component, Dimension dim) {
    panel.add(component);
   ...
   * @param alignment
   */
  static void alignComponentsX(Container container, float alignment) {
  ...
  static void alignComponentsY(Container container, float alignment) {
    Component[] children = container.getComponents();
    for (int i = 0; i < children.length; i++) {
      if (children[i] instanceof JComponent) {
        JComponent jcomp = (JComponent) children[i];
   ...
   * @param size
   */
  static void setButtonSizeAll(Container container, Dimension size) {
    Component[] children = container.getComponents();
    for (int i = 0; i < children.length; i++) {
  ...
  static Object getDefaultUIResource(Object target, String name) {
