...
final class TiltalignPanel implements Expandable, ActionListener {
  ...
  private final LabeledTextField ltfResidualThreshold =
    new LabeledTextField(FieldType.FLOATING_POINT, "Threshold for residual report: ");
  ...
  private final RadioButton rbSingleFiducialSurface =
    new RadioButton("Do not sort fiducials into 2 surfaces for analysis");
  private final RadioButton rbDualFiducialSurfaces =
    new RadioButton("Assume fiducials on 2 surfaces for analysis");
  private final ButtonGroup bgFiducialSurfaces = new ButtonGroup();
  private final EtomoPanel pnlFiducialSurfaces = new EtomoPanel();

  private final LabeledTextField ltfExcludeList =
    new LabeledTextField(FieldType.INTEGER_LIST, "List of views to exclude: ");
  private final LabeledTextField ltfSeparateViewGroups =
    new LabeledTextField(FieldType.INTEGER_LIST, "Separate view groups: ");

  private final EtomoPanel pnlVolumeParameters = new EtomoPanel();
  private final LabeledTextField ltfTiltAngleOffset =
    new LabeledTextField(FieldType.FLOATING_POINT, "Total tilt angle offset: ");
  private final LabeledTextField ltfTiltAxisZShift =
    new LabeledTextField(FieldType.FLOATING_POINT, "Tilt axis z shift: ");

  private final EtomoPanel pnlMinimizationParams = new EtomoPanel();
  private final JPanel pnlMetroFactor = new JPanel();
  private final LabeledTextField ltfMetroFactor =
    new LabeledTextField(FieldType.FLOATING_POINT, "Metro factor: ");
  private final LabeledTextField ltfMaximumCycles =
    new LabeledTextField(FieldType.INTEGER, "Iteration limit: ");
  ...
  private final RadioTextField rtfTargetPatchSizeXandY = RadioTextField
    .getInstance(FieldType.INTEGER_PAIR, "Target patch size (x,y): ", bgLocalPatches);
  private final RadioTextField rtfNLocalPatches = RadioTextField
    .getInstance(FieldType.INTEGER_PAIR, "# of local patches (x,y): ", bgLocalPatches);
  ...
  private final CheckBox cbFixXYZCoordinates =
    new CheckBox("Use global X-Y-Z coordinates");
  ...
  private final RadioButton rbTiltAngleAll =
    new RadioButton("Solve for all except minimum tilt");
  ...
  private final LabeledTextField ltfTiltAngleGroupSize =
    new LabeledTextField(FieldType.INTEGER, "Group size: ");
  private final LabeledTextField ltfTiltAngleNonDefaultGroups =
    new LabeledTextField(FieldType.INTEGER_TRIPLE, "Non-default grouping: ");

  // Magnfication pane
  private final RadioButton rbMagnificationFixed =
    new RadioButton("Fixed magnification at 1.0");
  private final RadioButton rbMagnificationAll =
    new RadioButton("Solve for all magnifications");
  ...
  private final LabeledTextField ltfMagnificationReferenceView =
    new LabeledTextField(FieldType.INTEGER, "Reference view: ");
  private final LabeledTextField ltfMagnificationGroupSize =
    new LabeledTextField(FieldType.INTEGER, "Group size: ");
  private final LabeledTextField ltfMagnificationNonDefaultGroups =
    new LabeledTextField(FieldType.INTEGER_TRIPLE, "Non-default grouping: ");
  ...
  private final LabeledTextField ltfXstretchGroupSize =
    new LabeledTextField(FieldType.INTEGER, "X stretch group size: ");
  private final LabeledTextField ltfXstretchNonDefaultGroups =
    new LabeledTextField(FieldType.INTEGER_TRIPLE, "X stretch non-default grouping: ");

  private final LabeledTextField ltfSkewGroupSize =
    new LabeledTextField(FieldType.INTEGER, "Skew group size: ");
  private final LabeledTextField ltfSkewNonDefaultGroups =
    new LabeledTextField(FieldType.INTEGER_TRIPLE, "Skew non-default grouping: ");
  ...
  private final LabeledTextField ltfLocalRotationGroupSize =
    new LabeledTextField(FieldType.INTEGER, "Group size: ");
  private final LabeledTextField ltfLocalRotationNonDefaultGroups =
    new LabeledTextField(FieldType.INTEGER_TRIPLE, "Non-default grouping: ");
  ...
  private final LabeledTextField ltfLocalTiltAngleGroupSize =
    new LabeledTextField(FieldType.INTEGER, "Group size: ");
  ...
  private final LabeledTextField ltfLocalMagnificationGroupSize =
    new LabeledTextField(FieldType.INTEGER, "Group size: ");
  ...
  private final RadioButton rbLocalDistortionFullSolution =
    new RadioButton("Full solution");
  ...
  private final LabeledTextField ltfLocalXstretchGroupSize =
    new LabeledTextField(FieldType.INTEGER, "X stretch group size: ");
  private final LabeledTextField ltfLocalXstretchNonDefaultGroups =
    new LabeledTextField(FieldType.INTEGER_TRIPLE, "X stretch non-default grouping: ");

  private final LabeledTextField ltfLocalSkewGroupSize =
    new LabeledTextField(FieldType.INTEGER, "Skew group size: ");
  private final LabeledTextField ltfLocalSkewNonDefaultGroups =
    new LabeledTextField(FieldType.INTEGER_TRIPLE, "Skew non-default grouping: ");
  ...
  private final LabeledTextField ltfRotationAngle =
    new LabeledTextField(FieldType.FLOATING_POINT, "Rotation angle: ");
  private final LabeledTextField ltfRotationGroupSize =
    new LabeledTextField(FieldType.INTEGER, "Group size: ");
  private final LabeledTextField ltfRotationNonDefaultGroups =
    new LabeledTextField(FieldType.INTEGER_TRIPLE, "Non-default grouping: ");
  private final CheckBox cbProjectionStretch =
    new CheckBox("Solve for single stretch during projection");
  ...
  private final EtomoPanel pnlSingleVariables = new EtomoPanel();
  private final JPanel pnlSingleVariablesBody = new JPanel();
  ...
  private final CheckBox cbWeightWholeTracks =
    new CheckBox("Find weights for contours, not points");
  private final CheckBox cbXTiltAutomapSame =
    new CheckBox("Solve for X axis tilt between separate groups");
  ...
  private final LabeledTextField ltfMinMeasurementRatio =
    new LabeledTextField(FieldType.FLOATING_POINT, "Minimum ");
  private SingleLineButton btnRestrictalign = new SingleLineButton("Restrict Variables");

  private final PanelHeader phSingleVariables;
  ...
  private TiltalignPanel(final AxisID axis, final ApplicationManager appMgr,
    ...
    phSingleVariables = PanelHeader.getAdvancedBasicOnlyNoSeparatorInstance(
      "Single Variables: Beam Tilt," + " X Tilt, Projection Stretch", this,
  ...
  private void updateDisplay() {
    ...
    cbWeightWholeTracks
      .setEnabled(patchTracking && ctfRobustFittingAndKFactorScaling.isSelected());
  }
  ...
  public void expand(ExpandButton button) {
    if (phSingleVariables.equalsAdvancedBasic(button)) {
  ...
  private void updateAdvancedBeamTilt(boolean advanced) {
    pnlSingleVariablesBody.setVisible(advanced);
  }
  ...
  void setParameters(final ConstTiltalignParam params) {
    ...
    ltfResidualThreshold
      .setText(Math.abs(params.getResidualReportCriterion().getDouble()));
  ...
  void setParameters(BaseScreenState screenState) {
    phSingleVariables.setButtonStates(screenState);
  }
  ...
  void setPatchTracking(boolean input) {
    patchTracking = input;
    updateDisplay();
  }
  ...
  void setSurfacesToAnalyze(int surfacesToAnalyze) {
    if (surfacesToAnalyze == 1) {
      rbSingleFiducialSurface.setSelected(true);
      cbWeightWholeTracks.setSelected(true);
    }
    else if (surfacesToAnalyze == 2) {
      rbDualFiducialSurfaces.setSelected(true);
      cbWeightWholeTracks.setSelected(false);
    }
  }

  void getParameters(BaseScreenState screenState) {
    phSingleVariables.getButtonStates(screenState);
  }
  ...
  boolean getParameters(final TiltalignParam params, final boolean doValidation)
    ...
    try {
      ...
      try {
        ...
        params
          .setMagNondefaultGroup(ltfMagnificationNonDefaultGroups.getText(doValidation));
        ...
        params
          .setXStretchNondefaultGroup(ltfXstretchNonDefaultGroups.getText(doValidation));
        ...
        params.setLocalRotNondefaultGroup(
          ltfLocalRotationNonDefaultGroups.getText(doValidation));
        ...
        params
          .setLocalTiltDefaultGrouping(ltfLocalTiltAngleGroupSize.getText(doValidation));

        badParameter = ltfLocalTiltAngleNonDefaultGroups.getLabel();
        params.setLocalTiltNondefaultGroup(
          ltfLocalTiltAngleNonDefaultGroups.getText(doValidation));
        ...
        params.setLocalMagDefaultGrouping(
          ltfLocalMagnificationGroupSize.getText(doValidation));

        badParameter = ltfLocalMagnificationNonDefaultGroups.getLabel();
        params.setLocalMagNondefaultGroup(
          ltfLocalMagnificationNonDefaultGroups.getText(doValidation));
        ...
        params.setLocalSkewNondefaultGroup(
          ltfLocalSkewNonDefaultGroups.getText(doValidation));

        badParameter = ltfLocalXstretchGroupSize.getLabel();
        params.setLocalXStretchDefaultGrouping(
          ltfLocalXstretchGroupSize.getText(doValidation));

        badParameter = ltfLocalXstretchNonDefaultGroups.getLabel();
        params.setLocalXStretchNondefaultGroup(
          ltfLocalXstretchNonDefaultGroups.getText(doValidation));
  ...
  boolean isValid() {
    if (rtfFixedBeamTilt.isSelected() && rtfFixedBeamTilt.getText().equals("")) {
      UIHarness.INSTANCE.openMessageDialog(appMgr,
        rtfFixedBeamTilt.getLabel() + " can not be empty when it is selected.",
        "Entry Error");
      return false;
    }
  ...
  private void createGeneralTab() {
    ...
    createRadioBox(pnlRBFiducual, bgFiducialSurfaces, items, 400);
    ...
    pnlMinimizationParams
      .setBorder(new EtchedBorder("Minimization Parameters").getBorder());
    ...
    ltfMinLocalFiducials
      .setTextPreferredWidth(60 * UIParameters.getInstance().getFontSizeAdjustment());
    pnlLocalParameters.setLayout(new BoxLayout(pnlLocalParameters, BoxLayout.Y_AXIS));
    pnlLocalParameters
      .setBorder(new EtchedBorder("Local Alignment Parameters").getBorder());
  ...
  private void createGlobalSolutionTab() {
    ...
    ltfXstretchNonDefaultGroups
      .setTextPreferredWidth(UIParameters.getInstance().getIntegerTripletWidth());
    ...
    pnlGlobalVariableBody.add(Box.createRigidArea(FixedDim.x0_y5));
    pnlGlobalVariableBody.add(Box.createVerticalGlue());
    pnlGlobalVariableBody.add(pnlSingleVariables);
    pnlGlobalVariableBody.add(Box.createRigidArea(FixedDim.x0_y5));
    ...
    pnlRestrictalign
      .setBorder(new EtchedBorder("Restrict Alignment Variables").getBorder());
    ...
    // RestrictalignButton
    pnlRestrictalignButton
      .setLayout(new BoxLayout(pnlRestrictalignButton, BoxLayout.X_AXIS));
    pnlRestrictalignButton.add(Box.createHorizontalGlue());
    pnlRestrictalignButton.add(btnRestrictalign.getComponent());
    pnlRestrictalignButton.add(Box.createHorizontalGlue());
    // single variables
    pnlSingleVariables.setLayout(new BoxLayout(pnlSingleVariables, BoxLayout.Y_AXIS));
    pnlSingleVariables.setBorder(BorderFactory.createEtchedBorder());
    pnlSingleVariables.setAlignmentX(Component.CENTER_ALIGNMENT);
    pnlSingleVariables.add(phSingleVariables);
    // single variables body
    JPanel opnlSingleVariablesBody = new JPanel();
    opnlSingleVariablesBody
      .setLayout(new BoxLayout(opnlSingleVariablesBody, BoxLayout.X_AXIS));
    opnlSingleVariablesBody.setAlignmentX(Component.CENTER_ALIGNMENT);
    opnlSingleVariablesBody.add(pnlSingleVariablesBody);
    opnlSingleVariablesBody.add(Box.createHorizontalGlue());
    pnlSingleVariablesBody
      .setLayout(new BoxLayout(pnlSingleVariablesBody, BoxLayout.Y_AXIS));
    // no beam tilt
    JPanel pnlNoBeamTilt = new JPanel();
    pnlNoBeamTilt.setLayout(new BoxLayout(pnlNoBeamTilt, BoxLayout.X_AXIS));
    pnlNoBeamTilt.add(rbNoBeamTilt.getComponent());
    pnlNoBeamTilt.add(Box.createHorizontalGlue());
    bgBeamTiltOption.add(rbNoBeamTilt.getAbstractButton());
    // fixed beam tilt
    JPanel pnlFixedBeamTilt = new JPanel();
    pnlFixedBeamTilt.setLayout(new BoxLayout(pnlFixedBeamTilt, BoxLayout.X_AXIS));
    pnlFixedBeamTilt.add(rtfFixedBeamTilt.getContainer());
    pnlFixedBeamTilt.add(Box.createHorizontalGlue());
    // solve for beam tilt
    JPanel pnlSolveForBeamTilt = new JPanel();
    pnlSolveForBeamTilt.setLayout(new BoxLayout(pnlSolveForBeamTilt, BoxLayout.X_AXIS));
    pnlSolveForBeamTilt.add(rbSolveForBeamTilt.getComponent());
    pnlSolveForBeamTilt.add(Box.createHorizontalGlue());
    bgBeamTiltOption.add(rbSolveForBeamTilt.getAbstractButton());

    pnlSingleVariables.add(opnlSingleVariablesBody);
    JPanel pnlBeamTiltRadioButtons = new JPanel();
    pnlBeamTiltRadioButtons
      .setLayout(new BoxLayout(pnlBeamTiltRadioButtons, BoxLayout.Y_AXIS));
    pnlBeamTiltRadioButtons.setBorder(BorderFactory.createEtchedBorder());
    pnlBeamTiltRadioButtons.setAlignmentX(Component.LEFT_ALIGNMENT);
    pnlBeamTiltRadioButtons.add(pnlNoBeamTilt);
    pnlBeamTiltRadioButtons.add(pnlFixedBeamTilt);
    pnlBeamTiltRadioButtons.add(pnlSolveForBeamTilt);
    pnlSingleVariablesBody.add(pnlBeamTiltRadioButtons);
    pnlSingleVariablesBody.add(pnlBeamTiltRadioButtons);
    ...
    pnlSingleVariablesBody.add(pnlXTiltAutomapSame);
    ...
    pnlSingleVariablesBody.add(pnlProjectionStretch);
    UIUtilities.alignComponentsX(pnlSingleVariablesBody, Component.LEFT_ALIGNMENT);
  ...
  private void createVariablePanel(final EtomoPanel panel, final JPanel buttonPanel,
    final LabeledTextField groupSize, final LabeledTextField additionalGroups,
    final String title) {
    createVariablePanel(panel, buttonPanel, groupSize, additionalGroups, null, null, null,
      title, null);
  }

  private void createVariablePanel(final EtomoPanel panel, final Container buttonPanel,
    final LabeledTextField field1, final LabeledTextField field2,
    final LabeledTextField field3, final LabeledTextField field4, final CheckBox checkBox,
  ...
  private void setToolTipText() {
    ...
    // General tab
    ltfExcludeList
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, TiltalignParam.EXCLUDE_LIST_KEY));
    ltfSeparateViewGroups.setToolTipText(
    ...
    if (section != null) {
      ltfResidualThreshold
        .setToolTipText(EtomoAutodoc.getTooltip(autodocName, section, true));
      rbResidAllViews
        .setToolTipText(EtomoAutodoc.getTooltip(autodocName, section, "all"));
      rbResidNeighboring
        .setToolTipText(EtomoAutodoc.getTooltip(autodocName, section, "neighboring"));
    }
    section = autodoc.getSection(EtomoAutodoc.FIELD_SECTION_NAME,
      TiltalignParam.SURFACES_TO_ANALYZE_KEY);
    if (section != null) {
      rbSingleFiducialSurface
        .setToolTipText(EtomoAutodoc.getTooltip(autodocName, section, "1")
          + "  Use if fiducials are on one surface or distributed in Z.");
      rbDualFiducialSurfaces
        .setToolTipText(EtomoAutodoc.getTooltip(autodocName, section, "2"));
    }
    ltfTiltAngleOffset
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, TiltalignParam.ANGLE_OFFSET_KEY));
    ltfTiltAxisZShift
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, TiltalignParam.AXIS_Z_SHIFT_KEY));
    ltfMetroFactor
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, TiltalignParam.METRO_FACTOR_KEY));
    ltfMaximumCycles.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.MAXIMUM_CYCLES_KEY));
    cbLocalAlignments.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_ALIGNMENTS_KEY));
    rtfTargetPatchSizeXandY.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.TARGET_PATCH_SIZE_X_AND_Y_KEY));
    rtfNLocalPatches.setToolTipText(EtomoAutodoc.getTooltip(autodoc,
      TiltalignParam.NUMBER_OF_LOCAL_PATCHES_X_AND_Y_KEY));
    ltfMinLocalPatchSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.MIN_SIZE_OR_OVERLAP_X_AND_Y_KEY));
    ltfMinLocalFiducials.setToolTipText(EtomoAutodoc.getTooltip(autodoc,
      TiltalignParam.MIN_FIDS_TOTAL_AND_EACH_SURFACE_KEY));
    cbFixXYZCoordinates.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.FIX_XYZ_COORDINATES_KEY));
    ctfRobustFittingAndKFactorScaling.setCheckBoxToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.ROBUST_FITTING_KEY));
    ctfRobustFittingAndKFactorScaling.setFieldToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.K_FACTOR_SCALING_KEY));
    cbWeightWholeTracks.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.WEIGHT_WHOLE_TRACKS_KEY));
    // Global variables
    section =
      autodoc.getSection(EtomoAutodoc.FIELD_SECTION_NAME, TiltalignParam.TILT_OPTION_KEY);
    if (section != null) {
      rbTiltAngleFixed.setToolTipText(
        EtomoAutodoc.getTooltip(autodocName, section, TiltalignParam.FIXED_OPTION));
      rbTiltAngleAll.setToolTipText(
        EtomoAutodoc.getTooltip(autodocName, section, TiltalignParam.TILT_ALL_OPTION));
      rbTiltAngleAutomap.setToolTipText(EtomoAutodoc.getTooltip(autodocName, section,
        TiltalignParam.TILT_AUTOMAPPED_OPTION));
    }
    ltfTiltAngleGroupSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.TILT_DEFAULT_GROUPING_KEY));
    ltfTiltAngleNonDefaultGroups.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.TILT_NONDEFAULT_GROUP_KEY));

    section =
      autodoc.getSection(EtomoAutodoc.FIELD_SECTION_NAME, TiltalignParam.MAG_OPTION_KEY);
    if (section != null) {
      rbMagnificationFixed.setToolTipText(
        EtomoAutodoc.getTooltip(autodocName, section, TiltalignParam.FIXED_OPTION));
      rbMagnificationAll.setToolTipText(
        EtomoAutodoc.getTooltip(autodocName, section, TiltalignParam.ALL_OPTION));
      rbMagnificationAutomap.setToolTipText(
        EtomoAutodoc.getTooltip(autodocName, section, TiltalignParam.AUTOMAPPED_OPTION));
    }
    ltfMagnificationReferenceView.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.MAG_REFERENCE_VIEW_KEY));
    ltfMagnificationGroupSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.MAG_DEFAULT_GROUPING_KEY));
    ltfMagnificationNonDefaultGroups.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.MAG_NONDEFAULT_GROUP_KEY));

    section =
      autodoc.getSection(EtomoAutodoc.FIELD_SECTION_NAME, TiltalignParam.ROT_OPTION_KEY);
    if (section != null) {
      rbRotationNone.setToolTipText(
        EtomoAutodoc.getTooltip(autodocName, section, TiltalignParam.NONE_OPTION));
      rbRotationAll.setToolTipText(
        EtomoAutodoc.getTooltip(autodocName, section, TiltalignParam.ALL_OPTION));
      rbRotationAutomap.setToolTipText(
        EtomoAutodoc.getTooltip(autodocName, section, TiltalignParam.AUTOMAPPED_OPTION));
      rbRotationOne.setToolTipText(
        EtomoAutodoc.getTooltip(autodocName, section, TiltalignParam.SINGLE_OPTION));
    }
    ltfRotationAngle
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, TiltalignParam.ROT_ANGLE_KEY));
    ltfRotationGroupSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.ROT_DEFAULT_GROUPING_KEY));
    ltfRotationNonDefaultGroups.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.ROT_NONDEFAULT_GROUP_KEY));
    ...
    rbDistortionSkew
      .setToolTipText(EtomoAutodoc.getTooltip(autodoc, TiltalignParam.SKEW_OPTION_KEY));
    ltfXstretchGroupSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.X_STRETCH_DEFAULT_GROUPING_KEY));
    ltfXstretchNonDefaultGroups.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.X_STRETCH_NONDEFAULT_GROUP_KEY));
    ltfSkewGroupSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.SKEW_DEFAULT_GROUPING_KEY));
    ltfSkewNonDefaultGroups.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.SKEW_NONDEFAULT_GROUP_KEY));
    cbProjectionStretch.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.PROJECTION_STRETCH_KEY));
    // local variables
    cbLocalRotation.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_ROT_OPTION_KEY));
    ltfLocalRotationGroupSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_ROT_DEFAULT_GROUPING_KEY));
    ltfLocalRotationNonDefaultGroups.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_ROT_NONDEFAULT_GROUP_KEY));
    cbLocalTiltAngle.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_TILT_OPTION_KEY));
    ltfLocalTiltAngleGroupSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_TILT_DEFAULT_GROUPING_KEY));
    ltfLocalTiltAngleNonDefaultGroups.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_TILT_NONDEFAULT_GROUP_KEY));
    cbLocalMagnification.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_MAG_OPTION_KEY));
    ltfLocalMagnificationGroupSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_MAG_DEFAULT_GROUPING_KEY));
    ltfLocalMagnificationNonDefaultGroups.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_MAG_NONDEFAULT_GROUP_KEY));
    ...
    rbLocalDistortionSkew.setToolTipText(
    ...
    ltfLocalSkewGroupSize.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_SKEW_DEFAULT_GROUPING_KEY));
    ltfLocalSkewNonDefaultGroups.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.LOCAL_SKEW_NONDEFAULT_GROUP_KEY));
    rbNoBeamTilt.setToolTipText("The beam axis is perpendicular to tilt axis");
    rtfFixedBeamTilt.setRadioButtonToolTipText(
      "Set the non-perpendicularity between tilt axis and beam axis.");
    rtfFixedBeamTilt.setTextFieldToolTipText(
      EtomoAutodoc.getTooltip(autodoc, TiltalignParam.FIXED_OR_INITIAL_BEAM_TILT));
    rbSolveForBeamTilt
    ...
    btnRestrictalign.setToolTipText(
    ...
    ltfTargetMeasurementRatio.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, RestrictalignParam.TARGET_MEASUREMENT_RATIO_KEY));
    ltfMinMeasurementRatio.setToolTipText(
      EtomoAutodoc.getTooltip(autodoc, RestrictalignParam.MIN_MEASUREMENT_RATIO_KEY));
  }
  ...
  private static final class TabChangeListener implements ChangeListener {
    ...
    TabChangeListener(TiltalignPanel tiltalignPanel) {
      this.tiltalignPanel = tiltalignPanel;
    }
