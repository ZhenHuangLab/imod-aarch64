 ...
 * <p> </p>
 */
class TomogramProcessPanel extends AxisProcessPanel {
  ...
  private ProcessControlPanel procCtlPreProc =
    new ProcessControlPanel(DialogType.PRE_PROCESSING);
  private ProcessControlPanel procCtlCoarseAlign =
    new ProcessControlPanel(DialogType.COARSE_ALIGNMENT);
  private ProcessControlPanel procCtlFiducialModel =
    new ProcessControlPanel(DialogType.FIDUCIAL_MODEL);
  private ProcessControlPanel procCtlFineAlignment =
    new ProcessControlPanel(DialogType.FINE_ALIGNMENT);
  private ProcessControlPanel procCtlTomogramPositioning =
    new ProcessControlPanel(DialogType.TOMOGRAM_POSITIONING);
  private ProcessControlPanel procCtlFinalAlignedStack =
    new ProcessControlPanel(DialogType.FINAL_ALIGNED_STACK);
  private ProcessControlPanel procCtlTomogramGeneration =
    new ProcessControlPanel(DialogType.TOMOGRAM_GENERATION);
  private ProcessControlPanel procCtlTomogramCombination =
    new ProcessControlPanel(DialogType.TOMOGRAM_COMBINATION);
  private ProcessControlPanel procCtlPostProcessing =
    new ProcessControlPanel(DialogType.POST_PROCESSING);
  private ProcessControlPanel procCtlCleanUp =
    new ProcessControlPanel(DialogType.CLEAN_UP);
   ...
   * @param axis
   */
  TomogramProcessPanel(ApplicationManager appManager, AxisID axis,
    final AxisProgressPanel axisProgressPanel) {
    super(axis, appManager, true, true, InterfaceType.RECON, false, axisProgressPanel);
  ...
  void buttonAxisAction(ActionEvent event) {
   ...
   */
  void buttonProcessAction(ActionEvent event) {
    String command = event.getActionCommand();
   ...
   */
  void setPreProcState(ProcessState state) {
   ...
   */
  void setCoarseAlignState(ProcessState state) {
   ...
   */
  void setFiducialModelState(ProcessState state) {
   ...
   * @param state
   */
  void setFineAlignmentState(ProcessState state) {
   ...
   * @param state
   */
  void setTomogramPositioningState(ProcessState state) {
   ...
   * @param state
   */
  void setFinalAlignedStackState(ProcessState state) {
   ...
   * @param state
   */
  void setTomogramGenerationState(ProcessState state) {
   ...
   * @param state
   */
  void setTomogramCombinationState(ProcessState state) {
   ...
   * @param state
   */
  void setPostProcessingState(ProcessState state) {
   ...
   * @param state
   */
  void setCleanUpState(ProcessState state) {
  ...
  private void setToolTipText() {
    ...
    procCtlFinalAlignedStack.setToolTipText(
