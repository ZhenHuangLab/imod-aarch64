 ...
 *          <p> </p>
 */
final class LabeledSpinner implements TextFieldInterface, ChangeListener, FocusListener {
  ...
  void setValue(final String value, final boolean nonempty) {
    if (!nonempty || (value != null && !value.isEmpty())) {
      setValue(value);
    }
  }
