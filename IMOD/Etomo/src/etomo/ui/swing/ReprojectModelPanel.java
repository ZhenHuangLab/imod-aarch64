...
final class ReprojectModelPanel implements TiltDisplay, Run3dmodButtonContainer {
  ...
  private final ActionListener actionListener =
    new ReprojectModelPanelActionListener(this);
  private final Run3dmodButton btn3dmodReprojectModel =
    Run3dmodButton.get3dmodInstance("View 2D Model on Aligned Stack", this);
  ...
  private ReprojectModelPanel(ApplicationManager manager, AxisID axisID,
    ...
    btnReprojectModel =
      (Run3dmodButton) manager.getProcessResultDisplayFactory(axisID).getReprojectModel();
  }
  ...
  void setParameters(ReconScreenState screenState) {
    btnReprojectModel
      .setButtonState(screenState.getButtonState(btnReprojectModel.getButtonStateKey()));
  }
