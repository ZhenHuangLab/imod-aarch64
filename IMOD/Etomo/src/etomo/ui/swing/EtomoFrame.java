 ...
 * <p>Description: </p>
 * 
 * <p>Copyright: Copyright 2005 - 2017 by the Regents of the University of Colorado</p>
 * 
...
abstract class EtomoFrame extends AbstractFrame {
  ...
  void displayInfoMessage(BaseManager manager, String message, String title,
    AxisID axisID) {
    getFrame(axisID).openInfoMessageDialog(manager, null, axisID, message, title);
  }
  ...
  private boolean getParamFilename() {
    ...
    JFileChooser chooser = new FileChooser(currentManager);
  ...
  private File openDataFileDialog() {
    ...
    JFileChooser chooser =
      new FileChooser(currentManager, System.getProperty("user.dir"));
