 ...
 * <p> </p>
 */
 public final class ExpandButton extends SingleLineButton implements TableComponent, Expander {
  ...
  private ExpandButton(final Expandable expandable1, final Expandable expandable2,
    ...
    setManualName();
    setText(type.getSymbol(expanded));
 ...
 public void setButtonState(final boolean state) {
   ...
   * @return
   */
  public boolean equals(final ExpandButton that) {
