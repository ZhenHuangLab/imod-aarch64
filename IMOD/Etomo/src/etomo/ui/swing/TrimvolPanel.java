...
final class TrimvolPanel
  implements Run3dmodButtonContainer, RubberbandContainer, TrimvolDisplay {
  ...
  private LabeledTextField ltfFixedScaleMin =
    new LabeledTextField(FieldType.INTEGER, FIXED_SCALE_MIN_LABEL);
  private LabeledTextField ltfFixedScaleMax =
    new LabeledTextField(FieldType.INTEGER, FIXED_SCALE_MAX_LABEL);

  private RadioButton rbScaleSection = new RadioButton("Find scaling from sections  ");
  private JPanel pnlScaleSection = new JPanel();
  private LabeledTextField ltfSectionScaleMin =
    new LabeledTextField(FieldType.INTEGER, SECTION_SCALE_MIN_LABEL);
  private LabeledTextField ltfSectionScaleMax =
    new LabeledTextField(FieldType.INTEGER, SECTION_SCALE_MAX_LABEL);
  ...
  private Run3dmodButton btnImodFull =
    Run3dmodButton.get3dmodInstance("3dmod Full Volume", this);
  private final Run3dmodButton btnTrimvol;
  private Run3dmodButton btnImodTrim =
    Run3dmodButton.get3dmodInstance("3dmod Trimmed Volume", this);
  private MultiLineButton btnGetCoordinates =
    new MultiLineButton("Get XYZ Volume Range From 3dmod");
   ...
   * Default constructor
   */
  TrimvolPanel(final ApplicationManager appMgr, final AxisID axisID,
    ...
    // panels
    pnlScaleRubberband =
      RubberbandPanel.getNoButtonInstance(appMgr, this, ImodManager.COMBINED_TOMOGRAM_KEY,
        "Scaling from sub-area:", "Get XYZ Sub-Area From 3dmod",
    ...
    btnTrimvol =
      (Run3dmodButton) appMgr.getProcessResultDisplayFactory(AxisID.ONLY).getTrimVolume();
    ...
    pnlReorientationChoices
      .setBorder(new EtchedBorder(REORIENTATION_GROUP_LABEL).getBorder());
  ...
  void initParameters(final TrimvolParam param) {
    ...
    // ConvertToBytes default is coming from metadata where is can be overridden by
    // batchruntomo.
    ...
    volumeRangePanel.initParameters(param);
    pnlScaleRubberband.initScaleParameters(param);
    setScaleState();
  }
  ...
  /**
   * @param inputFileState
   * @return true if a warning that says "...values have been restored to defaults" has
   * been displayed.
   */
  boolean setStartupWarnings(final TrimvolInputFileState inputFileState) {
    // set warning
  ...
  boolean getParameters(TrimvolParam trimvolParam, final boolean doValidation) {
    ...
    try {
      ...
      if (rbScaleFixed.isSelected()) {
        ...
        try {
          errorMessage =
            trimvolParam.setFixedScaleMin(ltfFixedScaleMin.getText(doValidation))
          ...
          errorMessage =
            trimvolParam.setFixedScaleMax(ltfFixedScaleMax.getText(doValidation))
        ...
        try {
          errorMessage =
            trimvolParam.setSectionScaleMin(ltfSectionScaleMin.getText(doValidation))
          ...
          errorMessage =
            trimvolParam.setSectionScaleMax(ltfSectionScaleMax.getText(doValidation))
  ...
  public void setSwapYZ(final boolean input) {
    if (input) {
      rbSwapYZ.setSelected(input);
    }
  }

  public void setRotateX(final boolean input) {
    if (input) {
      rbRotateX.setSelected(input);
    }
  }

  public void setConvertToBytes(final boolean input) {
    cbConvertToBytes.setSelected(input);
  }

  public void setSectionScaleMin(final String input) {
    ltfSectionScaleMin.setText(input);
  }

  public void setSectionScaleMax(final String input) {
    ltfSectionScaleMax.setText(input);
  }

  public void setZMin(final String input) {
    volumeRangePanel.setZMin(input);
  }

  public void setZMax(final String input) {
    volumeRangePanel.setZMax(input);
  }

  public void setScaleXMin(final String input) {
    pnlScaleRubberband.setXMin(input);
  }

  public void setScaleXMax(final String input) {
    pnlScaleRubberband.setXMax(input);
  }

  public void setScaleYMin(final String input) {
    pnlScaleRubberband.setYMin(input);
  }

  public void setScaleYMax(final String input) {
    pnlScaleRubberband.setYMax(input);
  }

  /**
   * Set scale section Min if selected.  From the subarea scale.
   */
  public void setRubberbandContainerZMin(final String sectionScaleMin) {
    if (rbScaleSection.isSelected()) {
      ltfSectionScaleMin.setText(sectionScaleMin);
    }
  }

  /**
   * Set scale section Max if selected.  From the subarea scale.
   */
  public void setRubberbandContainerZMax(final String sectionScaleMax) {
    if (rbScaleSection.isSelected()) {
      ltfSectionScaleMax.setText(sectionScaleMax);
    }
  }
   ...
   * @param event
   */
  void scaleAction(ActionEvent event) {
    setScaleState();
  }
  ...
  public void action(final String command, Deferred3dmodButton deferred3dmodButton,
    ...
    if (command == btnTrimvol.getActionCommand()) {
      ...
      volumeRangePanel.setXYMinAndMax(applicationManager
        .imodGetRubberbandCoordinates(ImodManager.COMBINED_TOMOGRAM_KEY, AxisID.ONLY));
    }
  ...
  private void setToolTipText() {
    ...
    ltfFixedScaleMin.setToolTipText(
      "Enter the black contrast slider setting (0-254) that gives the desired "
        + "contrast.");
    ltfFixedScaleMax.setToolTipText(
      "Enter the white contrast slider setting (1-255) that gives the desired "
        + "contrast.");
    rbScaleSection.setToolTipText(
      "Set the scaling based on the range of contrast in a subset of sections and XY volume.  "
    ...
    rbNone.setToolTipText("Do not change the orientation of the output volume.  "
      + "The file will need to be flipped when loaded into 3dmod.");
    rbSwapYZ.setToolTipText(
      "Flip Y and Z in the output volume so that the file does not need to be "
        + "flipped when loaded into 3dmod.");
    rbRotateX.setToolTipText("Rotate the output volume by -90 degrees around the X axis, "
