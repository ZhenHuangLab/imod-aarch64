...
* <p> $Log$ </p>
*/
 class GpuTiltTestPanel implements ToolPanel, ContextMenu {
  ...
  private GpuTiltTestPanel(final ToolsManager manager, final AxisID axisID) {
   ...
   static GpuTiltTestPanel getInstance(final ToolsManager manager,
      final AxisID axisID) {
  ...
  private void addListeners() {
   ...
   boolean getParameters(final GpuTiltTestParam param, final boolean doValidation) {
    try {
