...
final class Viewport {
  ...
  Viewport(final Viewable viewable, final int size, final String uniqueKey) {
    this.viewable = viewable;
    if (size < MINUMUM_SIZE || size == EtomoNumber.INTEGER_NULL_VALUE) {
  ...
  void initPaging() {
    pagingPanel = PagingPanel.getInstance(this, uniqueKey);
    pagingPanel.setVisible(false);
  }

  JComponent[] getFocusableParents() {
    return viewable.getFocusableParents();
  }
