...
final class EraseGoldPanel implements ContextMenu {
  ...
  private final EraseGoldPanelActionListener actionListener =
    new EraseGoldPanelActionListener(this);
  private final ButtonGroup bgModel = new ButtonGroup();
  private final RadioButton rbModelUseFid =
    new RadioButton("Use the existing fiducial model", bgModel);
  private final RadioButton rbModelUseFindBeads3d =
    new RadioButton("Use findbeads3d", bgModel);
  ...
  private EraseGoldPanel(final ApplicationManager manager, final AxisID axisID,
    ...
    beads3dFindPanel =
      Beads3dFindPanel.getInstance(manager, axisID, dialogType, globalAdvancedButton);
  ...
  static EraseGoldPanel getInstance(ApplicationManager manager, AxisID axisID,
    ...
    EraseGoldPanel instance =
      new EraseGoldPanel(manager, axisID, dialogType, globalAdvancedButton);
  ...
  void reregisterProcessingMethodMediator() {
    beads3dFindPanel.reregisterProcessingMethodMediator();
  }
  ...
  public void popUpContextMenu(final MouseEvent mouseEvent) {
    ...
    String[] manPagelabel =
      { alignManpageLabel, "Tilt", "Findbeads3d", "CcdEraser", "3dmod" };
    ...
    ContextPopup contextPopup =
      new ContextPopup(pnlRoot, mouseEvent, "ErasingGold", ContextPopup.TOMO_GUIDE,
  ...
  void setParameters(ConstCCDEraserParam param) {
    ccdEraserBeadsPanel.setParameters(param);
  }
