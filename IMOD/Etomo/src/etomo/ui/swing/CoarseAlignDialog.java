...
public final class CoarseAlignDialog extends ProcessDialog
  ...
  private CoarseAlignDialog(final ApplicationManager appMgr, final AxisID axisID,
    ...
    btnDistortionCorrectedStack =
      (MultiLineButton) displayFactory.getDistortionCorrectedStack();
    ...
    pnlPrenewst =
      new PrenewstPanel(applicationManager, axisID, dialogType, this, btnAdvanced);
  ...
  public void setEnabledFixEdgesMidasButton() {
    if (btnDistortionCorrectedStack.isEnabled()
      && !BlendmontParam.getDistortionCorrectedFile(applicationManager,
        applicationManager.getPropertyUserDir(), axisID).exists()) {
  ...
  public void popUpContextMenu(final MouseEvent mouseEvent) {
    ...
    if (applicationManager.getMetaData().getViewType() == ViewType.MONTAGE) {
      ...
      if (!DatasetTool.isOneBy(applicationManager.getPropertyUserDir(),
        ...
        axisID) && applicationManager.getState().isXcorrBlendmontWasRun(axisID)) {
    ...
    String[] manPagelabel =
      { "Tiltxcorr", "Xftoxg", alignManpageLabel, "3dmod", "Midas" };
  ...
  private void setToolTipText() {
    ...
    ltfRotation.setToolTipText(
      "Initial rotation angle of tilt axis when viewing images in Midas.");
    btnDistortionCorrectedStack.setToolTipText(
  ...
  public void action(final String command, final Deferred3dmodButton deferred3dmodButton,
    ...
    if (command.equals(btnMidas.getActionCommand())) {
      ...
      applicationManager.makeDistortionCorrectedStack(axisID, btnDistortionCorrectedStack,
        null);
    }
  }
