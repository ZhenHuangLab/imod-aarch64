 ...
 * <p> </p>
 */
public class TiltPanel extends AbstractTiltPanel /*implements ResumeObserver */ {
  private final JPanel pnlTiltPanelRoot = new JPanel();

  protected final TomogramGenerationDialog parent;

  protected TiltPanel(final ApplicationManager manager, final AxisID axisID,
  ...
  public final boolean allowTiltComSave() {
    return true;
  }

  @Deprecated // 9/13/2018 See TiltDisplay.
  public final boolean isResume() {
    return false;
  }

  @Override
  public final boolean isBackProjection() {
    return parent.isBackProjection();
  }

  @Override
  public final boolean isMultifilt() {
    return parent.isMultifilt();
  }

  protected final boolean isSirt() {
    return parent.isSirt();
  }

  @Override
  protected boolean isMethodPlugin() {
    return parent.isMethodPlugin();
  }

  @Deprecated // 8/6/18 Saving tilt.com no longer effects SIRT resume - Bug# 2098, comment
              // 10
  public final void msgResumeChanged(boolean resume) {}
  ...
  protected void setAdvancedFieldDisplayer() {
    super.setAdvancedFieldDisplayer();
    ltfZShift.setFieldDisplayer(advancedFieldDisplayer);
  }

  final void tiltAction(final ProcessResultDisplay processResultDisplay,
  ...
  final void imodTomogramAction(final Deferred3dmodButton deferred3dmodButton,
    final Run3dmodMenuOptions run3dmodMenuOptions) {
    manager.imodFullVolume(axisID, run3dmodMenuOptions);
  }

  final void popUpContextMenu(final String anchor, final Component rootPanel,
  ...
  @Override
  protected final void setToolTipText() {
