 ...
 * @version $Id$
 */
public final class Run3dmodButton extends MultiLineButton
  ...
  private Run3dmodButton(final String label, final Run3dmodButtonContainer container,
    ...
    String description) {
    super(label, toggleButton, dialogType, false, false, false);
  ...
  public static Run3dmodButton get3dmodInstance(final String label,
    final Run3dmodButtonContainer container) {
    Run3dmodButton instance =
      new Run3dmodButton(label, container, false, null, false, null);
  ...
  static Run3dmodButton getToggle3dmodInstance(final String label,
    ...
    Run3dmodButton instance =
      new Run3dmodButton(label, null, true, dialogType, false, null);
    instance.addListeners();
    return instance;
  }

  public static Run3dmodButton getDeferred3dmodInstance(final String label,
    final Run3dmodButtonContainer container) {
    Run3dmodButton instance =
      new Run3dmodButton(label, container, false, null, true, null);
    instance.addListeners();
    return instance;
  }
  ...
  static Run3dmodButton getDeferred3dmodInstance(final String label,
    ...
    Run3dmodButton instance =
      new Run3dmodButton(label, container, false, null, true, description);
    instance.addListeners();
    return instance;
  }
  ...
  public static Run3dmodButton getDeferredToggle3dmodInstance(final String label,
    final DialogType dialogType) {
    Run3dmodButton instance =
      new Run3dmodButton(label, null, true, dialogType, true, null);
    instance.addListeners();
    return instance;
  }
...
public  void setDeferred3dmodButton(Deferred3dmodButton input) {
 ...
 public Deferred3dmodButton getDeferred3dmodButton() {
    return deferred3dmodButton;
  }

  public void setContainer(final Run3dmodButtonContainer container) {
    this.container = container;
  }
