...
/**
 * <p>Description: Tells one or more fields about a change in the flag type.  Flag types are
 * template error, error, and template.  The field can then change the display if it
 * knows how to react to the flag setting.  For instance a template flag causes some part
 * of a field to turn blue.  And error flag causes a field to turn red in the same way.
 * Replaces FlagExtension.</p>
 * 
 ...
 * @version $Id$
 */
public final class TextFlagExtension implements FlagOriginListener {
  private final TextFlagOrigin flagOrigin;
  ...
  public TextFlagExtension(final TextFlagOrigin flagOrigin) {
