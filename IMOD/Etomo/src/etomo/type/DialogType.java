...
public final class DialogType {
  ...
  public static final DialogType SETUP_RECON =
    new DialogType(DataFileType.RECON, setupIndex);
  public static final DialogType PRE_PROCESSING =
    new DialogType(DataFileType.RECON, preProcessingIndex);
  public static final DialogType COARSE_ALIGNMENT =
    new DialogType(DataFileType.RECON, coarseAlignmentIndex);
  public static final DialogType FIDUCIAL_MODEL =
    new DialogType(DataFileType.RECON, fiducialModelIndex);
  public static final DialogType FINE_ALIGNMENT =
    new DialogType(DataFileType.RECON, fineAlignmentIndex);

  public static final DialogType TOMOGRAM_POSITIONING =
    new DialogType(DataFileType.RECON, tomogramPositioningIndex);
  public static final DialogType FINAL_ALIGNED_STACK =
    new DialogType(DataFileType.RECON, finalAlignedStackIndex);
  public static final DialogType TOMOGRAM_GENERATION =
    new DialogType(DataFileType.RECON, tomogramGenerationIndex);
  public static final DialogType TOMOGRAM_COMBINATION =
    new DialogType(DataFileType.RECON, tomogramCombinationIndex);
  public static final DialogType POST_PROCESSING =
    new DialogType(DataFileType.RECON, postProcessingIndex);
  public static final DialogType CLEAN_UP =
    new DialogType(DataFileType.RECON, cleanUpIndex);

  public static final DialogType JOIN = new DialogType(DataFileType.JOIN, joinIndex);

  public static final DialogType PARALLEL =
    new DialogType(DataFileType.PARALLEL, parallelIndex);
  public static final DialogType ANISOTROPIC_DIFFUSION =
  ...
  public static final DialogType SERIAL_SECTIONS_STARTUP =
    new DialogType(DataFileType.SERIAL_SECTIONS, 0);
  public static final DialogType SERIAL_SECTIONS =
  ...
  public static final DialogType DIRECTIVE_EDITOR =
    new DialogType(DataFileType.DIRECTIVE_EDITOR, 0);

  public static final DialogType BATCH_RUN_TOMO =
    new DialogType(DataFileType.BATCH_RUN_TOMO, 0);
  ...
  public static DialogType load(DataFileType dataFileType, Properties props) {
    ...
    if (defaultType != null) {
      return getInstance(props
        .getProperty(DialogType.PROPERTIES_KEY, defaultType.toString()));
    }
