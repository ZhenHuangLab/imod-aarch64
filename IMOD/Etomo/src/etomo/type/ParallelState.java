...
public final class ParallelState extends BaseState {
  ...
  private final ParsedArray testKValueList =
    ParsedArray.getInstance(EtomoNumber.Type.DOUBLE, "TestKValueList", null);
  ...
  public ParallelState(BaseManager manager, AxisID axisID) {
    ...
    testKValueList.setBackwardCompatibleNullKey();
  }
