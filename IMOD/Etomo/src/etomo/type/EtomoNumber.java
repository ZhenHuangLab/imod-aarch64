...
public class EtomoNumber extends ConstEtomoNumber {
  ...
  /**
   * Set the type and value from number
   * @param number
   */
  public EtomoNumber(final Number number) {
    super(Type.getType(number));
    set(number);
  }
  ...
  public boolean isKeyPresent(Properties props, String prepend) {
    if (props.getProperty(
      prepend == null || prepend.matches("\\s*") ? name : prepend + "." + name) == null) {
      return false;
    }
    return true;
  }
  ...
  public static EtomoNumber load(EtomoNumber instance, Type type, String name,
    ...
    String value = props.getProperty(
      prepend == null || prepend.matches("\\s*") ? name : prepend + "." + name);
    if (value == null) {
      return null;
    }
    if (instance == null) {
  ...
  public EtomoNumber set(String value) {
    ...
    if (value == null || value.matches("\\s*")) {
      ...
      currentValue =
        newNumber(applyCeilingValue(applyFloorValue(newNumber(value, invalidBuffer))));
      if (isDebug()) {
        System.out
          .println("currentValue=" + currentValue + ",invalidBuffer=" + invalidBuffer);
      }
