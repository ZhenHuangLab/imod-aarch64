...
public interface ProcessResultDisplay {
  ...
  public void setNext(ProcessResultDisplay display);

  /**
   * Controls whether a display can cause the buttons that come after it to be set to not
   * done.
   */
  public void setUseGlobalDependencyList(boolean input);

  /**
   * @return the display pointed to by the instance next pointer.
   */
  ...
  public boolean equalsID(int displayID, String factoryID);
  public void setID(int displayID, String factoryID);
