...
public final class UITestActionType {
  ...
  public static final UITestActionType GET = new UITestActionType("get");
  ...
  public static final UITestActionType PAUSE = new UITestActionType("pause");
  public static final UITestActionType PRINT = new UITestActionType("print");
  ...
  public static final UITestActionType UNSET = new UITestActionType("unset");
  ...
  // Not a command
  public static final UITestActionType DELIMETER_CHANGER =
    new UITestActionType("KeyValueDelimiter");
