...
public final class ParallelMetaData extends BaseMetaData {
  ...
  public static final String NEW_ANISOTROPIC_DIFFUSION_TITLE =
  ...
  private final EtomoNumber testKValue =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "TestKValue");
  private final StringProperty testIterationList =
    new StringProperty("TestIterationList");
  ...
  public ParallelMetaData(final BaseManager manager, final LogProperties logProperties,
    final boolean forceOldStyle, final boolean newDataset) {
    super(manager, logProperties, forceOldStyle, newDataset, true);
