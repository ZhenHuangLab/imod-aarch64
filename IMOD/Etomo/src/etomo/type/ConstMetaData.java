 ...
 * <p>Description: </p>
 *
 * <p>Copyright: Copyright 2002 - 2018 by the Regents of the University of Colorado</p>
 * <p/>
...
public interface ConstMetaData {
  ...
  public ConstEtomoNumber getGenSuperSampleFactor(AxisID axisID);

  public ConstEtomoNumber getGenExpandInputLines(AxisID axisID);

  public boolean isGenBackProjection(AxisID axisID);

  public boolean isGenFilterTrials(AxisID axisID);
  ...
  public String getRadialRadius(PanelId panelId, AxisID axisID);

  public String getRadialSigma(PanelId panelId, AxisID axisID);
  ...
  public SampleType getSampleType(AxisID axisID);

  public boolean isHasGoldBeads(AxisID axisID);

  /**
   * @deprecated 2/19/2018 incorrectly named member variable - use ...BeadSize
   */
  public double getPositioningFiducialDiameter(AxisID axisID);

  public String getPositioningBeadSize(AxisID axisID);

  public boolean isHasGoldBeadsNull(AxisID axisID);

  /**
   * @deprecated 2/19/2018 incorrectly named member variable - use ...BeadSize
   */
  public boolean isPositioningFiducialDiameterNull(AxisID axisID);

  public boolean isPositioningBeadSizeNull(AxisID axisID);

  public String getExtraThickness(AxisID axisID);

  public String getExtraThicknessCryo(AxisID axisID);

  public String getHammingLikeFilter(PanelId panelId, AxisID axisID);

  public String getFakeSIRTiterations(PanelId panelId, AxisID axisID);

  public String getExactFilterSize(PanelId panelId, AxisID axisID);
  ...
  public String getGenFilterTrialsFakeSIRTiterations(AxisID axisID);

  public String getGenFilterTrialsExactObjectSizes(AxisID axisID);

  public String getGenFilterTrialsGaussianCutoffs(AxisID axisID);

  public String getGenFilterTrialsGaussianFalloffs(AxisID axisID);

  public String getGenFilterTrialsHammingLikeStarts(AxisID axisID);

  public String getStackMtfFilterLowPassRadiusSigma(AxisID axisID);

  public String getStackMtfFilterMtfFile(AxisID axisID);

  public String getStackMtfFilterMaximumInverse(AxisID axisID);

  public String getStackMtfFilterInverseRolloffRadiusSigma(AxisID axisID);

  public boolean isUseStackMtfFilterFixedImageDose(AxisID axisID);

  public String getStackMtfFilterFixedImageDose(AxisID axisID);

  public String getStackMtfFilterDoseWeightingFile(AxisID axisID);

  public String getStackMtfFilterTypeOfDoseFile(AxisID axisID);

  public boolean isStackMtfFilterVoltage200(AxisID axisID);

  public String getStackMtfFilterOptimalDoseScaling(AxisID axisID);

  public String getStackMtfFilterBidirectionalNumViews(AxisID axisID);

  public boolean isUseStackCtfPhaseFlipXAxisTilt(AxisID axisID);

  public String getStackCtfPhaseFlipXAxisTilt(AxisID axisID);

  public String getStackCtfPhaseFlipScaleByCtfPower(AxisID axisID);
}
