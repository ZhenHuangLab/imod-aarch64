...
public class ProcessEndState {
  ...
  private static final int cancelledIndex = 4;
  ...
  public static final int TOTAL = cancelledIndex + 1;
  ...
  public static boolean isValid(final String string) {
    return DONE.equals(string) || FAILED.equals(string) || KILLED.equals(string)
      || PAUSED.equals(string) || CANCELLED.equals(string);
  }
  ...
  public static final ProcessEndState CANCELLED = new ProcessEndState(cancelledIndex);
