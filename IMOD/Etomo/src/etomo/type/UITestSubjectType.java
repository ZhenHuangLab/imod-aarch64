...
public final class UITestSubjectType {
  ...
  public static final UITestSubjectType AXIS = new UITestSubjectType("axis");
  ...
  public static final UITestSubjectType IMAGE_FILE = new UITestSubjectType("image-file");
  public static final UITestSubjectType INDEX = new UITestSubjectType("index");
  public static final UITestSubjectType INSTANCE = new UITestSubjectType("instance");
  ...
  public static final UITestSubjectType TOOL = new UITestSubjectType("tool");
  ...
  public static UITestSubjectType getInstance(String string) {
    ...
    if (string.equals(AXIS.toString())) {
      return AXIS;
    }
    ...
    if (string.equals(IMAGE_FILE.toString())) {
      return IMAGE_FILE;
    }
    if (string.equals(INDEX.toString())) {
      return INDEX;
    }
    if (string.equals(INSTANCE.toString())) {
      return INSTANCE;
    }
    ...
    if (string.equals(TOOL.toString())) {
      return TOOL;
    }
