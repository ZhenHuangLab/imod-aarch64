...
public class BaseScreenState implements Storable {
  ...
  private final PanelHeaderState parallelHeaderState =
    new PanelHeaderState(PARALLEL_HEADER_GROUP);
  private List<Storable> additionalStorables = null;
  ...
  final String getPrepend(String prepend) {
    if (prepend == "") {
      return group;
    }
    else {
  ...
  /**
   * Inserts additional items to be stored with items in this class, under its prepend.
   * @param input
   */
  public void insert(final Storable input) {
    if (input == null) {
      return;
    }
    if (additionalStorables == null) {
      additionalStorables = new ArrayList<Storable>();
    }
    additionalStorables.add(input);
  }
  ...
  public void store(Properties props, String prepend) {
    ...
    if (additionalStorables != null) {
      Iterator<Storable> iterator = additionalStorables.iterator();
  ...
  public void load(Properties props, String prepend) {
    ...
    if (additionalStorables != null) {
      Iterator<Storable> iterator = additionalStorables.iterator();
      while (!iterator.hasNext()) {
        iterator.next().load(props, prepend);
      }
    }
  }
