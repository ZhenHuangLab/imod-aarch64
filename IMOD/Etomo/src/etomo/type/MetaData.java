...
import etomo.ui.swing.TrimvolDisplay;
import etomo.util.Utilities;

/**
 * <p>Description: </p>
 *
 * <p>Copyright: Copyright 2002 - 2022 by the Regents of the University of Colorado</p>
 * 
...
public final class MetaData extends BaseMetaData implements ConstMetaData {
  ...
  private static final String CORRECTED_RAW_IMAGE_STACK_EXT_KEY_VERSION = "4.10.43";
  ...
  private static final int DEFAULT_SAMPLE_THICKNESS = 300;
  ...
  private static final String FINAL_STACK_BINNING_B_BACKWARD_COMPATABILITY_1_8 =
    "TomoGenBinningB";
  private static final double TWO_DIR_DEFAULT = 0;
  ...
  private static final String SIRT_KEY = "Sirt";
  ...
  public static final String BATCHRUNTOMO_KEY = "batchruntomo";
  public static final String COMBINE_KEY = "Combine";

  private static final String TILT_3D_FIND_A_TILT_PARALLEL_KEY =
    STACK_KEY + ".A.Tilt.Parallel";
  private static final String TILT_3D_FIND_B_TILT_PARALLEL_KEY =
    STACK_KEY + ".B.Tilt.Parallel";

  // Defaults
  private static final boolean ERASE_GOLD_MODEL_USE_FID_DEFAULT = true;

  private static final double EXTRA_THICKNESS_CRYO_DEFAULT = 25;
  private static final double CTF_SCALE_BY_CTF_POWER_DEFAULT = 0.5;

  private static final String BATCH_RUN_TOMO_LOG_FILE_AXIS_ID_KEY =
    "BatchRunTomoLog.Read.AxisID";
  ...
  private EtomoNumber imageRotationA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "ImageRotationA");
  private EtomoNumber imageRotationB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "ImageRotationB");
  EtomoNumber binning = new EtomoNumber(EtomoNumber.Type.DOUBLE, "Binning");
  ...
  // private EtomoBoolean2 cbSuperSampleFactorA = new
  // EtomoBoolean2("CbSuperSampleFactorA");
  // private EtomoBoolean2 cbSuperSampleFactorB = new
  // EtomoBoolean2("CbSuperSampleFactorB");
  ...
  private final EtomoNumber sampleThicknessA = new EtomoNumber(
    AxisID.FIRST.toString() + '.' + ProcessName.SAMPLE + '.' + THICKNESS_KEY);
  private final EtomoNumber sampleThicknessB = new EtomoNumber(
    AxisID.SECOND.toString() + '.' + ProcessName.SAMPLE + '.' + THICKNESS_KEY);
  private String firstAxisPrepend = null;
  private String secondAxisPrepend = null;
  private final EtomoBoolean2 defaultGpuProcessing =
    new EtomoBoolean2("DefaultGpuProcessing");
  /**
   * @version 1.8
   */
  ...
  private final EtomoBoolean2 noBeamTiltSelectedA =
    new EtomoBoolean2(AxisID.FIRST.getExtension() + "."
      + DialogType.FINE_ALIGNMENT.getStorableName() + ".NoBeamTiltSelected");
  private final EtomoBoolean2 fixedBeamTiltSelectedA =
    new EtomoBoolean2(AxisID.FIRST.getExtension() + "."
  ...
  private final EtomoBoolean2 noBeamTiltSelectedB =
    new EtomoBoolean2(AxisID.SECOND.getExtension() + "."
      + DialogType.FINE_ALIGNMENT.getStorableName() + ".NoBeamTiltSelected");
  private final EtomoBoolean2 fixedBeamTiltSelectedB =
    new EtomoBoolean2(AxisID.SECOND.getExtension() + "."
      + DialogType.FINE_ALIGNMENT.getStorableName() + ".FixedBeamTiltSelected");
   ...
   */
  private StringProperty finalStackBetterRadiusA =
    new StringProperty(DialogType.FINAL_ALIGNED_STACK.getStorableName() + "."
      + AxisID.FIRST.getExtension() + "." + "BetterRadius");
  /**
   * @deprecated in MetaData 1.10
   */
  private StringProperty finalStackBetterRadiusB =
    new StringProperty(DialogType.FINAL_ALIGNED_STACK.getStorableName() + "."
  ...
  private EtomoNumber finalStackExpandCircleIterationsA =
    new EtomoNumber(DialogType.FINAL_ALIGNED_STACK.getStorableName() + "."
      + AxisID.FIRST.getExtension() + "." + "ExpandCircleIterations");
  private EtomoNumber finalStackExpandCircleIterationsB =
    new EtomoNumber(DialogType.FINAL_ALIGNED_STACK.getStorableName() + "."
      + AxisID.SECOND.getExtension() + "." + "ExpandCircleIterations");
  private EtomoBoolean2 useFinalStackExpandCircleIterationsA =
    new EtomoBoolean2(DialogType.FINAL_ALIGNED_STACK.getStorableName() + "."
      + AxisID.FIRST.getExtension() + "." + "UseExpandCircleIterations");
  private EtomoNumber useFinalStackExpandCircleIterationsB =
    new EtomoBoolean2(DialogType.FINAL_ALIGNED_STACK.getStorableName() + "."
      + AxisID.SECOND.getExtension() + "." + "UseExpandCircleIterations");
  private EtomoNumber finalStackPolynomialOrderA =
    new EtomoNumber(DialogType.FINAL_ALIGNED_STACK.getStorableName() + "."
      + AxisID.FIRST.getExtension() + "." + "PolynomialOrder");
  private EtomoNumber finalStackPolynomialOrderB =
    new EtomoNumber(DialogType.FINAL_ALIGNED_STACK.getStorableName() + "."
      + AxisID.SECOND.getExtension() + "." + "PolynomialOrder");
  private IntKeyList tomoGenTrialTomogramNameListA =
    IntKeyList.getStringInstance(DialogType.TOMOGRAM_GENERATION.getStorableName() + "."
      + AxisID.FIRST.getExtension() + "." + "TrialTomogramName");
  private IntKeyList tomoGenTrialTomogramNameListB =
    IntKeyList.getStringInstance(DialogType.TOMOGRAM_GENERATION.getStorableName() + "."
   ...
   */
  private final EtomoBoolean2 trackUseRaptorA =
    new EtomoBoolean2(TRACK_KEY + "." + FIRST_AXIS_KEY + "." + USE_KEY + RAPTOR_KEY);
  ...
  private final EtomoNumber trackRaptorMarkA =
    new EtomoNumber(TRACK_KEY + "." + FIRST_AXIS_KEY + "." + RAPTOR_KEY + "." + MARK_KEY);
  private final EtomoNumber trackRaptorDiamA =
    new EtomoNumber(TRACK_KEY + "." + FIRST_AXIS_KEY + "." + RAPTOR_KEY + "." + DIAM_KEY);
  ...
  private final EtomoNumber stack3dFindBinningA =
    new EtomoNumber(STACK_KEY + "." + FIRST_AXIS_KEY + "." + "3dFind.Binning");
  private final EtomoNumber stack3dFindBinningB =
    new EtomoNumber(STACK_KEY + "." + SECOND_AXIS_KEY + "." + "3dFind.Binning");

  private final EtomoBoolean2 postFlattenInputTrimVol =
    new EtomoBoolean2(POST_KEY + "." + FLATTEN_KEY + "." + INPUT_KEY + TRIM_VOL_KEY);
  ...
  private final EtomoNumber postFlattenWarpSpacingInX =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      POST_KEY + "." + FLATTEN_WARP_KEY + "." + SPACING_IN_KEY + X_KEY);
  private final EtomoNumber postFlattenWarpSpacingInY =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      POST_KEY + "." + FLATTEN_WARP_KEY + "." + SPACING_IN_KEY + Y_KEY);

  private final EtomoBoolean2 postSqueezeVolInputTrimVol =
    new EtomoBoolean2(POST_KEY + "." + SQUEEZE_VOL_KEY + "." + INPUT_KEY + TRIM_VOL_KEY);
  ...
  private final EtomoNumber lambdaForSmoothing =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, POST_KEY + ".LambdaForSmoothing");
  private final StringProperty lambdaForSmoothingList =
    new StringProperty(POST_KEY + ".LambdaForSmoothingList");

  private final StringProperty trackOverlapOfPatchesXandYA =
    new StringProperty(TRACK_KEY + "." + FIRST_AXIS_KEY + ".OverlapOfPatchesXandY");
  private final StringProperty trackOverlapOfPatchesXandYB =
    new StringProperty(TRACK_KEY + "." + SECOND_AXIS_KEY + ".OverlapOfPatchesXandY");
  private final StringProperty trackNumberOfPatchesXandYA =
    new StringProperty(TRACK_KEY + "." + FIRST_AXIS_KEY + ".NumberOfPatchesXandY");
  private final StringProperty trackNumberOfPatchesXandYB =
    new StringProperty(TRACK_KEY + "." + SECOND_AXIS_KEY + ".NumberOfPatchesXandY");
  /**
   * @deprecated
   */
  private final StringProperty trackLengthAndOverlapA =
    new StringProperty(TRACK_KEY + "." + FIRST_AXIS_KEY + ".LengthAndOverlap");
  /**
   * @deprecated
   */
  private final StringProperty trackLengthAndOverlapB =
    new StringProperty(TRACK_KEY + "." + SECOND_AXIS_KEY + ".LengthAndOverlap");
  private final StringProperty trackMethodA =
    new StringProperty(TRACK_KEY + "." + FIRST_AXIS_KEY + ".TrackMethod");
  private final StringProperty trackMethodB =
    new StringProperty(TRACK_KEY + "." + SECOND_AXIS_KEY + ".TrackMethod");
  /**
   * fineExists is true if the fine alignment dialog has opened at least once.
   */
  private final EtomoBoolean2 fineExistsA =
    new EtomoBoolean2(FINE_KEY + "." + FIRST_AXIS_KEY + ".Exists");
  private final EtomoBoolean2 fineExistsB =
    new EtomoBoolean2(FINE_KEY + "." + SECOND_AXIS_KEY + ".Exists");

  private final EtomoNumber genLogA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, GEN_KEY + "." + FIRST_AXIS_KEY + ".Log");
  private final EtomoNumber genLogB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, GEN_KEY + "." + SECOND_AXIS_KEY + ".Log");
   ...
   * once.
   */
  private final EtomoBoolean2 genExistsA =
    new EtomoBoolean2(GEN_KEY + "." + FIRST_AXIS_KEY + ".Exists");
  private final EtomoBoolean2 genExistsB =
    new EtomoBoolean2(GEN_KEY + "." + SECOND_AXIS_KEY + ".Exists");
  /**
  ...
  private final EtomoBoolean2 genBackProjectionA =
    new EtomoBoolean2(GEN_KEY + "." + FIRST_AXIS_KEY + ".BackProjection");
  private final EtomoBoolean2 genBackProjectionB =
    new EtomoBoolean2(GEN_KEY + "." + SECOND_AXIS_KEY + ".BackProjection");
  private final EtomoBoolean2 genSubareaA =
    new EtomoBoolean2(GEN_KEY + "." + FIRST_AXIS_KEY + ".Subarea");
  private final EtomoBoolean2 genSubareaB =
    new EtomoBoolean2(GEN_KEY + "." + SECOND_AXIS_KEY + ".Subarea");
  private final StringProperty genSubareaSizeA =
    new StringProperty(GEN_KEY + "." + FIRST_AXIS_KEY + ".SubareaSize");
  private final StringProperty genSubareaSizeB =
    new StringProperty(GEN_KEY + "." + SECOND_AXIS_KEY + ".SubareaSize");
  private final StringProperty genYOffsetOfSubareaA =
    new StringProperty(GEN_KEY + "." + FIRST_AXIS_KEY + ".YOffsetOfSubarea");
  private final StringProperty genYOffsetOfSubareaB =
    new StringProperty(GEN_KEY + "." + SECOND_AXIS_KEY + ".YOffsetOfSubarea");
  private final StringProperty genRadialRadiusA =
    new StringProperty(GEN_KEY + "." + FIRST_AXIS_KEY + ".RadialRadius");
  private final StringProperty genRadialRadiusB =
    new StringProperty(GEN_KEY + "." + SECOND_AXIS_KEY + ".RadialRadius");
  private final StringProperty genRadialSigmaA =
    new StringProperty(GEN_KEY + "." + FIRST_AXIS_KEY + ".RadialSigma");
  private final StringProperty genRadialSigmaB =
    new StringProperty(GEN_KEY + "." + SECOND_AXIS_KEY + ".RadialSigma");
  private final StringProperty postTrimvolXMin =
    new StringProperty(POST_KEY + ".Trimvol.XMin");
  private final StringProperty postTrimvolXMax =
    new StringProperty(POST_KEY + ".Trimvol.XMax");
  private final StringProperty postTrimvolYMin =
    new StringProperty(POST_KEY + ".Trimvol.YMin");
  private final StringProperty postTrimvolYMax =
    new StringProperty(POST_KEY + ".Trimvol.YMax");
  private final StringProperty postTrimvolZMin =
    new StringProperty(POST_KEY + ".Trimvol.ZMin");
  private final StringProperty postTrimvolZMinFromBatchruntomo =
    new StringProperty("batchruntomo.Trimvol.ZMin");
  private final StringProperty postTrimvolZMax =
    new StringProperty(POST_KEY + ".Trimvol.ZMax");
  private final StringProperty postTrimvolZMaxFromBatchruntomo =
    new StringProperty("batchruntomo.Trimvol.ZMax");
  private final EtomoBoolean2 postTrimvolConvertToBytes =
    new EtomoBoolean2(POST_KEY + ".Trimvol.ConvertToBytes");
  private final EtomoBoolean2 postTrimvolFixedScaling =
    new EtomoBoolean2(POST_KEY + ".Trimvol.FixedScaling");
  private final EtomoBoolean2 postTrimvolFlippedVolume =
    new EtomoBoolean2(POST_KEY + ".Trimvol.FlippedVolume");
  private final StringProperty postTrimvolSectionScaleMin =
    new StringProperty(POST_KEY + ".Trimvol.SectionScaleMin");
  private final StringProperty postTrimvolSectionScaleMax =
    new StringProperty(POST_KEY + ".Trimvol.SectionScaleMax");
  private final StringProperty postTrimvolFixedScaleMin =
    new StringProperty(POST_KEY + ".Trimvol.FixedScaleMin");
  private final StringProperty postTrimvolFixedScaleMax =
    new StringProperty(POST_KEY + ".Trimvol.FixedScaleMax");
  private final EtomoBoolean2 postTrimvolSwapYZ =
    new EtomoBoolean2(POST_KEY + ".Trimvol.SwapYZ");
  private final EtomoBoolean2 postTrimvolRotateX =
    new EtomoBoolean2(POST_KEY + ".Trimvol.RotateX");
  private final EtomoNumber postTrimvolScaleXMin =
    new EtomoNumber(POST_KEY + ".Trimvol.ScaleXMin");
  private final EtomoNumber postTrimvolScaleXMinFromBatchruntomo =
    new EtomoNumber("batchruntomo.Trimvol.ScaleXMin");
  private final EtomoNumber postTrimvolScaleXMax =
    new EtomoNumber(POST_KEY + ".Trimvol.ScaleXMax");
  private final EtomoNumber postTrimvolScaleXMaxFromBatchruntomo =
    new EtomoNumber("batchruntomo.Trimvol.ScaleXMax");
  private final EtomoNumber postTrimvolScaleYMin =
    new EtomoNumber(POST_KEY + ".Trimvol.ScaleYMin");
  private final EtomoNumber postTrimvolScaleYMinFromBatchruntomo =
    new EtomoNumber("batchruntomo.Trimvol.ScaleYMin");
  private final EtomoNumber postTrimvolScaleYMax =
    new EtomoNumber(POST_KEY + ".Trimvol.ScaleYMax");
  private final EtomoNumber postTrimvolScaleYMaxFromBatchruntomo =
    new EtomoNumber("batchruntomo.Trimvol.ScaleYMax");
  private final EtomoBoolean2 eraseBeadsInitialized =
    new EtomoBoolean2(STACK_KEY + ".EraseBeadsInitialized");

  private final EtomoBoolean2 trackSeedModelManualA =
    new EtomoBoolean2(TRACK_KEY + "." + FIRST_AXIS_KEY + ".SeedModel.Manual");
  private final EtomoBoolean2 trackSeedModelManualB =
    new EtomoBoolean2(TRACK_KEY + "." + SECOND_AXIS_KEY + ".SeedModel.Manual");
  private final EtomoBoolean2 trackSeedModelAutoA =
    new EtomoBoolean2(TRACK_KEY + "." + FIRST_AXIS_KEY + ".SeedModel.Auto");
  private final EtomoBoolean2 trackSeedModelAutoB =
    new EtomoBoolean2(TRACK_KEY + "." + SECOND_AXIS_KEY + ".SeedModel.Auto");
  private final EtomoBoolean2 trackSeedModelTransferA =
    new EtomoBoolean2(TRACK_KEY + "." + FIRST_AXIS_KEY + ".SeedModel.Transfer");
  private final EtomoBoolean2 trackSeedModelTransferB =
    new EtomoBoolean2(TRACK_KEY + "." + SECOND_AXIS_KEY + ".SeedModel.Transfer");
  private final EtomoBoolean2 trackExcludeInsideAreasA =
    new EtomoBoolean2(TRACK_KEY + "." + FIRST_AXIS_KEY + ".ExcludeInsideAreas");
  private final EtomoBoolean2 trackExcludeInsideAreasB =
    new EtomoBoolean2(TRACK_KEY + "." + SECOND_AXIS_KEY + ".ExcludeInsideAreas");
  private final EtomoNumber trackTargetNumberOfBeadsA =
    new EtomoNumber(TRACK_KEY + "." + FIRST_AXIS_KEY + ".TargetNumberOfBeads");
  private final EtomoNumber trackTargetNumberOfBeadsB =
    new EtomoNumber(TRACK_KEY + "." + SECOND_AXIS_KEY + ".TargetNumberOfBeads");
  ...
  private final EtomoBoolean2 trackAdvancedA =
    new EtomoBoolean2(TRACK_KEY + "." + FIRST_AXIS_KEY + ".Advanced");
  private final EtomoBoolean2 trackAdvancedB =
    new EtomoBoolean2(TRACK_KEY + "." + SECOND_AXIS_KEY + ".Advanced");

  // stack3dFindThickness must override the .com file values when it is not null
  private final EtomoNumber stack3dFindThicknessA =
    new EtomoNumber(STACK_KEY + "." + FIRST_AXIS_KEY + ".3dFind.Thickness");
  private final EtomoNumber stack3dFindThicknessB =
    new EtomoNumber(STACK_KEY + "." + SECOND_AXIS_KEY + ".3dFind.Thickness");
  private final EtomoBoolean2 setFEIPixelSize = new EtomoBoolean2("SetFEIPixelSize");
  private final EtomoBoolean2 postTrimvolNewStyleZ =
    new EtomoBoolean2(POST_KEY + "Trimvol.NewStyleZ");
  private final EtomoBoolean2 postTrimvolScalingNewStyleZ =
    new EtomoBoolean2(POST_KEY + "Trimvol.Scaling.NewStyleZ");
  private final FortranInputString stackCtfAutoFitRangeAndStepA =
    new FortranInputString(2);
  private final FortranInputString stackCtfAutoFitRangeAndStepB =
    new FortranInputString(2);
  private final StringProperty origScopeTemplate =
    new StringProperty("Orig.ScopeTemplate");
  private final StringProperty origSystemTemplate =
    new StringProperty("Orig.SystemTemplate");
  private final StringProperty origUserTemplate = new StringProperty("Orig.UserTemplate");
  private final EtomoBoolean2 isTwodirA =
    new EtomoBoolean2(STACK_KEY + "." + FIRST_AXIS_KEY + ".Is.Twodir");
  private final EtomoBoolean2 isTwodirB =
    new EtomoBoolean2(STACK_KEY + "." + SECOND_AXIS_KEY + ".Is.Twodir");
  private final EtomoNumber twodirA = new EtomoNumber(EtomoNumber.Type.DOUBLE,
    STACK_KEY + "." + FIRST_AXIS_KEY + ".Twodir");
  private final EtomoNumber twodirB = new EtomoNumber(EtomoNumber.Type.DOUBLE,
    STACK_KEY + "." + SECOND_AXIS_KEY + ".Twodir");
  private final EtomoNumber seedAndTrackTabA =
    new EtomoNumber(TRACK_KEY + "." + FIRST_AXIS_KEY + "Tab.SeedAndTrack");
  private final EtomoNumber seedAndTrackTabB =
    new EtomoNumber(TRACK_KEY + "." + SECOND_AXIS_KEY + "Tab.SeedAndTrack");
  private final EtomoNumber raptorTabA =
    new EtomoNumber(TRACK_KEY + "." + FIRST_AXIS_KEY + "Tab.Raptor");
  private final EtomoNumber raptorTabB =
    new EtomoNumber(TRACK_KEY + "." + SECOND_AXIS_KEY + "Tab.Raptor");
  private final EtomoNumber coarseAntialiasFilterA =
    new EtomoNumber(COARSE_KEY + "." + FIRST_AXIS_KEY + ".AntialiasFilter");
  private final EtomoNumber coarseAntialiasFilterB =
    new EtomoNumber(COARSE_KEY + "." + SECOND_AXIS_KEY + ".AntialiasFilter");
  private final EtomoNumber stackAntialiasFilterA =
    new EtomoNumber(STACK_KEY + "." + FIRST_AXIS_KEY + ".AntialiasFilter");
  private final EtomoNumber stackAntialiasFilterB =
    new EtomoNumber(STACK_KEY + "." + SECOND_AXIS_KEY + ".AntialiasFilter");
  private final EtomoNumber trackElongatedPointsAllowedA =
    new EtomoNumber(TRACK_KEY + "." + FIRST_AXIS_KEY + ".ElongatedPointsAllowed");
  private final EtomoNumber trackElongatedPointsAllowedB =
    new EtomoNumber(TRACK_KEY + "." + SECOND_AXIS_KEY + ".ElongatedPointsAllowed");
  private final EtomoNumber trackLowerTargetForClusteredA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      TRACK_KEY + "." + FIRST_AXIS_KEY + ".LowerTargetForClustered");
  private final EtomoNumber trackLowerTargetForClusteredB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      TRACK_KEY + "." + SECOND_AXIS_KEY + ".LowerTargetForClustered");
  private final EtomoBoolean2 origViewsWithMagChangesA = new EtomoBoolean2(
    COARSE_KEY + ".Tiltxcorr." + FIRST_AXIS_KEY + ".Orig.ViewsWithMagChanges");
  private final EtomoBoolean2 origViewsWithMagChangesB = new EtomoBoolean2(
    COARSE_KEY + ".Tiltxcorr." + SECOND_AXIS_KEY + ".Orig.ViewsWithMagChanges");
  private final EtomoBoolean2 origViewsWithMagChangesSetA = new EtomoBoolean2(
    COARSE_KEY + ".Tiltxcorr." + FIRST_AXIS_KEY + ".Orig.ViewsWithMagChanges.Set");
  private final EtomoBoolean2 origViewsWithMagChangesSetB = new EtomoBoolean2(
    COARSE_KEY + ".Tiltxcorr." + SECOND_AXIS_KEY + ".Orig.ViewsWithMagChanges.Set");
  private final EtomoBoolean2 weightWholeTracksA =
    new EtomoBoolean2(FINE_KEY + FIRST_AXIS_KEY + ".WeightWholeTracks");
  private final EtomoBoolean2 weightWholeTracksB =
    new EtomoBoolean2(FINE_KEY + SECOND_AXIS_KEY + ".WeightWholeTracks");
  private final EtomoNumber lengthOfPiecesA =
    new EtomoNumber(TRACK_KEY + "." + FIRST_AXIS_KEY + ".LengthOfPieces");
  private final EtomoNumber lengthOfPiecesB =
    new EtomoNumber(TRACK_KEY + "." + SECOND_AXIS_KEY + ".LengthOfPieces");
  //
  // Raw image stack file extension used in the dataset.
  private static final String INCORRECT_RAW_IMAGE_STACK_EXT_KEY = "Setup.ImageStackExt";
  private boolean removeIncorrectRawImageStackExtKey = false;
  private final StringProperty rawImageStackExt =
    new StringProperty("RawImageStackExt", true);
  // Orginal raw image stack file extension (prior to rename).
  private static final String INCORRECT_ORIG_RAW_IMAGE_STACK_EXT_KEY =
    "Setup.OrigImageStackExt";
  private boolean removeIncorrectOrigRawImageStackExtKey = false;
  private final StringProperty origRawImageStackExt =
    new StringProperty("OrigRawImageStackExt", true);
  // Prevents the raw image stack file extension from being changed.
  private final EtomoBoolean2 origRawImageStackExtLock =
    new EtomoBoolean2("OrigRawImageStackExt.Lock");
  private final StringProperty origRawImageStackExtFromBatchRunTomo =
    new StringProperty("batchruntomo.OrigImageStackExt");
  /**
   * For backwards compatibility
   */
  private final EtomoNumber minimumOverlapA =
    new EtomoNumber(TRACK_KEY + "." + FIRST_AXIS_KEY + ".MinimumOverlap");
  /**
   * For backwards compatibility
   */
  private final EtomoNumber minimumOverlapB =
    new EtomoNumber(TRACK_KEY + "." + SECOND_AXIS_KEY + ".MinimumOverlap");
  ...
  private final EtomoNumber targetMeasurementRatioB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      FINE_KEY + "." + SECOND_AXIS_KEY + ".TargetMeasurementRatio");
  ...
  private final StringProperty orderOfRestrictionsA =
    new StringProperty(FINE_KEY + "." + FIRST_AXIS_KEY + ".OrderOfRestrictions");
  private final StringProperty orderOfRestrictionsB =
    new StringProperty(FINE_KEY + "." + SECOND_AXIS_KEY + ".OrderOfRestrictions");
  private final EtomoNumber skipBeamTiltWithOneRotA =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN,
      FINE_KEY + "." + FIRST_AXIS_KEY + ".SkipBeamTiltWithOneRot");
  private final EtomoNumber skipBeamTiltWithOneRotB =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN,
      FINE_KEY + "." + SECOND_AXIS_KEY + ".SkipBeamTiltWithOneRot");

  private final EtomoNumber sampleTypeA =
    new EtomoNumber(POS_KEY + "." + FIRST_AXIS_KEY + ".SampleType");
  private final EtomoNumber sampleTypeB =
    new EtomoNumber(POS_KEY + "." + SECOND_AXIS_KEY + ".SampleType");
  private final EtomoNumber hasGoldBeadsA = new EtomoNumber(EtomoNumber.Type.BOOLEAN,
    POS_KEY + "." + FIRST_AXIS_KEY + ".HasGoldBeads");
  private final EtomoNumber hasGoldBeadsB = new EtomoNumber(EtomoNumber.Type.BOOLEAN,
    POS_KEY + "." + SECOND_AXIS_KEY + ".HasGoldBeads");
  // The key has the wrong name. This is unbinned bead size in pixels, not fiducial
  // diameter. Won't change it unless there is a good reason
  private final EtomoNumber positioningBeadSizeA = new EtomoNumber(
    EtomoNumber.Type.DOUBLE, POS_KEY + "." + FIRST_AXIS_KEY + ".FiducialDiameter");
  private final EtomoNumber positioningBeadSizeB = new EtomoNumber(
    EtomoNumber.Type.DOUBLE, POS_KEY + "." + SECOND_AXIS_KEY + ".FiducialDiameter");
  private final EtomoNumber extraThicknessA = new EtomoNumber(EtomoNumber.Type.DOUBLE,
    POS_KEY + "." + FIRST_AXIS_KEY + ".ExtraThickness");
  private final EtomoNumber extraThicknessB = new EtomoNumber(EtomoNumber.Type.DOUBLE,
    POS_KEY + "." + SECOND_AXIS_KEY + ".ExtraThickness");
  private final EtomoNumber extraThicknessCryoA = new EtomoNumber(EtomoNumber.Type.DOUBLE,
    POS_KEY + "." + FIRST_AXIS_KEY + ".ExtraThickness.Cryo");
  private final EtomoNumber extraThicknessCryoB = new EtomoNumber(EtomoNumber.Type.DOUBLE,
    POS_KEY + "." + SECOND_AXIS_KEY + ".ExtraThickness.Cryo");
  private final StringProperty genHammingLikeFilterA =
    new StringProperty(GEN_KEY + "." + FIRST_AXIS_KEY + ".HammingLikeFilter");
  private final StringProperty genHammingLikeFilterB =
    new StringProperty(GEN_KEY + "." + SECOND_AXIS_KEY + ".HammingLikeFilter");
  private final StringProperty genFakeSIRTiterationsA =
    new StringProperty(GEN_KEY + "." + FIRST_AXIS_KEY + ".FakeSIRTiterations");
  private final StringProperty genFakeSIRTiterationsB =
    new StringProperty(GEN_KEY + "." + SECOND_AXIS_KEY + ".FakeSIRTiterations");
  private final StringProperty genExactFilterSizeA =
    new StringProperty(GEN_KEY + "." + FIRST_AXIS_KEY + ".ExactFilterSize");
  private final StringProperty genExactFilterSizeB =
    new StringProperty(GEN_KEY + "." + SECOND_AXIS_KEY + ".ExactFilterSize");
  private final StringProperty sirtRadialRadiusA =
    new StringProperty(SIRT_KEY + "." + FIRST_AXIS_KEY + ".RadialRadius");
  private final StringProperty sirtRadialRadiusB =
    new StringProperty(SIRT_KEY + "." + SECOND_AXIS_KEY + ".RadialRadius");
  private final StringProperty sirtRadialSigmaA =
    new StringProperty(SIRT_KEY + "." + FIRST_AXIS_KEY + ".RadialSigma");
  private final StringProperty sirtRadialSigmaB =
    new StringProperty(SIRT_KEY + "." + SECOND_AXIS_KEY + ".RadialSigma");
  private final StringProperty batchRunTomoLogReadTimestamp =
    new StringProperty("BatchRunTomoLog.Read.Timestamp", true);
  private final EtomoBoolean2 batchRunTomoLogReadFinished =
    new EtomoBoolean2("BatchRunTomoLog.Read.Finished");

  private EtomoNumber postTrimvolSwapYZFromBatchruntomo =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.Trimvol.SwapYZ");
  private EtomoNumber postTrimvolRotateXFromBatchruntomo =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.Trimvol.RotateX");
  private final EtomoNumber postTrimvolConvertToBytesFromBatchruntomo =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.Trimvol.ConvertToBytes");
  private final EtomoNumber postTrimvolSectionScaleMinFromBatchruntomo =
    new EtomoNumber("batchruntomo.Trimvol.ScaleSectionMin");
  private final EtomoNumber postTrimvolSectionScaleMaxFromBatchruntomo =
    new EtomoNumber("batchruntomo.Trimvol.ScaleSectionMax");
  private final EtomoNumber stackAlignedStackEraseGoldFromBatchruntomo =
    new EtomoNumber("batchruntomo.AlignedStack.eraseGold");

  private final EtomoBoolean2 positioningNewDialogA =
    new EtomoBoolean2(POS_KEY + "." + FIRST_AXIS_KEY + ".NewDialog");
  private final EtomoBoolean2 positioningNewDialogB =
    new EtomoBoolean2(POS_KEY + "." + SECOND_AXIS_KEY + ".NewDialog");
  private final EtomoBoolean2 genFilterTrialsA =
    new EtomoBoolean2(GEN_KEY + "." + FIRST_AXIS_KEY + ".FilterTrials");
  private final EtomoBoolean2 genFilterTrialsB =
    new EtomoBoolean2(GEN_KEY + "." + SECOND_AXIS_KEY + ".FilterTrials");
  private AxisID batchRunTomoLogReadAxisID = null;
  private final StringProperty genFilterTrialsFakeSIRTiterationsA = new StringProperty(
    GEN_KEY + "." + FIRST_AXIS_KEY + ".FilterTrials.FakeSIRTiterations");
  private final StringProperty genFilterTrialsFakeSIRTiterationsB = new StringProperty(
    GEN_KEY + "." + SECOND_AXIS_KEY + ".FilterTrials.FakeSIRTiterations");
  private final StringProperty genFilterTrialsExactObjectSizesA =
    new StringProperty(GEN_KEY + "." + FIRST_AXIS_KEY + ".FilterTrials.ExactObjectSizes");
  private final StringProperty genFilterTrialsExactObjectSizesB = new StringProperty(
    GEN_KEY + "." + SECOND_AXIS_KEY + ".FilterTrials.ExactObjectSizes");
  private final StringProperty genFilterTrialsGaussianCutoffsA =
    new StringProperty(GEN_KEY + "." + FIRST_AXIS_KEY + ".FilterTrials.GaussianCutoffs");
  private final StringProperty genFilterTrialsGaussianCutoffsB =
    new StringProperty(GEN_KEY + "." + SECOND_AXIS_KEY + ".FilterTrials.GaussianCutoffs");
  private final StringProperty genFilterTrialsGaussianFalloffsA =
    new StringProperty(GEN_KEY + "." + FIRST_AXIS_KEY + ".FilterTrials.GaussianFalloffs");
  private final StringProperty genFilterTrialsGaussianFalloffsB = new StringProperty(
    GEN_KEY + "." + SECOND_AXIS_KEY + ".FilterTrials.GaussianFalloffs");
  private final StringProperty genFilterTrialsHammingLikeStartsA = new StringProperty(
    GEN_KEY + "." + FIRST_AXIS_KEY + ".FilterTrials.HammingLikeStarts");
  private final StringProperty genFilterTrialsHammingLikeStartsB = new StringProperty(
    GEN_KEY + "." + SECOND_AXIS_KEY + ".FilterTrials.HammingLikeStarts");

  private final StringProperty stackMtfFilterLowPassRadiusSigmaA = new StringProperty(
    STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.LowPassRadiusSigma");
  private final StringProperty stackMtfFilterLowPassRadiusSigmaB = new StringProperty(
    STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.LowPassRadiusSigma");
  private final StringProperty stackMtfFilterMtfFileA =
    new StringProperty(STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.MtfFile");
  private final StringProperty stackMtfFilterMtfFileB =
    new StringProperty(STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.MtfFile");
  private final EtomoNumber stackMtfFilterMaximumInverseA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.MaximumInverse");
  private final EtomoNumber stackMtfFilterMaximumInverseB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.MaximumInverse");
  private final StringProperty stackMtfFilterInverseRolloffRadiusSigmaA =
    new StringProperty(
      STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.InverseRolloffRadiusSigma");
  private final StringProperty stackMtfFilterInverseRolloffRadiusSigmaB =
    new StringProperty(
      STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.InverseRolloffRadiusSigma");
  private final EtomoBoolean2 useStackMtfFilterFixedImageDoseA = new EtomoBoolean2(
    STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.Use.FixedImageDose");
  private final EtomoBoolean2 useStackMtfFilterFixedImageDoseB = new EtomoBoolean2(
    STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.Use.FixedImageDose");
  private final StringProperty stackMtfFilterFixedImageDoseA = new StringProperty(
    STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.FixedImageDose");
  private final StringProperty stackMtfFilterFixedImageDoseB = new StringProperty(
    STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.FixedImageDose");
  private final StringProperty stackMtfFilterDoseWeightingFileA = new StringProperty(
    STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.DoseWeightingFile");
  private final StringProperty stackMtfFilterDoseWeightingFileB = new StringProperty(
    STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.DoseWeightingFile");
  private final EtomoNumber stackMtfFilterTypeOfDoseFileA =
    new EtomoNumber(STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.TypeOfDoseFile");
  private final EtomoNumber stackMtfFilterTypeOfDoseFileB =
    new EtomoNumber(STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.TypeOfDoseFile");
  private final EtomoBoolean2 stackMtfFilterVoltage200A =
    new EtomoBoolean2(STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.Voltage.200");
  private final EtomoBoolean2 stackMtfFilterVoltage200B =
    new EtomoBoolean2(STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.Voltage.200");
  private final EtomoNumber stackMtfFilterOptimalDoseScalingA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.OptimalDoseScaling");
  private final EtomoNumber stackMtfFilterOptimalDoseScalingB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.OptimalDoseScaling");
  private final EtomoNumber stackMtfFilterBidirectionalNumViewsA =
    new EtomoNumber(EtomoNumber.Type.INTEGER,
      STACK_KEY + "." + FIRST_AXIS_KEY + "." + "MtfFilter.BidirectionalNumViews");
  private final EtomoNumber stackMtfFilterBidirectionalNumViewsB =
    new EtomoNumber(EtomoNumber.Type.INTEGER,
      STACK_KEY + "." + SECOND_AXIS_KEY + "." + "MtfFilter.BidirectionalNumViews");
  private final EtomoBoolean2 useStackCtfPhaseFlipXAxisTiltA = new EtomoBoolean2(
    STACK_KEY + "." + FIRST_AXIS_KEY + ".Use." + "CtfPhaseFlip.XAxisTilt");
  private final EtomoBoolean2 useStackCtfPhaseFlipXAxisTiltB = new EtomoBoolean2(
    STACK_KEY + "." + SECOND_AXIS_KEY + ".Use." + "CtfPhaseFlip.XAxisTilt");
  private final EtomoNumber stackCtfPhaseFlipXAxisTiltA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      STACK_KEY + "." + FIRST_AXIS_KEY + "." + "CtfPhaseFlip.XAxisTilt");
  private final EtomoNumber stackCtfPhaseFlipXAxisTiltB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      STACK_KEY + "." + SECOND_AXIS_KEY + "." + "CtfPhaseFlip.XAxisTilt");
  private final EtomoNumber stackCtfPhaseFlipScaleByCtfPowerA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      STACK_KEY + "." + FIRST_AXIS_KEY + "." + "CtfPhaseFlip.ScaleByCtfPower");
  private final EtomoNumber stackCtfPhaseFlipScaleByCtfPowerB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE,
      STACK_KEY + "." + SECOND_AXIS_KEY + "." + "CtfPhaseFlip.ScaleByCtfPower");
  private final EtomoNumber genSuperSampleFactorA =
    new EtomoNumber(GEN_KEY + "." + FIRST_AXIS_KEY + ".SuperSampleFactor");
  private final EtomoNumber genSuperSampleFactorB =
    new EtomoNumber(GEN_KEY + "." + SECOND_AXIS_KEY + ".SuperSampleFactor");
  private EtomoBoolean2 genExpandInputLinesA =
    new EtomoBoolean2(GEN_KEY + "." + FIRST_AXIS_KEY + ".ExpandInputLines");
  private EtomoBoolean2 genExpandInputLinesB =
    new EtomoBoolean2(GEN_KEY + "." + SECOND_AXIS_KEY + ".ExpandInputLines");
  ...
  public MetaData(final ApplicationManager manager, final LogProperties logProperties,
    ...
    stackCtfAutoFitRangeAndStepA
      .setPropertiesKey(STACK_KEY + "." + FIRST_AXIS_KEY + ".CTF.AutoFit.RangeAndStep");
    stackCtfAutoFitRangeAndStepA
      .setPropertiesKey(STACK_KEY + "." + SECOND_AXIS_KEY + ".CTF.AutoFit.RangeAndStep");

    trackMethodA.set(TrackingMethod.SEED.toString());
    trackMethodB.set(TrackingMethod.SEED.toString());
    trackSeedModelAutoA.set(true);
    trackSeedModelTransferB.set(true);
    twodirA.set(TWO_DIR_DEFAULT);
    twodirB.set(TWO_DIR_DEFAULT);
    extraThicknessCryoA.setDisplayValue(EXTRA_THICKNESS_CRYO_DEFAULT);
    extraThicknessCryoB.setDisplayValue(EXTRA_THICKNESS_CRYO_DEFAULT);
    positioningNewDialogA.set(true);
    positioningNewDialogB.set(true);
    postTrimvolConvertToBytes.setDisplayValue(true);
    stackCtfPhaseFlipScaleByCtfPowerA.setDisplayValue(CTF_SCALE_BY_CTF_POWER_DEFAULT);
    stackCtfPhaseFlipScaleByCtfPowerB.setDisplayValue(CTF_SCALE_BY_CTF_POWER_DEFAULT);
  }
   ...
   * name.  Store the extension in origImageStackExt.
   */
  private void fixDatasetName() {
    Extension extension = Extension.getInstance(datasetName);
    if (extension != null) {
      rawImageStackExt.set(extension.toString());
      if (!origRawImageStackExtLock.is()) {
        if (extension.isInputImageFile()) {
          origRawImageStackExt.set(extension.toString());
        }
        else {
          // No valid extension available
          origRawImageStackExt.reset();
        }
      }
    }
    boolean dual = axisType != AxisType.SINGLE_AXIS;
    StringBuilder errMsg = new StringBuilder();
    if (!DatasetTool.isValidInputImageFile(datasetName, dual, errMsg)) {
      // Something is wrong with the file name - report an error message.
      appendMessage(errMsg.toString() + "\n");
    }
    // Use this file whether or not it is valid.
    datasetName = DatasetTool.getDatasetName(datasetName, dual);
  }
  ...
  public void setPostTrimvolNewStyleZ(final String uiZMin, final String uiZMax) {
    if (postTrimvolNewStyleZ.isNull() || !postTrimvolNewStyleZ.is()) {
      postTrimvolNewStyleZ
        .set(!postTrimvolZMin.equals(uiZMin) || !postTrimvolZMax.equals(uiZMax));
    }
  }
  ...
  public void setFinalStackCtfCorrectionParallel(final AxisID axisID,
    final boolean input) {
    if (axisID == AxisID.SECOND) {
  ...
  public void setGenFilterTrials(final AxisID axisID, final boolean input) {
    if (axisID == AxisID.SECOND) {
      genFilterTrialsB.set(input);
    }
    else {
      genFilterTrialsA.set(input);
    }
  }

  public void setGenFilterTrialsFakeSIRTiterations(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      genFilterTrialsFakeSIRTiterationsB.set(input);
    }
    else {
      genFilterTrialsFakeSIRTiterationsA.set(input);
    }
  }

  public void setGenFilterTrialsExactObjectSizes(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      genFilterTrialsExactObjectSizesB.set(input);
    }
    else {
      genFilterTrialsExactObjectSizesA.set(input);
    }
  }

  public void setGenFilterTrialsHammingLikeStarts(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      genFilterTrialsHammingLikeStartsB.set(input);
    }
    else {
      genFilterTrialsHammingLikeStartsA.set(input);
    }
  }

  public void setStackMtfFilterLowPassRadiusSigma(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      stackMtfFilterLowPassRadiusSigmaB.set(input);
    }
    else {
      stackMtfFilterLowPassRadiusSigmaA.set(input);
    }
  }

  public void setStackMtfFilterMtfFile(final AxisID axisID, final String input) {
    if (axisID == AxisID.SECOND) {
      stackMtfFilterMtfFileB.set(input);
    }
    else {
      stackMtfFilterMtfFileA.set(input);
    }
  }

  public void setStackMtfFilterMaximumInverse(final AxisID axisID, final String input) {
    if (axisID == AxisID.SECOND) {
      stackMtfFilterMaximumInverseB.set(input);
    }
    else {
      stackMtfFilterMaximumInverseA.set(input);
    }
  }

  public void setStackMtfFilterOptimalDoseScaling(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      stackMtfFilterOptimalDoseScalingB.set(input);
    }
    else {
      stackMtfFilterOptimalDoseScalingA.set(input);
    }
  }

  public void setStackMtfFilterBidirectionalNumViews(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      stackMtfFilterBidirectionalNumViewsB.set(input);
    }
    else {
      stackMtfFilterBidirectionalNumViewsA.set(input);
    }
  }

  public void setUseStackCtfPhaseFlipXAxisTilt(final AxisID axisID, final boolean input) {
    if (axisID == AxisID.SECOND) {
      useStackCtfPhaseFlipXAxisTiltB.set(input);
    }
    else {
      useStackCtfPhaseFlipXAxisTiltA.set(input);
    }
  }

  public void setStackCtfPhaseFlipXAxisTilt(final AxisID axisID, final String input) {
    if (axisID == AxisID.SECOND) {
      stackCtfPhaseFlipXAxisTiltB.set(input);
    }
    else {
      stackCtfPhaseFlipXAxisTiltA.set(input);
    }
  }

  public void setStackCtfPhaseFlipScaleByCtfPower(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      stackCtfPhaseFlipScaleByCtfPowerB.set(input);
    }
    else {
      stackCtfPhaseFlipScaleByCtfPowerA.set(input);
    }
  }
  ...
  public void setOrigRawImageStackExtension(final Extension input) {
    if (input != null) {
      if (!origRawImageStackExtLock.is() && input != null) {
        origRawImageStackExt.set(input.toString());
      }
    }
  }

  @Override
  public void setRawImageStackExtension(final Extension extension) {
    if (extension != null) {
      rawImageStackExt.set(extension.toString());
    }
    else {
      rawImageStackExt.reset();
    }
  }

  @Override
  public Extension getOrigRawImageStackExtension() {
    if (!origRawImageStackExt.isEmpty()) {
      return Extension.getInstance(origRawImageStackExt.toString());
    }
  ...
  public Extension getRawImageStackExtension() {
    if (!rawImageStackExt.isEmpty()) {
      return Extension.getInstance(rawImageStackExt.toString());
    }
    return super.getRawImageStackExtension();
  }

  public void setStackMtfFilterInverseRolloffRadiusSigma(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      stackMtfFilterInverseRolloffRadiusSigmaB.set(input);
    }
    else {
      stackMtfFilterInverseRolloffRadiusSigmaA.set(input);
    }
  }

  public void setUseStackMtfFilterFixedImageDose(final AxisID axisID,
    final boolean input) {
    if (axisID == AxisID.SECOND) {
      useStackMtfFilterFixedImageDoseB.set(input);
    }
    else {
      useStackMtfFilterFixedImageDoseA.set(input);
    }
  }

  public void setStackMtfFilterFixedImageDose(final AxisID axisID, final String input) {
    if (axisID == AxisID.SECOND) {
      stackMtfFilterFixedImageDoseB.set(input);
    }
    else {
      stackMtfFilterFixedImageDoseA.set(input);
    }
  }

  public void setStackMtfFilterDoseWeightingFile(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      stackMtfFilterDoseWeightingFileB.set(input);
    }
    else {
      stackMtfFilterDoseWeightingFileA.set(input);
    }
  }

  public void setStackMtfFilterTypeOfDoseFile(final AxisID axisID,
    final EnumeratedType enumeratedType) {
    String value = null;
    if (enumeratedType != null) {
      value = enumeratedType.toString();
    }
    if (axisID == AxisID.SECOND) {
      stackMtfFilterTypeOfDoseFileB.set(value);
    }
    else {
      stackMtfFilterTypeOfDoseFileA.set(value);
    }
  }

  public void setStackMtfFilterVoltage200(final AxisID axisID, final boolean input) {
    if (axisID == AxisID.SECOND) {
      stackMtfFilterVoltage200B.set(input);
    }
    else {
      stackMtfFilterVoltage200A.set(input);
    }
  }

  public void setGenFilterTrialsGaussianCutoffs(final AxisID axisID, final String input) {
    if (axisID == AxisID.SECOND) {
      genFilterTrialsGaussianCutoffsB.set(input);
    }
    else {
      genFilterTrialsGaussianCutoffsA.set(input);
    }
  }

  public void setGenFilterTrialsGaussianFalloffs(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      genFilterTrialsGaussianFalloffsB.set(input);
    }
    else {
      genFilterTrialsGaussianFalloffsA.set(input);
    }
  }

  public String getGenFilterTrialsFakeSIRTiterations(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return genFilterTrialsFakeSIRTiterationsB.toString();
    }
    return genFilterTrialsFakeSIRTiterationsA.toString();
  }

  public String getGenFilterTrialsExactObjectSizes(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return genFilterTrialsExactObjectSizesB.toString();
    }
    return genFilterTrialsExactObjectSizesA.toString();
  }

  public String getGenFilterTrialsHammingLikeStarts(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return genFilterTrialsHammingLikeStartsB.toString();
    }
    return genFilterTrialsHammingLikeStartsA.toString();
  }

  public String getStackMtfFilterLowPassRadiusSigma(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackMtfFilterLowPassRadiusSigmaB.toString();
    }
    return stackMtfFilterLowPassRadiusSigmaA.toString();
  }

  public String getStackMtfFilterMtfFile(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackMtfFilterMtfFileB.toString();
    }
    return stackMtfFilterMtfFileA.toString();
  }

  public String getStackMtfFilterMaximumInverse(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackMtfFilterMaximumInverseB.toString();
    }
    return stackMtfFilterMaximumInverseA.toString();
  }

  public String getStackMtfFilterOptimalDoseScaling(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackMtfFilterOptimalDoseScalingB.toString();
    }
    return stackMtfFilterOptimalDoseScalingA.toString();
  }

  public String getStackMtfFilterBidirectionalNumViews(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackMtfFilterBidirectionalNumViewsB.toString();
    }
    return stackMtfFilterBidirectionalNumViewsA.toString();
  }

  public boolean isUseStackCtfPhaseFlipXAxisTilt(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return useStackCtfPhaseFlipXAxisTiltB.is();
    }
    return useStackCtfPhaseFlipXAxisTiltA.is();
  }

  public String getStackCtfPhaseFlipXAxisTilt(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackCtfPhaseFlipXAxisTiltB.toString();
    }
    return stackCtfPhaseFlipXAxisTiltA.toString();
  }

  public String getStackCtfPhaseFlipScaleByCtfPower(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackCtfPhaseFlipScaleByCtfPowerB.toString();
    }
    return stackCtfPhaseFlipScaleByCtfPowerA.toString();
  }

  public String getStackMtfFilterInverseRolloffRadiusSigma(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackMtfFilterInverseRolloffRadiusSigmaB.toString();
    }
    return stackMtfFilterInverseRolloffRadiusSigmaA.toString();
  }

  public boolean isUseStackMtfFilterFixedImageDose(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return useStackMtfFilterFixedImageDoseB.is();
    }
    return useStackMtfFilterFixedImageDoseA.is();
  }

  public String getStackMtfFilterFixedImageDose(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackMtfFilterFixedImageDoseB.toString();
    }
    return stackMtfFilterFixedImageDoseA.toString();
  }

  public String getStackMtfFilterDoseWeightingFile(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackMtfFilterDoseWeightingFileB.toString();
    }
    return stackMtfFilterDoseWeightingFileA.toString();
  }

  public String getStackMtfFilterTypeOfDoseFile(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackMtfFilterTypeOfDoseFileB.toString();
    }
    return stackMtfFilterTypeOfDoseFileA.toString();
  }

  public boolean isStackMtfFilterVoltage200(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return stackMtfFilterVoltage200B.is();
    }
    return stackMtfFilterVoltage200A.is();
  }

  public String getGenFilterTrialsGaussianCutoffs(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return genFilterTrialsGaussianCutoffsB.toString();
    }
    return genFilterTrialsGaussianCutoffsA.toString();
  }

  public String getGenFilterTrialsGaussianFalloffs(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return genFilterTrialsGaussianFalloffsB.toString();
    }
    return genFilterTrialsGaussianFalloffsA.toString();
  }

  public boolean isGenFilterTrials(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return genFilterTrialsB.is();
    }
    return genFilterTrialsA.is();
  }
  ...
  public void setRadialRadius(final PanelId panelId, final AxisID axisID,
    final String input) {
    if (panelId == PanelId.TILT) {
      if (axisID == AxisID.SECOND) {
    ...
    else if (panelId == PanelId.SIRTSETUP) {
      if (axisID == AxisID.SECOND) {
        sirtRadialRadiusB.set(input);
      }
      else {
        sirtRadialRadiusA.set(input);
      }
    }
  }

  public void setRadialSigma(final PanelId panelId, final AxisID axisID,
    final String input) {
    if (panelId == PanelId.TILT) {
      if (axisID == AxisID.SECOND) {
      ...
      if (axisID == AxisID.SECOND) {
        sirtRadialSigmaB.set(input);
      }
      else {
        sirtRadialSigmaA.set(input);
      }
    }
  }

  public String getBatchRunTomoLogReadTimestamp() {
    return batchRunTomoLogReadTimestamp.toString();
  }

  public void setBatchRunTomoLogReadTimestamp(final String input) {
    batchRunTomoLogReadTimestamp.set(input);
  }

  public boolean isBatchRunTomoLogReadFinished() {
    return batchRunTomoLogReadFinished.is();
  }

  public AxisID getBatchRunTomoLogReadAxisID() {
    return batchRunTomoLogReadAxisID;
  }

  public void setBatchRunTomoLogReadAxisID(final AxisID input) {
    batchRunTomoLogReadAxisID = input;
  }

  public void setBatchRunTomoLogReadFinished(final boolean input) {
    batchRunTomoLogReadFinished.set(input);
  }

  public void setHammingLikeFilter(final PanelId panelId, final AxisID axisID,
    final String input) {
    if (panelId == PanelId.TILT) {
      if (axisID == AxisID.SECOND) {
        genHammingLikeFilterB.set(input);
      }
      else {
        genHammingLikeFilterA.set(input);
      }
    }
    // Currently only valid for tilt
  }

  public String getHammingLikeFilter(final PanelId panelId, final AxisID axisID) {
    if (panelId == PanelId.TILT) {
      if (axisID == AxisID.SECOND) {
        return genHammingLikeFilterB.toString();
      }
      return genHammingLikeFilterA.toString();
    }
    // Currently only valid for tilt
    return null;
  }

  public void setFakeSIRTiterations(final PanelId panelId, final AxisID axisID,
    final String input) {
    if (panelId == PanelId.TILT) {
      if (axisID == AxisID.SECOND) {
        genFakeSIRTiterationsB.set(input);
      }
      else {
        genFakeSIRTiterationsA.set(input);
      }
    }
    // Currently only valid for tilt
  }

  public String getFakeSIRTiterations(final PanelId panelId, final AxisID axisID) {
    if (panelId == PanelId.TILT) {
      if (axisID == AxisID.SECOND) {
        return genFakeSIRTiterationsB.toString();
      }
      return genFakeSIRTiterationsA.toString();
    }
    // Currently only valid for tilt
    return null;
  }

  public void setExactFilterSize(final PanelId panelId, final AxisID axisID,
    final String input) {
    if (panelId == PanelId.TILT) {
      if (axisID == AxisID.SECOND) {
        genExactFilterSizeB.set(input);
      }
      else {
        genExactFilterSizeA.set(input);
      }
    }
    // Currently only valid for tilt
  }

  public String getExactFilterSize(final PanelId panelId, final AxisID axisID) {
    if (panelId == PanelId.TILT) {
      if (axisID == AxisID.SECOND) {
        return genExactFilterSizeB.toString();
      }
      return genExactFilterSizeA.toString();
    }
    // Currently only valid for tilt
    return null;
  }
  ...
  public void load(final Properties props, final String parentPrepend) {
    ...
    genSuperSampleFactorA.reset();
    genSuperSampleFactorB.reset();
    genExpandInputLinesA.reset();
    genExpandInputLinesB.reset();
    genExistsA.reset();
    genExistsB.reset();
    posExistsA.reset();
    posExistsB.reset();
    ...
    isTwodirA.set(TWO_DIR_DEFAULT);
    isTwodirB.set(TWO_DIR_DEFAULT);
    twodirA.reset();
    twodirB.reset();
    ...
    trackLowerTargetForClusteredA.reset();
    trackLowerTargetForClusteredB.reset();
    ...
    hasGoldBeadsA.reset();
    hasGoldBeadsB.reset();
    positioningBeadSizeA.reset();
    positioningBeadSizeB.reset();
    extraThicknessA.reset();
    extraThicknessB.reset();
    extraThicknessCryoA.reset();
    extraThicknessCryoB.reset();
    genHammingLikeFilterA.reset();
    genHammingLikeFilterB.reset();
    genFakeSIRTiterationsA.reset();
    genFakeSIRTiterationsB.reset();
    genExactFilterSizeA.reset();
    genExactFilterSizeB.reset();
    sirtRadialRadiusA.reset();
    sirtRadialRadiusB.reset();
    sirtRadialSigmaA.reset();
    sirtRadialSigmaB.reset();
    batchRunTomoLogReadTimestamp.reset();
    batchRunTomoLogReadFinished.reset();
    positioningNewDialogA.set(true);
    positioningNewDialogB.set(true);
    batchRunTomoLogReadAxisID = null;
    genFilterTrialsA.reset();
    genFilterTrialsB.reset();
    genFilterTrialsFakeSIRTiterationsA.reset();
    genFilterTrialsFakeSIRTiterationsB.reset();
    genFilterTrialsExactObjectSizesA.reset();
    genFilterTrialsExactObjectSizesB.reset();
    genFilterTrialsGaussianCutoffsA.reset();
    genFilterTrialsGaussianCutoffsB.reset();
    genFilterTrialsGaussianFalloffsA.reset();
    genFilterTrialsGaussianFalloffsB.reset();
    genFilterTrialsHammingLikeStartsA.reset();
    genFilterTrialsHammingLikeStartsB.reset();
    stackMtfFilterLowPassRadiusSigmaA.reset();
    stackMtfFilterLowPassRadiusSigmaB.reset();
    stackMtfFilterMtfFileA.reset();
    stackMtfFilterMtfFileB.reset();
    stackMtfFilterMaximumInverseA.reset();
    stackMtfFilterMaximumInverseB.reset();
    stackMtfFilterOptimalDoseScalingA.reset();
    stackMtfFilterOptimalDoseScalingB.reset();
    stackMtfFilterBidirectionalNumViewsA.reset();
    stackMtfFilterBidirectionalNumViewsB.reset();
    useStackCtfPhaseFlipXAxisTiltA.reset();
    useStackCtfPhaseFlipXAxisTiltB.reset();
    stackCtfPhaseFlipXAxisTiltA.reset();
    stackCtfPhaseFlipXAxisTiltB.reset();
    stackCtfPhaseFlipScaleByCtfPowerA.reset();
    stackCtfPhaseFlipScaleByCtfPowerB.reset();
    stackMtfFilterInverseRolloffRadiusSigmaA.reset();
    stackMtfFilterInverseRolloffRadiusSigmaB.reset();
    useStackMtfFilterFixedImageDoseA.reset();
    useStackMtfFilterFixedImageDoseB.reset();
    stackMtfFilterFixedImageDoseA.reset();
    stackMtfFilterFixedImageDoseB.reset();
    stackMtfFilterDoseWeightingFileA.reset();
    stackMtfFilterDoseWeightingFileB.reset();
    stackMtfFilterTypeOfDoseFileA.reset();
    stackMtfFilterTypeOfDoseFileB.reset();
    stackMtfFilterVoltage200A.reset();
    stackMtfFilterVoltage200B.reset();
    rawImageStackExt.reset();
    origRawImageStackExt.reset();
    origRawImageStackExtLock.reset();
    // batchruntomo settings
    postTrimvolSwapYZFromBatchruntomo.reset();
    postTrimvolRotateXFromBatchruntomo.reset();
    postTrimvolConvertToBytesFromBatchruntomo.reset();
    postTrimvolSectionScaleMinFromBatchruntomo.reset();
    postTrimvolSectionScaleMaxFromBatchruntomo.reset();
    postTrimvolZMinFromBatchruntomo.reset();
    postTrimvolZMaxFromBatchruntomo.reset();
    postTrimvolScaleXMinFromBatchruntomo.reset();
    postTrimvolScaleYMinFromBatchruntomo.reset();
    postTrimvolScaleXMaxFromBatchruntomo.reset();
    postTrimvolScaleYMaxFromBatchruntomo.reset();
    stackAlignedStackEraseGoldFromBatchruntomo.reset();
    origRawImageStackExtFromBatchRunTomo.reset();
    // load
    // Bug# 2403
    ...
    if (revisionNumber.le(EtomoVersion.getDefaultInstance("1.11"))) {
      ...
      postTrimvolConvertToBytes.loadFromOtherKey(props, prepend,
    ...
    // May-03-2002
    comScriptsCreated = Boolean
      .valueOf(props.getProperty(group + "ComScriptsCreated", "true")).booleanValue();
    ...
    useLocalAlignmentsA = Boolean
      .valueOf(props.getProperty(group + "UseLocalAlignmentsA", "true")).booleanValue();
    useLocalAlignmentsB = Boolean
      .valueOf(props.getProperty(group + "UseLocalAlignmentsB", "true")).booleanValue();
    ...
    fiducialessAlignmentB =
      Boolean.valueOf(props.getProperty(group + "FiducialessAlignmentB", "false"))
        .booleanValue();
    wholeTomogramSampleA = Boolean
      .valueOf(props.getProperty(group + "WholeTomogramSampleA", "false")).booleanValue();
    wholeTomogramSampleB = Boolean
      .valueOf(props.getProperty(group + "WholeTomogramSampleB", "false")).booleanValue();
    ...
    // be in any file yet
    targetPatchSizeXandY = props.getProperty(
      group + "tiltalign." + TiltalignParam.TARGET_PATCH_SIZE_X_AND_Y_KEY,
      TiltalignParam.TARGET_PATCH_SIZE_X_AND_Y_DEFAULT);
    numberOfLocalPatchesXandY = props.getProperty(
      group + "tiltalign." + TiltalignParam.NUMBER_OF_LOCAL_PATCHES_X_AND_Y_KEY,
      TiltalignParam.NUMBER_OF_LOCAL_PATCHES_X_AND_Y_DEFAULT);
    ...
    genSuperSampleFactorA.load(props, prepend);
    genSuperSampleFactorB.load(props, prepend);
    genExpandInputLinesA.load(props, prepend);
    genExpandInputLinesB.load(props, prepend);
    ...
    trackLowerTargetForClusteredA.load(props, prepend);
    trackLowerTargetForClusteredB.load(props, prepend);
    ...
    sampleTypeA.load(props, prepend);
    sampleTypeB.load(props, prepend);
    hasGoldBeadsA.load(props, prepend);
    hasGoldBeadsB.load(props, prepend);
    positioningBeadSizeA.load(props, prepend);
    positioningBeadSizeB.load(props, prepend);
    extraThicknessA.load(props, prepend);
    extraThicknessB.load(props, prepend);
    extraThicknessCryoA.load(props, prepend);
    extraThicknessCryoB.load(props, prepend);

    // backwards compatibility - not necessary to load minimumOverlap
    if (!trackLengthAndOverlapA.isEmpty()) {
      if (lengthOfPiecesA.isNull()) {
        lengthOfPiecesA
          .set(Utilities.getElementFromList(trackLengthAndOverlapA.toString(), 0));
      }
      minimumOverlapA
        .set(Utilities.getElementFromList(trackLengthAndOverlapA.toString(), 1));
    }
    if (!trackLengthAndOverlapB.isEmpty()) {
      if (lengthOfPiecesB.isNull()) {
        lengthOfPiecesB
          .set(Utilities.getElementFromList(trackLengthAndOverlapB.toString(), 0));
      }
      minimumOverlapB
        .set(Utilities.getElementFromList(trackLengthAndOverlapB.toString(), 1));
    }
    ...
    boolean backwardCompatabilityCorrection =
      etomoModifiedVersionLt(CORRECTED_RAW_IMAGE_STACK_EXT_KEY_VERSION);
    if (backwardCompatabilityCorrection) {
      String key =
        Utilities.createPropertyKey(prepend, INCORRECT_RAW_IMAGE_STACK_EXT_KEY);
      rawImageStackExt.set(props.getProperty(key));
      removeIncorrectRawImageStackExtKey = true;
      key = Utilities.createPropertyKey(prepend, INCORRECT_ORIG_RAW_IMAGE_STACK_EXT_KEY);
      origRawImageStackExt.set(stripExtensionDivider(props.getProperty(key)));
      removeIncorrectOrigRawImageStackExtKey = true;
    }
    if (!backwardCompatabilityCorrection || rawImageStackExt.isEmpty()) {
      rawImageStackExt.load(props, prepend);
    }
    if (!backwardCompatabilityCorrection || origRawImageStackExt.isEmpty()) {
      origRawImageStackExt.load(props, prepend);
      // This should not be necessary as the extension is now being saved without the ".".
      origRawImageStackExt.set(stripExtensionDivider(origRawImageStackExt.toString()));
    }
    origRawImageStackExtLock.load(props, prepend);
    ...
    genHammingLikeFilterA.load(props, prepend);
    genHammingLikeFilterB.load(props, prepend);
    genFakeSIRTiterationsA.load(props, prepend);
    genFakeSIRTiterationsB.load(props, prepend);
    genExactFilterSizeA.load(props, prepend);
    genExactFilterSizeB.load(props, prepend);
    sirtRadialRadiusA.load(props, prepend);
    sirtRadialRadiusB.load(props, prepend);
    sirtRadialSigmaA.load(props, prepend);
    sirtRadialSigmaB.load(props, prepend);
    batchRunTomoLogReadTimestamp.load(props, prepend);
    batchRunTomoLogReadFinished.load(props, prepend);
    positioningNewDialogA.load(props, prepend);
    positioningNewDialogB.load(props, prepend);
    genFilterTrialsA.load(props, prepend);
    genFilterTrialsB.load(props, prepend);
    genFilterTrialsFakeSIRTiterationsA.load(props, prepend);
    genFilterTrialsFakeSIRTiterationsB.load(props, prepend);
    genFilterTrialsExactObjectSizesA.load(props, prepend);
    genFilterTrialsExactObjectSizesB.load(props, prepend);
    genFilterTrialsGaussianCutoffsA.load(props, prepend);
    genFilterTrialsGaussianCutoffsB.load(props, prepend);
    genFilterTrialsGaussianFalloffsA.load(props, prepend);
    genFilterTrialsGaussianFalloffsB.load(props, prepend);
    genFilterTrialsHammingLikeStartsA.load(props, prepend);
    genFilterTrialsHammingLikeStartsB.load(props, prepend);
    stackMtfFilterLowPassRadiusSigmaA.load(props, prepend);
    stackMtfFilterLowPassRadiusSigmaB.load(props, prepend);
    stackMtfFilterMtfFileA.load(props, prepend);
    stackMtfFilterMtfFileB.load(props, prepend);
    stackMtfFilterMaximumInverseA.load(props, prepend);
    stackMtfFilterMaximumInverseB.load(props, prepend);
    stackMtfFilterOptimalDoseScalingA.load(props, prepend);
    stackMtfFilterOptimalDoseScalingB.load(props, prepend);
    stackMtfFilterBidirectionalNumViewsA.load(props, prepend);
    stackMtfFilterBidirectionalNumViewsB.load(props, prepend);
    useStackCtfPhaseFlipXAxisTiltA.load(props, prepend);
    useStackCtfPhaseFlipXAxisTiltB.load(props, prepend);
    stackCtfPhaseFlipXAxisTiltA.load(props, prepend);
    stackCtfPhaseFlipXAxisTiltB.load(props, prepend);
    stackCtfPhaseFlipScaleByCtfPowerA.load(props, prepend);
    stackCtfPhaseFlipScaleByCtfPowerB.load(props, prepend);
    stackMtfFilterInverseRolloffRadiusSigmaA.load(props, prepend);
    stackMtfFilterInverseRolloffRadiusSigmaB.load(props, prepend);
    useStackMtfFilterFixedImageDoseA.load(props, prepend);
    useStackMtfFilterFixedImageDoseB.load(props, prepend);
    stackMtfFilterFixedImageDoseA.load(props, prepend);
    stackMtfFilterFixedImageDoseB.load(props, prepend);
    stackMtfFilterDoseWeightingFileA.load(props, prepend);
    stackMtfFilterDoseWeightingFileB.load(props, prepend);
    stackMtfFilterTypeOfDoseFileA.load(props, prepend);
    stackMtfFilterTypeOfDoseFileB.load(props, prepend);
    stackMtfFilterVoltage200A.load(props, prepend);
    stackMtfFilterVoltage200B.load(props, prepend);
    batchRunTomoLogReadAxisID =
      AxisID.getInstance(props.getProperty(group + BATCH_RUN_TOMO_LOG_FILE_AXIS_ID_KEY));
    // batchruntomo settings
    postTrimvolSwapYZFromBatchruntomo.load(props);
    postTrimvolRotateXFromBatchruntomo.load(props);
    postTrimvolConvertToBytesFromBatchruntomo.load(props);
    postTrimvolSectionScaleMinFromBatchruntomo.load(props);
    postTrimvolSectionScaleMaxFromBatchruntomo.load(props);
    postTrimvolZMinFromBatchruntomo.load(props);
    postTrimvolZMaxFromBatchruntomo.load(props);
    postTrimvolScaleXMinFromBatchruntomo.load(props);
    postTrimvolScaleYMinFromBatchruntomo.load(props);
    postTrimvolScaleXMaxFromBatchruntomo.load(props);
    postTrimvolScaleYMaxFromBatchruntomo.load(props);
    stackAlignedStackEraseGoldFromBatchruntomo.load(props);
    origRawImageStackExtFromBatchRunTomo.load(props);
  ...
  // Bug# 2403
  /**
   * Uses the datast or the environment (as a fallback) to repair
  ...
  void repairImageFilenameStyle(final String parentPrepend) {
    ...
    ImageFilenameStyle imageFilenameStyle = getDatasetImageFilenameStyle();
    if (imageFilenameStyle != null) {
      repairType = "image file name style from this project's dataset";
    }
    else {
    ...
    if (imageFilenameStyle != null) {
      System.err.println("\nINFO: Attempting to repair the " + key
        ...
        + " and\nsetting " + key + " to " + imageFilenameStyle + ".  " + "[Bug# 2403]\n");
  ...
  /**
   * Removes "." from the start of fileExt if necessary.  For backwards compatability.
   * @param fileExt
   * @return fileExt -  minus "." starting character if there
   */
  private String stripExtensionDivider(final String fileExt) {
    if (fileExt != null && fileExt.startsWith(Extension.EXTENSION_DIVIDER)
      && fileExt.length() > 1) {
  ...
  public boolean isTrackLowerTargetForClusteredNull(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return trackLowerTargetForClusteredB.isNull();
    }
    return trackLowerTargetForClusteredA.isNull();
  }

  public String getTrackLowerTargetForClustered(AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return trackLowerTargetForClusteredB.toString();
    }
    return trackLowerTargetForClusteredA.toString();
  }

  public void setTrackLowerTargetForClustered(final AxisID axisID, final String input) {
    if (axisID == AxisID.SECOND) {
      trackLowerTargetForClusteredB.set(input);
    }
    else {
      trackLowerTargetForClusteredA.set(input);
    }
  }
  ...
  public void setSuperSampleFactor(final AxisID axisID, final Number input) {
    if (axisID == AxisID.SECOND) {
      genSuperSampleFactorB.set(input);
    }
    else {
      genSuperSampleFactorA.set(input);
    }
  }

  public void setExpandInputLines(final AxisID axisID, final boolean input) {
    if (axisID == AxisID.SECOND) {
      genExpandInputLinesB.set(input);
    }
    else {
      genExpandInputLinesA.set(input);
    }
  }
  ...
  public void setFinalStackExpandCircleIterations(final AxisID axisID,
    final Object input) {
    if (axisID == AxisID.SECOND) {
  ...
  public void setFinalStackExpandCircleIterations(final AxisID axisID,
    final String input) {
    if (axisID == AxisID.SECOND) {
      finalStackExpandCircleIterationsB.set(input);
    }
    else {
      finalStackExpandCircleIterationsA.set(input);
    }
  }
  ...
  public void store(final Properties props, String prepend) {
    ...
    genSuperSampleFactorA.store(props, prepend);
    genSuperSampleFactorB.store(props, prepend);
    genExpandInputLinesA.store(props, prepend);
    genExpandInputLinesB.store(props, prepend);
    ...
    trackLowerTargetForClusteredA.store(props, prepend);
    trackLowerTargetForClusteredB.store(props, prepend);
    ...
    rawImageStackExt.store(props, prepend);
    if (removeIncorrectRawImageStackExtKey) {
      props
        .remove(Utilities.createPropertyKey(prepend, INCORRECT_RAW_IMAGE_STACK_EXT_KEY));
    }
    origRawImageStackExt.store(props, prepend);
    origRawImageStackExtLock.store(props, prepend);
    if (removeIncorrectOrigRawImageStackExtKey) {
      props.remove(
        Utilities.createPropertyKey(prepend, INCORRECT_ORIG_RAW_IMAGE_STACK_EXT_KEY));
    }
    ...
    sampleTypeA.store(props, prepend);
    sampleTypeB.store(props, prepend);
    hasGoldBeadsA.store(props, prepend);
    hasGoldBeadsB.store(props, prepend);
    positioningBeadSizeA.store(props, prepend);
    positioningBeadSizeB.store(props, prepend);
    extraThicknessA.store(props, prepend);
    extraThicknessB.store(props, prepend);
    extraThicknessCryoA.store(props, prepend);
    extraThicknessCryoB.store(props, prepend);
    genHammingLikeFilterA.store(props, prepend);
    genHammingLikeFilterB.store(props, prepend);
    genFakeSIRTiterationsA.store(props, prepend);
    genFakeSIRTiterationsB.store(props, prepend);
    genExactFilterSizeA.store(props, prepend);
    genExactFilterSizeB.store(props, prepend);
    sirtRadialRadiusA.store(props, prepend);
    sirtRadialRadiusB.store(props, prepend);
    sirtRadialSigmaA.store(props, prepend);
    sirtRadialSigmaB.store(props, prepend);
    batchRunTomoLogReadTimestamp.store(props, prepend);
    batchRunTomoLogReadFinished.store(props, prepend);
    positioningNewDialogA.store(props, prepend);
    positioningNewDialogB.store(props, prepend);
    genFilterTrialsA.store(props, prepend);
    genFilterTrialsB.store(props, prepend);
    genFilterTrialsFakeSIRTiterationsA.store(props, prepend);
    genFilterTrialsFakeSIRTiterationsB.store(props, prepend);
    genFilterTrialsExactObjectSizesA.store(props, prepend);
    genFilterTrialsExactObjectSizesB.store(props, prepend);
    genFilterTrialsHammingLikeStartsA.store(props, prepend);
    genFilterTrialsHammingLikeStartsB.store(props, prepend);
    genFilterTrialsGaussianCutoffsA.store(props, prepend);
    genFilterTrialsGaussianCutoffsB.store(props, prepend);
    genFilterTrialsGaussianFalloffsA.store(props, prepend);
    genFilterTrialsGaussianFalloffsB.store(props, prepend);
    stackMtfFilterLowPassRadiusSigmaA.store(props, prepend);
    stackMtfFilterLowPassRadiusSigmaB.store(props, prepend);
    stackMtfFilterMtfFileA.store(props, prepend);
    stackMtfFilterMtfFileB.store(props, prepend);
    stackMtfFilterMaximumInverseA.store(props, prepend);
    stackMtfFilterMaximumInverseB.store(props, prepend);
    stackMtfFilterOptimalDoseScalingA.store(props, prepend);
    stackMtfFilterOptimalDoseScalingB.store(props, prepend);
    stackMtfFilterBidirectionalNumViewsA.store(props, prepend);
    stackMtfFilterBidirectionalNumViewsB.store(props, prepend);
    useStackCtfPhaseFlipXAxisTiltA.store(props, prepend);
    useStackCtfPhaseFlipXAxisTiltB.store(props, prepend);
    stackCtfPhaseFlipXAxisTiltA.store(props, prepend);
    stackCtfPhaseFlipXAxisTiltB.store(props, prepend);
    stackCtfPhaseFlipScaleByCtfPowerA.store(props, prepend);
    stackCtfPhaseFlipScaleByCtfPowerB.store(props, prepend);
    stackMtfFilterInverseRolloffRadiusSigmaA.store(props, prepend);
    stackMtfFilterInverseRolloffRadiusSigmaB.store(props, prepend);
    useStackMtfFilterFixedImageDoseA.store(props, prepend);
    useStackMtfFilterFixedImageDoseB.store(props, prepend);
    stackMtfFilterFixedImageDoseA.store(props, prepend);
    stackMtfFilterFixedImageDoseB.store(props, prepend);
    stackMtfFilterDoseWeightingFileA.store(props, prepend);
    stackMtfFilterDoseWeightingFileB.store(props, prepend);
    stackMtfFilterTypeOfDoseFileA.store(props, prepend);
    stackMtfFilterTypeOfDoseFileB.store(props, prepend);
    stackMtfFilterVoltage200A.store(props, prepend);
    stackMtfFilterVoltage200B.store(props, prepend);
    rawImageStackExt.store(props, prepend);
    if (batchRunTomoLogReadAxisID != null) {
      setProperty(props, group, BATCH_RUN_TOMO_LOG_FILE_AXIS_ID_KEY,
        batchRunTomoLogReadAxisID.getExtension());
    }
    // batchruntomo settings
    postTrimvolSwapYZFromBatchruntomo.store(props);
    postTrimvolRotateXFromBatchruntomo.store(props);
    postTrimvolConvertToBytesFromBatchruntomo.store(props);
    postTrimvolSectionScaleMinFromBatchruntomo.store(props);
    postTrimvolSectionScaleMaxFromBatchruntomo.store(props);
    postTrimvolZMinFromBatchruntomo.store(props);
    postTrimvolZMaxFromBatchruntomo.store(props);
    postTrimvolScaleXMinFromBatchruntomo.store(props);
    postTrimvolScaleYMinFromBatchruntomo.store(props);
    postTrimvolScaleXMaxFromBatchruntomo.store(props);
    postTrimvolScaleYMaxFromBatchruntomo.store(props);
    stackAlignedStackEraseGoldFromBatchruntomo.store(props);
    origRawImageStackExtFromBatchRunTomo.store(props);
  }

  public String getExtraThickness(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return extraThicknessB.toString();
    }
    return extraThicknessA.toString();
  }

  public String getExtraThicknessCryo(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return extraThicknessCryoB.toString();
    }
    return extraThicknessCryoA.toString();
  }

  public void setExtraThicknessCryo(final AxisID axisID, final String input) {
    if (axisID == AxisID.SECOND) {
      extraThicknessCryoB.set(input);
    }
    else {
      extraThicknessCryoA.set(input);
    }
  }

  public void setExtraThickness(final AxisID axisID, final String input) {
    if (axisID == AxisID.SECOND) {
      extraThicknessB.set(input);
    }
    else {
      extraThicknessA.set(input);
    }
  }

  /**
   * @deprecated 2/19/2018 incorrectly named member variable - use ...BeadSize
   */
  @SuppressWarnings("deprecation")
  public boolean isPositioningFiducialDiameterNull(final AxisID axisID) {
    return isPositioningBeadSizeNull(axisID);
  }

  public boolean isPositioningBeadSizeNull(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return positioningBeadSizeB.isNull();
    }
    return positioningBeadSizeA.isNull();
  }

  public boolean isHasGoldBeadsNull(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return hasGoldBeadsB.isNull();
    }
    return hasGoldBeadsA.isNull();
  }

  /**
   * @deprecated 2/19/2018 incorrectly named member variable - use ...BeadSize
   */
  public void setPositioningFiducialDiameter(final AxisID axisID, final String input) {
    setPositioningBeadSize(axisID, input);
  }

  public void setPositioningBeadSize(final AxisID axisID, final String input) {
    if (axisID == AxisID.SECOND) {
      positioningBeadSizeB.set(input);
    }
    else {
      positioningBeadSizeA.set(input);
    }
  }
   ...
   */
  @SuppressWarnings("deprecation")
  public double getPositioningFiducialDiameter(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return positioningBeadSizeB.getDouble();
    }
    return positioningBeadSizeA.getDouble();
  }

  public String getPositioningBeadSize(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return positioningBeadSizeB.toString();
    }
    return positioningBeadSizeA.toString();
  }

  public void setHasGoldBeads(final AxisID axisID, final boolean input) {
    if (axisID == AxisID.SECOND) {
      hasGoldBeadsB.set(input);
    }
    else {
      hasGoldBeadsA.set(input);
    }
  }

  public boolean isHasGoldBeads(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return hasGoldBeadsB.is();
    }
    return hasGoldBeadsA.is();
  }

  public void setSampleType(final AxisID axisID, final SampleType input) {
    if (axisID == AxisID.SECOND) {
      if (input == null) {
        sampleTypeB.reset();
      }
      else {
        sampleTypeB.set(input.getValue());
      }
    }
    else {
      if (input == null) {
        ...
        sampleTypeA.set(input.getValue());
      }
    }
  }

  public void setSampleType(final AxisID axisID, final String input) {
    if (axisID == AxisID.SECOND) {
      sampleTypeB.set(input);
    }
    else {
      sampleTypeA.set(input);
    }
  }

  public SampleType getSampleType(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return SampleType.getInstance(sampleTypeB, false);
    }
    return SampleType.getInstance(sampleTypeA, false);
  }
  ...
  public void resetBatchruntomoCombineSettings() {
    combineParams.resetBatchruntomoCombineSettings();
  }

  public void moveBatchruntomoSettings() {
    combineParams.moveBatchruntomoSettings();

    if (!stackAlignedStackEraseGoldFromBatchruntomo.isNull()) {
      stackEraseGoldModelUseFidA
        .set(stackAlignedStackEraseGoldFromBatchruntomo.equals(EraseGold.FID.getValue()));
      stackAlignedStackEraseGoldFromBatchruntomo.reset();
    }
    if (!origRawImageStackExtFromBatchRunTomo.isEmpty()) {
      origRawImageStackExt.set(origRawImageStackExtFromBatchRunTomo.toString());
      origRawImageStackExtLock.set(true);
      origRawImageStackExtFromBatchRunTomo.reset();
    }
  }

  /**
   * Move batchruntomo trimvol
   * @param display
   */
  public void movePostTrimvolBatchruntomoSettings(final TrimvolDisplay display) {
    if (!postTrimvolSwapYZFromBatchruntomo.isNull()) {
      postTrimvolSwapYZ.set(postTrimvolSwapYZFromBatchruntomo);
      if (display != null) {
        display.setSwapYZ(postTrimvolSwapYZFromBatchruntomo.is());
      }
      postTrimvolSwapYZFromBatchruntomo.reset();
    }
    if (!postTrimvolRotateXFromBatchruntomo.isNull()) {
      postTrimvolRotateX.set(postTrimvolRotateXFromBatchruntomo);
      if (display != null) {
        display.setRotateX(postTrimvolRotateXFromBatchruntomo.is());
      }
      postTrimvolRotateXFromBatchruntomo.reset();
    }
    if (!postTrimvolConvertToBytesFromBatchruntomo.isNull()) {
      postTrimvolConvertToBytes.set(postTrimvolConvertToBytesFromBatchruntomo);
      if (display != null) {
        display.setConvertToBytes(postTrimvolConvertToBytesFromBatchruntomo.is());
      }
      postTrimvolConvertToBytesFromBatchruntomo.reset();
    }
    if (!postTrimvolSectionScaleMinFromBatchruntomo.isNull()) {
      postTrimvolSectionScaleMin
        .set(postTrimvolSectionScaleMinFromBatchruntomo.toString());
      if (display != null) {
        display.setSectionScaleMin(postTrimvolSectionScaleMinFromBatchruntomo.toString());
      }
      postTrimvolSectionScaleMinFromBatchruntomo.reset();
    }
    if (!postTrimvolSectionScaleMaxFromBatchruntomo.isNull()) {
      postTrimvolSectionScaleMax
        .set(postTrimvolSectionScaleMaxFromBatchruntomo.toString());
      if (display != null) {
        display.setSectionScaleMax(postTrimvolSectionScaleMaxFromBatchruntomo.toString());
      }
      postTrimvolSectionScaleMaxFromBatchruntomo.reset();
    }
    if (!postTrimvolZMinFromBatchruntomo.isEmpty()) {
      postTrimvolZMin.set(postTrimvolZMinFromBatchruntomo.toString());
      if (display != null) {
        display.setZMin(postTrimvolZMinFromBatchruntomo.toString());
      }
      postTrimvolZMinFromBatchruntomo.reset();
    }
    if (!postTrimvolZMaxFromBatchruntomo.isEmpty()) {
      postTrimvolZMax.set(postTrimvolZMaxFromBatchruntomo.toString());
      if (display != null) {
        display.setZMax(postTrimvolZMaxFromBatchruntomo.toString());
      }
      postTrimvolZMaxFromBatchruntomo.reset();
    }
    if (!postTrimvolScaleXMinFromBatchruntomo.isNull()) {
      postTrimvolScaleXMin.set(postTrimvolScaleXMinFromBatchruntomo.toString());
      if (display != null) {
        display.setScaleXMin(postTrimvolScaleXMinFromBatchruntomo.toString());
      }
      postTrimvolScaleXMinFromBatchruntomo.reset();
    }
    if (!postTrimvolScaleYMinFromBatchruntomo.isNull()) {
      postTrimvolScaleYMin.set(postTrimvolScaleYMinFromBatchruntomo.toString());
      if (display != null) {
        display.setScaleYMin(postTrimvolScaleYMinFromBatchruntomo.toString());
      }
      postTrimvolScaleYMinFromBatchruntomo.reset();
    }
    if (!postTrimvolScaleXMaxFromBatchruntomo.isNull()) {
      postTrimvolScaleXMax.set(postTrimvolScaleXMaxFromBatchruntomo.toString());
      if (display != null) {
        display.setScaleXMax(postTrimvolScaleXMaxFromBatchruntomo.toString());
      }
      postTrimvolScaleXMaxFromBatchruntomo.reset();
    }
    if (!postTrimvolScaleYMaxFromBatchruntomo.isNull()) {
      postTrimvolScaleYMax.set(postTrimvolScaleYMaxFromBatchruntomo.toString());
      if (display != null) {
        display.setScaleYMax(postTrimvolScaleYMaxFromBatchruntomo.toString());
      }
      postTrimvolScaleYMaxFromBatchruntomo.reset();
    }
  }

  public boolean isNewBatchruntomoCombineSettings() {
    return combineParams.isNewBatchruntomoCombineSettings();
  }
  ...
  public void setTomoGenTrialTomogramNameList(final AxisID axisID,
    final IntKeyList input) {
    if (axisID == AxisID.SECOND) {
  ...
  public String getRadialRadius(final PanelId panelId, final AxisID axisID) {
    if (panelId == PanelId.TILT) {
      if (axisID == AxisID.SECOND) {
      ...
      if (axisID == AxisID.SECOND) {
        return sirtRadialRadiusB.toString();
      }
      return sirtRadialRadiusA.toString();
    }
    return null;
  }

  public String getRadialSigma(final PanelId panelId, final AxisID axisID) {
    if (panelId == PanelId.TILT) {
      if (axisID == AxisID.SECOND) {
      ...
      if (axisID == AxisID.SECOND) {
        return sirtRadialSigmaB.toString();
      }
      return sirtRadialSigmaA.toString();
    }
    return null;
  }
  ...
  public ConstEtomoNumber getGenSuperSampleFactor(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return genSuperSampleFactorB;
    }
    return genSuperSampleFactorA;
  }

  public ConstEtomoNumber getGenExpandInputLines(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return genExpandInputLinesB;
    }
    return genExpandInputLinesA;
  }
  ...
  public boolean isOrigScopeTemplate() {
    return !origScopeTemplate.isEmpty();
  }
  ...
  public boolean isOrigSystemTemplate() {
    return !origSystemTemplate.isEmpty();
  }
  ...
  public boolean isOrigUserTemplate() {
    return !origUserTemplate.isEmpty();
  }
  ...
  /**
   * @return true if fiducial diameter is not blank or zero.
   */
  public boolean isFiducialDiameterAvailable() {
    return fiducialDiameter != Double.NaN && fiducialDiameter != 0;
  }

  /**
   * 
   * @return true if the positioning dialog has never been saved previously.
   */
  public boolean isPositioningNewDialog(AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return positioningNewDialogB.is();
    }
    return positioningNewDialogA.is();
  }

  public void setPositioningNewDialog(AxisID axisID, final boolean input) {
    if (axisID == AxisID.SECOND) {
      positioningNewDialogB.set(input);
    }
    else {
      positioningNewDialogA.set(input);
    }
  }
  ...
  public void resetExcludeProjections(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      excludeProjectionsB = "";
    }
    else {
  ...
  public boolean isDatasetNameValid(final File paramFile) {
    ...
    if (paramFile == null) {
      ...
      if (getValidDatasetDirectory(
        new File(paramFile.getParent()).getAbsolutePath()) != null) {
        return true;
      }
    }
    return false;
  ...
  public File getValidDatasetDirectory(final String workingDirName) {
    ...
    if (isValid(workingDir, true)) {
      ...
      if (!workingDir.exists() && !backupDir.exists()) {
        invalidReason = "The working directory: " + workingDir.getAbsolutePath()
          + " and the backup directory: " + backupDir.getAbsolutePath() + " do not exist";
        return null;
      }
    ...
    if (rawImageStackExt.isEmpty()) {
      throw new IllegalStateException("Raw stack extension not found or invalid");
    }
    // Does the appropriate image stack exist in the working directory
    if (axisType == AxisType.DUAL_AXIS) {
      currentDir = findValidFile(
        datasetName + "a" + Extension.EXTENSION_DIVIDER + rawImageStackExt.toString(),
        currentDir, backupDir);
    }
    else {
      currentDir = findValidFile(
        datasetName + Extension.EXTENSION_DIVIDER + rawImageStackExt.toString(),
        currentDir, backupDir);
    }
  ...
  public boolean equals(final Object object) {
    ...
    if ((excludeProjectionsA == null && excludeProjectionsA != cmd.excludeProjectionsA)
      || (excludeProjectionsA != null
        && !excludeProjectionsA.equals(cmd.getExcludeProjectionsA())))
      return false;
    ...
    if ((excludeProjectionsB == null && excludeProjectionsB != cmd.excludeProjectionsB)
      || (excludeProjectionsB != null
        && !excludeProjectionsB.equals(cmd.getExcludeProjectionsB())))
      return false;
