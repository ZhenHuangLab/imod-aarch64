...
public final class SerialSectionsMetaData extends BaseMetaData
  implements ConstSerialSectionsMetaData {
  public static final String rcsid = "$Id:$";

  public static final String NEW_TITLE = "Serial Sections";
  private static final EtomoVersion CURRENT_VERSION =
  ...
  private final EtomoBoolean2 extractPlmdocMetadataFile =
    new EtomoBoolean2("MdocMetadataFile");
  ...
  private final EtomoNumber robustFitCriterion =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "RobustFitCriterion");
  ...
  private final EtomoBoolean2 hybridFitsTranslations =
    new EtomoBoolean2("HybridFitsTranslations");
  private final EtomoBoolean2 hybridFitsTranslationsRotations =
    new EtomoBoolean2("HybridFitsTranslationsRotations");
  private final EtomoBoolean2 noOptions = new EtomoBoolean2("NoOptions");
  private final EtomoBoolean2 numberToFitGlobalAlignment =
    new EtomoBoolean2("NumberToFitGlobalAlignment");
  ...
  private final EtomoBoolean2 preblendVerySloppyMontage =
    new EtomoBoolean2("PreblendVerySloppyMontage");

  public SerialSectionsMetaData(final BaseManager manager,
    final LogProperties logProperties, final boolean newDataset) {
  ...
  public void load(final Properties props, String prepend) {
    ...
    stack.reset();
    viewType.reset();
    extractPlmdocMetadataFile.reset();
    ...
    sizeY.reset();
    tab.reset();
    preblendVerySloppyMontage.reset();
    // load
    ...
    extractPlmdocMetadataFile.load(props, prepend);
    ...
    preblendVerySloppyMontage.load(props, prepend);
  }
  ...
  public void store(final Properties props, String prepend) {
    ...
    extractPlmdocMetadataFile.store(props, prepend);
    ...
    preblendVerySloppyMontage.store(props, prepend);
  }
  ...
  public void setStartupData(final SerialSectionsStartupData startupData) {
    ...
    extractPlmdocMetadataFile.set(startupData.getMdocMetadataFile());
  ...
  public boolean isextractPlMdocMetadataFile() {
    return extractPlmdocMetadataFile.is();
  }
  ...
  public boolean isPreblendVerySloppyMontage() {
    return preblendVerySloppyMontage.is();
  }
  ...
  public void setPreblendVerySloppyMontage(final boolean input) {
    preblendVerySloppyMontage.set(input);
  }
}
