...
public final class DataFileType {
  ...
  public static final DataFileType JOIN = new DataFileType(".ejf", false);
  public static final DataFileType PARALLEL = new DataFileType(".epp", false);
  public static final DataFileType BATCH_RUN_TOMO = new DataFileType(".ebt", false);
  public static final DataFileType PEET = new DataFileType(".epe", false);
  public static final DataFileType SERIAL_SECTIONS = new DataFileType(".ess", false);
  public static final DataFileType TOOLS = new DataFileType(null, false);
