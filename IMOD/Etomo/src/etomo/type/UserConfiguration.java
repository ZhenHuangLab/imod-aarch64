...
public final class UserConfiguration implements Storable {
  ...
  private final EtomoNumber batchTableSize = new EtomoNumber("BatchTableSize");
  ...
  private final EtomoBoolean2 removeExcludedViews =
    new EtomoBoolean2("RemoveExcludedViews");
  private final EtomoNumber batchCloseDatasets =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "Batch.CloseDatasets");
  ...
  public UserConfiguration() {
    ...
    batchTableSize.setDisplayValue(20);
  ...
  public void store(Properties props, String prepend) {
    ...
    batchTableSize.store(props, prepend);
    ...
    removeExcludedViews.store(props, prepend);
    batchCloseDatasets.store(props, prepend);
  ...
  public void load(Properties props, String prepend) {
    ...
    batchTableSize.load(props, prepend);
    ...
    if (revisionNumber.le(EtomoVersion.getDefaultInstance("1.2"))) {
      ...
      if (batchTableSize.isNull()) {
        batchTableSize.load(props, ".");
      }
    }
    // revisionNumber = props.getProperty(group + "RevisionNumber", "1.0");
    nativeLookAndFeel = Boolean
      .valueOf(props.getProperty(group + "NativeLookAndFeel", "false")).booleanValue();
    advancedDialogs = Boolean
      .valueOf(props.getProperty(group + "AdvancedDialogs", "false")).booleanValue();
    compactDisplay = Boolean
      .valueOf(props.getProperty(group + COMPACT_DISPLAY_KEY, "false")).booleanValue();
    ...
    removeExcludedViews.load(props, prepend);
    batchCloseDatasets.load(props, prepend);
  ...
  public void setBatchCloseDatasets(final boolean input) {
    batchCloseDatasets.set(input);
  }

  public boolean isBatchCloseDatasets() {
    return batchCloseDatasets.is();
  }
  ...
  public ConstEtomoNumber getBatchTableSize() {
    return batchTableSize;
  }
  ...
  public void setBatchTableSize(String input) {
    batchTableSize.set(input);
  }
  ...
  public boolean isRemoveExcludedViews() {
    return removeExcludedViews.is();
  }

  public void setRemoveExcludedViews(final boolean input) {
    removeExcludedViews.set(input);
  }
