...
public class TomogramState extends BaseState {
  ...
  private static final String COMBINE_MATCH_MODE_KEY =
    DialogType.TOMOGRAM_COMBINATION.getStorableName() + "." + "MatchMode";
  private static final String COMBINE_MATCH_MODE_BACK_KEY = "Setup.Combine.MatchBtoA";
  private static final String COMBINE_SCRIPTS_CREATED_BACK_KEY =
    "Setup.ComScriptsCreated";
  private static final String SAMPLE_FIDUCIALESS_KEY =
    DialogType.TOMOGRAM_POSITIONING.getStorableName() + '.' + ProcessName.TILT + '.'
      + "Fiducialess";
  ...
  private final EtomoNumber angleOffsetA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, AxisID.FIRST.getExtension() + '.'
      + ProcessName.ALIGN + '.' + ConstTiltalignParam.ANGLE_OFFSET_KEY);
  private final EtomoNumber angleOffsetB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, AxisID.SECOND.getExtension() + '.'
      + ProcessName.ALIGN + '.' + ConstTiltalignParam.ANGLE_OFFSET_KEY);
  private final EtomoNumber axisZShiftA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, AxisID.FIRST.getExtension() + '.'
      + ProcessName.ALIGN + '.' + ConstTiltalignParam.AXIS_Z_SHIFT_KEY);
  private final EtomoNumber axisZShiftB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, AxisID.SECOND.getExtension() + '.'
      + ProcessName.ALIGN + '.' + ConstTiltalignParam.AXIS_Z_SHIFT_KEY);

  private final EtomoNumber sampleAngleOffsetA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, AxisID.FIRST.getExtension() + '.'
      + ProcessName.SAMPLE + '.' + ConstTiltalignParam.ANGLE_OFFSET_KEY);
  private final EtomoNumber sampleAngleOffsetB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, AxisID.SECOND.getExtension() + '.'
      + ProcessName.SAMPLE + '.' + ConstTiltalignParam.ANGLE_OFFSET_KEY);
  private final EtomoNumber sampleAxisZShiftA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, AxisID.FIRST.getExtension() + '.'
      + ProcessName.SAMPLE + '.' + ConstTiltalignParam.AXIS_Z_SHIFT_KEY);
  private final EtomoNumber sampleAxisZShiftB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, AxisID.SECOND.getExtension() + '.'
      + ProcessName.SAMPLE + '.' + ConstTiltalignParam.AXIS_Z_SHIFT_KEY);
  ...
  private final EtomoNumber seedFileLastModifiedA = new EtomoNumber(EtomoNumber.Type.LONG,
    AxisID.FIRST.getExtension() + '.' + USE_FID_AS_SEED + '.' + LAST_MODIFIED);
  private final EtomoNumber seedFileLastModifiedB = new EtomoNumber(EtomoNumber.Type.LONG,
    AxisID.SECOND.getExtension() + '.' + USE_FID_AS_SEED + '.' + LAST_MODIFIED);
  private final EtomoBoolean2 fixedFiducialsA =
    new EtomoBoolean2(AxisID.FIRST.getExtension() + "." + FIXED_FIDUCIALS_KEY);
  private final EtomoBoolean2 fixedFiducialsB =
    new EtomoBoolean2(AxisID.SECOND.getExtension() + "." + FIXED_FIDUCIALS_KEY);
  ...
  private final EtomoBoolean2 seedingDoneA =
    new EtomoBoolean2(AxisID.FIRST.getExtension() + '.' + "SeedingDone");
  private final EtomoBoolean2 seedingDoneB =
    new EtomoBoolean2(AxisID.SECOND.getExtension() + '.' + "SeedingDone");
  private final EtomoBoolean2 xcorrBlendmontWasRunA =
    new EtomoBoolean2("xcorr.blendmont.a.WasRun");
  private final EtomoBoolean2 xcorrBlendmontWasRunB =
    new EtomoBoolean2("xcorr.blendmont.b.WasRun");
  private final EtomoNumber imageRotationForAliStackFromBatchruntomo = new EtomoNumber(
    EtomoNumber.Type.DOUBLE, MetaData.BATCHRUNTOMO_KEY + ".ImageRotationForAliStack");
   ...
   * stored.
   */
  private EtomoNumber tomogramSizeA =
    new EtomoNumber(EtomoNumber.Type.LONG, A_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY);
  /**
   * @deprecated Eventually this should be completely replaced by
   ...
   * stored.
   */
  private EtomoNumber tomogramSizeB =
    new EtomoNumber(EtomoNumber.Type.LONG, B_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY);
  private final EtomoBoolean2 adjustOriginA =
    new EtomoBoolean2(A_AXIS_KEY + "." + ADJUST_ORIGIN_KEY);
  private final EtomoBoolean2 adjustOriginB =
    new EtomoBoolean2(B_AXIS_KEY + "." + ADJUST_ORIGIN_KEY);
  ...
  private final EtomoBoolean2 stackUseLinearInterpolationA =
    new EtomoBoolean2(STACK_KEY + "." + A_AXIS_KEY + ".UseLinearInterpolation");
  private final EtomoBoolean2 stackUseLinearInterpolationB =
    new EtomoBoolean2(STACK_KEY + "." + B_AXIS_KEY + ".UseLinearInterpolation");
  private final StringProperty stackUserSizeToOutputInXandYA =
    new StringProperty(STACK_KEY + "." + A_AXIS_KEY + ".SizeToOutputInXandY");
  private final StringProperty stackUserSizeToOutputInXandYB =
    new StringProperty(STACK_KEY + "." + B_AXIS_KEY + ".SizeToOutputInXandY");
  private final EtomoNumber stackImageRotationA = new EtomoNumber(EtomoNumber.Type.DOUBLE,
    STACK_KEY + "." + A_AXIS_KEY + ".ImageRotation");
  private final EtomoNumber stackImageRotationB = new EtomoNumber(EtomoNumber.Type.DOUBLE,
    STACK_KEY + "." + B_AXIS_KEY + ".ImageRotation");
  ...
  private final EtomoBoolean2 stackUsingNewstOrBlend3dFindOutputA =
    new EtomoBoolean2("Track.A.UsingNewstOrBlend3dFindOutput");
  private final EtomoBoolean2 stackUsingNewstOrBlend3dFindOutputB =
    new EtomoBoolean2("Track.B.UsingNewstOrBlend3dFindOutput");

  private final EtomoBoolean2 useFixedStackWarningA =
    new EtomoBoolean2(PRE_KEY + ".A.UseFixedStack.Warning");
  private final EtomoBoolean2 useFixedStackWarningB =
    new EtomoBoolean2(PRE_KEY + ".B.UseFixedStack.Warning");
  private final EtomoBoolean2 useRaptorResultWarningA =
    new EtomoBoolean2(TRACK_KEY + ".A.UseRaptorResult.Warning");
  private final EtomoBoolean2 useCtfCorrectionWarningA =
    new EtomoBoolean2(STACK_KEY + ".A.UseCtfCorrection.Warning");
  private final EtomoBoolean2 useCtfCorrectionWarningB =
    new EtomoBoolean2(STACK_KEY + ".B.UseCtfCorrection.Warning");
  private final EtomoBoolean2 useErasedStackWarningA =
    new EtomoBoolean2(STACK_KEY + ".A.UseErasedStack.Warning");
  private final EtomoBoolean2 useErasedStackWarningB =
    new EtomoBoolean2(STACK_KEY + ".B.UseErasedStack.Warning");
  private final EtomoBoolean2 useFilteredStackWarningA =
    new EtomoBoolean2(STACK_KEY + ".A.UseFilteredStack.Warning");
  private final EtomoBoolean2 useFilteredStackWarningB =
    new EtomoBoolean2(STACK_KEY + ".B.UseFilteredStack.Warning");

  private final StringProperty genSirtsetupSubareaSizeA =
    new StringProperty(GEN_KEY + "." + A_AXIS_KEY + ".SirtsetupSubareaSize");
  private final StringProperty genSirtsetupSubareaSizeB =
    new StringProperty(GEN_KEY + "." + B_AXIS_KEY + ".SirtsetupSubareaSize");
  private final EtomoNumber genSirtsetupyOffsetOfSubareaA =
    new EtomoNumber(GEN_KEY + "." + A_AXIS_KEY + ".SirtsetupyOffsetOfSubarea");
  private final EtomoNumber genSirtsetupyOffsetOfSubareaB =
    new EtomoNumber(GEN_KEY + "." + B_AXIS_KEY + ".SirtsetupyOffsetOfSubarea");

  private EtomoNumber tomogramSizeColumnsA =
    new EtomoNumber(A_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Columns");
  private EtomoNumber tomogramSizeColumnsB =
    new EtomoNumber(B_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Columns");
  private EtomoNumber tomogramSizeRowsA =
    new EtomoNumber(A_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Rows");
  private EtomoNumber tomogramSizeRowsB =
    new EtomoNumber(B_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Rows");
  private EtomoNumber tomogramSizeSectionsA =
    new EtomoNumber(A_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Sections");
  private EtomoNumber tomogramSizeSectionsB =
    new EtomoNumber(B_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Sections");

  private EtomoNumber tomogramSizeColumnsFromBatchruntomoA = new EtomoNumber(
    MetaData.BATCHRUNTOMO_KEY + "." + A_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Columns");
  private EtomoNumber tomogramSizeColumnsFromBatchruntomoB = new EtomoNumber(
    MetaData.BATCHRUNTOMO_KEY + "." + B_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Columns");
  private EtomoNumber tomogramSizeRowsFromBatchruntomoA = new EtomoNumber(
    MetaData.BATCHRUNTOMO_KEY + "." + A_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Rows");
  private EtomoNumber tomogramSizeRowsFromBatchruntomoB = new EtomoNumber(
    MetaData.BATCHRUNTOMO_KEY + "." + B_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Rows");
  private EtomoNumber tomogramSizeSectionsFromBatchruntomoA = new EtomoNumber(
    MetaData.BATCHRUNTOMO_KEY + "." + A_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Sections");
  private EtomoNumber tomogramSizeSectionsFromBatchruntomoB = new EtomoNumber(
    MetaData.BATCHRUNTOMO_KEY + "." + B_AXIS_KEY + "." + TOMOGRAM_SIZE_KEY + ".Sections");
  private EtomoNumber posSampleTypeA = new EtomoNumber("a.positioning.PosSampleType");
  private EtomoNumber posSampleTypeB = new EtomoNumber("b.positioning.PosSampleType");
  private EtomoNumber stackUseLinearInterpolationFromBatchruntomoA = new EtomoNumber(
    EtomoNumber.Type.BOOLEAN, "batchruntomo.Stack.A.UseLinearInterpolation");
  private EtomoNumber stackUseLinearInterpolationFromBatchruntomoB = new EtomoNumber(
    EtomoNumber.Type.BOOLEAN, "batchruntomo.Stack.B.UseLinearInterpolation");
  private EtomoNumber madeZFactorsFromBatchruntomoA =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.MadeZFactorsA");
  private EtomoNumber madeZFactorsFromBatchruntomoB =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.MadeZFactorsB");
  private EtomoNumber usedLocalAlignmentsFromBatchruntomoA =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.UsedLocalAlignmentsA");
  private EtomoNumber usedLocalAlignmentsFromBatchruntomoB =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.UsedLocalAlignmentsB");
  private EtomoNumber axisZShiftFromBatchruntomoA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "batchruntomo.a.align.AxisZShift");
  private EtomoNumber axisZShiftFromBatchruntomoB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "batchruntomo.b.align.AxisZShift");
  private EtomoNumber angleOffsetFromBatchruntomoA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "batchruntomo.a.align.AngleOffset");
  private EtomoNumber angleOffsetFromBatchruntomoB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "batchruntomo.b.align.AngleOffset");
  private EtomoNumber sampleAngleOffsetFromBatchruntomoA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "batchruntomo.a.sample.AngleOffset");
  private EtomoNumber sampleAngleOffsetFromBatchruntomoB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "batchruntomo.b.sample.AngleOffset");
  private EtomoNumber sampleAxisZShiftFromBatchruntomoA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "batchruntomo.a.sample.AxisZShift");
  private EtomoNumber sampleAxisZShiftFromBatchruntomoB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "batchruntomo.b.sample.AxisZShift");
  private EtomoNumber sampleXAxisTiltFromBatchruntomoA =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "batchruntomo.a.sample.XAXISTILT");
  private EtomoNumber sampleXAxisTiltFromBatchruntomoB =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "batchruntomo.b.sample.XAXISTILT");
  private EtomoNumber seedingDoneFromBatchruntomoA =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.a.SeedingDone");
  private EtomoNumber seedingDoneFromBatchruntomoB =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.b.SeedingDone");
  private EtomoNumber trackLightBeadsFromBatchruntomoA =
    new EtomoNumber("batchruntomo.Track.A.LightBeads");
  private EtomoNumber trackLightBeadsFromBatchruntomoB =
    new EtomoNumber("batchruntomo.Track.B.LightBeads");
  private EtomoNumber xcorrBlendmontWasRunFromBatchruntomoA =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.xcorr.blendmont.a.WasRun");
  private EtomoNumber xcorrBlendmontWasRunFromBatchruntomoB =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.xcorr.blendmont.b.WasRun");
  private EtomoNumber invalidEdgeFunctionsFromBatchruntomoA =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.InvalidEdgeFunctionsA");
  private EtomoNumber invalidEdgeFunctionsFromBatchruntomoB =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.InvalidEdgeFunctionsB");
  private StringProperty stackUserSizeToOutputInXandYFromBatchruntomoA =
    new StringProperty("batchruntomo.Stack.A.SizeToOutputInXandY");
  private StringProperty stackUserSizeToOutputInXandYFromBatchruntomoB =
    new StringProperty("batchruntomo.Stack.B.SizeToOutputInXandY");
  private EtomoNumber trimvolFlippedFromBatchruntomo =
    new EtomoNumber(EtomoNumber.Type.BOOLEAN, "batchruntomo.TrimvolFlipped");
  private EtomoNumber postProcTrimVolInputNRowsFromBatchruntomo =
    new EtomoNumber("batchruntomo.TrimVol.Input.NRows");
  private final EtomoNumber postProcTrimVolInputNColumnsFromBatchruntomo =
    new EtomoNumber("batchruntomo.TrimVol.Input.NColumns");
  private final EtomoNumber postProcTrimVolInputNSectionsFromBatchruntomo =
    new EtomoNumber("batchruntomo.TrimVol.Input.NSections");
  private EtomoNumber posSampleTypeFromBatchruntomoA =
    new EtomoNumber("batchruntomo.a.positioning.PosSampleType");
  private EtomoNumber posSampleTypeFromBatchruntomoB =
    new EtomoNumber("batchruntomo.b.positioning.PosSampleType");

  private boolean newBatchruntomoCombineSettings = false;
  ...
  public void resetBatchruntomoCombineSettings() {
    newBatchruntomoCombineSettings = true;
  }

  public boolean isNewBatchruntomoCombineSettings() {
    return newBatchruntomoCombineSettings;
  }

  public void moveBatchruntomoSettings() {
    if (!imageRotationForAliStackFromBatchruntomo.isNull()) {
      setStackImageRotation(AxisID.FIRST, imageRotationForAliStackFromBatchruntomo);
      setStackImageRotation(AxisID.SECOND, imageRotationForAliStackFromBatchruntomo);
      imageRotationForAliStackFromBatchruntomo.reset();
    }
    if (!tomogramSizeColumnsFromBatchruntomoA.isNull()) {
      newBatchruntomoCombineSettings = true;
      tomogramSizeColumnsA.set(tomogramSizeColumnsFromBatchruntomoA);
      tomogramSizeColumnsFromBatchruntomoA.reset();
    }
    if (!tomogramSizeColumnsFromBatchruntomoB.isNull()) {
      newBatchruntomoCombineSettings = true;
      tomogramSizeColumnsB.set(tomogramSizeColumnsFromBatchruntomoB);
      tomogramSizeColumnsFromBatchruntomoB.reset();
    }
    if (!tomogramSizeRowsFromBatchruntomoA.isNull()) {
      newBatchruntomoCombineSettings = true;
      tomogramSizeRowsA.set(tomogramSizeRowsFromBatchruntomoA);
      tomogramSizeRowsFromBatchruntomoA.reset();
    }
    if (!tomogramSizeRowsFromBatchruntomoB.isNull()) {
      newBatchruntomoCombineSettings = true;
      tomogramSizeRowsB.set(tomogramSizeRowsFromBatchruntomoB);
      tomogramSizeRowsFromBatchruntomoB.reset();
    }
    if (!tomogramSizeSectionsFromBatchruntomoA.isNull()) {
      newBatchruntomoCombineSettings = true;
      tomogramSizeSectionsA.set(tomogramSizeSectionsFromBatchruntomoA);
      tomogramSizeSectionsFromBatchruntomoA.reset();
    }
    if (!tomogramSizeSectionsFromBatchruntomoB.isNull()) {
      newBatchruntomoCombineSettings = true;
      tomogramSizeSectionsB.set(tomogramSizeSectionsFromBatchruntomoB);
      tomogramSizeSectionsFromBatchruntomoB.reset();
    }
    if (!stackUseLinearInterpolationFromBatchruntomoA.isNull()) {
      stackUseLinearInterpolationA.set(stackUseLinearInterpolationFromBatchruntomoA);
      stackUseLinearInterpolationFromBatchruntomoA.reset();
    }
    if (!stackUseLinearInterpolationFromBatchruntomoB.isNull()) {
      stackUseLinearInterpolationB.set(stackUseLinearInterpolationFromBatchruntomoB);
      stackUseLinearInterpolationFromBatchruntomoB.reset();
    }
    if (!madeZFactorsFromBatchruntomoA.isNull()) {
      madeZFactorsA.set(madeZFactorsFromBatchruntomoA);
      madeZFactorsFromBatchruntomoA.reset();
    }
    if (!madeZFactorsFromBatchruntomoB.isNull()) {
      madeZFactorsB.set(madeZFactorsFromBatchruntomoB);
      madeZFactorsFromBatchruntomoB.reset();
    }
    if (!usedLocalAlignmentsFromBatchruntomoA.isNull()) {
      usedLocalAlignmentsA.set(usedLocalAlignmentsFromBatchruntomoA);
      usedLocalAlignmentsFromBatchruntomoA.reset();
    }
    if (!usedLocalAlignmentsFromBatchruntomoB.isNull()) {
      usedLocalAlignmentsB.set(usedLocalAlignmentsFromBatchruntomoB);
      usedLocalAlignmentsFromBatchruntomoB.reset();
    }
    if (!axisZShiftFromBatchruntomoA.isNull()) {
      axisZShiftA.set(axisZShiftFromBatchruntomoA);
      axisZShiftFromBatchruntomoA.reset();
    }
    if (!axisZShiftFromBatchruntomoB.isNull()) {
      axisZShiftB.set(axisZShiftFromBatchruntomoB);
      axisZShiftFromBatchruntomoB.reset();
    }
    if (!angleOffsetFromBatchruntomoA.isNull()) {
      angleOffsetA.set(angleOffsetFromBatchruntomoA);
      angleOffsetFromBatchruntomoA.reset();
    }
    if (!angleOffsetFromBatchruntomoB.isNull()) {
      angleOffsetB.set(angleOffsetFromBatchruntomoB);
      angleOffsetFromBatchruntomoB.reset();
    }
    if (!sampleAngleOffsetFromBatchruntomoA.isNull()) {
      sampleAngleOffsetA.set(sampleAngleOffsetFromBatchruntomoA);
      sampleAngleOffsetFromBatchruntomoA.reset();
    }
    if (!sampleAngleOffsetFromBatchruntomoB.isNull()) {
      sampleAngleOffsetB.set(sampleAngleOffsetFromBatchruntomoB);
      sampleAngleOffsetFromBatchruntomoB.reset();
    }
    if (!sampleAxisZShiftFromBatchruntomoA.isNull()) {
      sampleAxisZShiftA.set(sampleAxisZShiftFromBatchruntomoA);
      sampleAxisZShiftFromBatchruntomoA.reset();
    }
    if (!sampleAxisZShiftFromBatchruntomoB.isNull()) {
      sampleAxisZShiftB.set(sampleAxisZShiftFromBatchruntomoB);
      sampleAxisZShiftFromBatchruntomoB.reset();
    }
    if (!sampleXAxisTiltFromBatchruntomoA.isNull()) {
      sampleXAxisTiltA.set(sampleXAxisTiltFromBatchruntomoA);
      sampleXAxisTiltFromBatchruntomoA.reset();
    }
    if (!sampleXAxisTiltFromBatchruntomoB.isNull()) {
      sampleXAxisTiltB.set(sampleXAxisTiltFromBatchruntomoB);
      sampleXAxisTiltFromBatchruntomoB.reset();
    }
    if (!seedingDoneFromBatchruntomoA.isNull()) {
      seedingDoneA.set(seedingDoneFromBatchruntomoA);
      seedingDoneFromBatchruntomoA.reset();
    }
    if (!seedingDoneFromBatchruntomoB.isNull()) {
      seedingDoneB.set(seedingDoneFromBatchruntomoB);
      seedingDoneFromBatchruntomoB.reset();
    }
    if (!trackLightBeadsFromBatchruntomoA.isNull()) {
      trackLightBeadsA.set(trackLightBeadsFromBatchruntomoA);
      trackLightBeadsFromBatchruntomoA.reset();
    }
    if (!trackLightBeadsFromBatchruntomoB.isNull()) {
      trackLightBeadsB.set(trackLightBeadsFromBatchruntomoB);
      trackLightBeadsFromBatchruntomoB.reset();
    }
    if (!xcorrBlendmontWasRunFromBatchruntomoA.isNull()) {
      xcorrBlendmontWasRunA.set(xcorrBlendmontWasRunFromBatchruntomoA);
      xcorrBlendmontWasRunFromBatchruntomoA.reset();
    }
    if (!xcorrBlendmontWasRunFromBatchruntomoB.isNull()) {
      xcorrBlendmontWasRunB.set(xcorrBlendmontWasRunFromBatchruntomoB);
      xcorrBlendmontWasRunFromBatchruntomoB.reset();
    }
    if (!invalidEdgeFunctionsFromBatchruntomoA.isNull()) {
      invalidEdgeFunctionsA.set(invalidEdgeFunctionsFromBatchruntomoA);
      invalidEdgeFunctionsFromBatchruntomoA.reset();
    }
    if (!invalidEdgeFunctionsFromBatchruntomoB.isNull()) {
      invalidEdgeFunctionsB.set(invalidEdgeFunctionsFromBatchruntomoB);
      invalidEdgeFunctionsFromBatchruntomoB.reset();
    }
    if (!stackUserSizeToOutputInXandYFromBatchruntomoA.isEmpty()) {
      stackUserSizeToOutputInXandYA.set(stackUserSizeToOutputInXandYFromBatchruntomoA);
      stackUserSizeToOutputInXandYFromBatchruntomoA.reset();
    }
    if (!stackUserSizeToOutputInXandYFromBatchruntomoB.isEmpty()) {
      stackUserSizeToOutputInXandYB.set(stackUserSizeToOutputInXandYFromBatchruntomoB);
      stackUserSizeToOutputInXandYFromBatchruntomoB.reset();
    }
    if (!trimvolFlippedFromBatchruntomo.isNull()) {
      trimvolFlipped.set(trimvolFlippedFromBatchruntomo);
      trimvolFlippedFromBatchruntomo.reset();
    }
    if (!postProcTrimVolInputNRowsFromBatchruntomo.isNull()) {
      postProcTrimVolInputNRows.set(postProcTrimVolInputNRowsFromBatchruntomo);
      postProcTrimVolInputNRowsFromBatchruntomo.reset();
    }
    if (!postProcTrimVolInputNColumnsFromBatchruntomo.isNull()) {
      postProcTrimVolInputNColumns.set(postProcTrimVolInputNColumnsFromBatchruntomo);
      postProcTrimVolInputNColumnsFromBatchruntomo.reset();
    }
    if (!postProcTrimVolInputNSectionsFromBatchruntomo.isNull()) {
      postProcTrimVolInputNSections.set(postProcTrimVolInputNSectionsFromBatchruntomo);
      postProcTrimVolInputNSectionsFromBatchruntomo.reset();
    }
    if (!posSampleTypeFromBatchruntomoA.isNull()) {
      posSampleTypeA.set(posSampleTypeFromBatchruntomoA);
      posSampleTypeFromBatchruntomoA.reset();
    }
    if (!posSampleTypeFromBatchruntomoB.isNull()) {
      posSampleTypeB.set(posSampleTypeFromBatchruntomoB);
      posSampleTypeFromBatchruntomoB.reset();
    }
  }
  ...
  public void store(Properties props, String prepend) {
    ...
    posSampleTypeA.store(props, prepend);
    posSampleTypeB.store(props, prepend);
    ...
    EtomoBoolean2.store(sampleFiducialessA, props, prepend,
      firstAxisGroup + SAMPLE_FIDUCIALESS_KEY);
    if (secondAxisGroup != null) {
      EtomoBoolean2.store(sampleFiducialessB, props, prepend,
        secondAxisGroup + SAMPLE_FIDUCIALESS_KEY);
    }
    // batchruntomo settings
    imageRotationForAliStackFromBatchruntomo.store(props);
    tomogramSizeColumnsFromBatchruntomoA.store(props);
    tomogramSizeColumnsFromBatchruntomoB.store(props);
    tomogramSizeRowsFromBatchruntomoA.store(props);
    tomogramSizeRowsFromBatchruntomoB.store(props);
    tomogramSizeSectionsFromBatchruntomoA.store(props);
    tomogramSizeSectionsFromBatchruntomoB.store(props);
    stackUseLinearInterpolationFromBatchruntomoA.store(props);
    stackUseLinearInterpolationFromBatchruntomoB.store(props);
    madeZFactorsFromBatchruntomoA.store(props);
    madeZFactorsFromBatchruntomoB.store(props);
    usedLocalAlignmentsFromBatchruntomoA.store(props);
    usedLocalAlignmentsFromBatchruntomoB.store(props);
    axisZShiftFromBatchruntomoA.store(props);
    axisZShiftFromBatchruntomoB.store(props);
    angleOffsetFromBatchruntomoA.store(props);
    angleOffsetFromBatchruntomoB.store(props);
    sampleAngleOffsetFromBatchruntomoA.store(props);
    sampleAngleOffsetFromBatchruntomoB.store(props);
    sampleAxisZShiftFromBatchruntomoA.store(props);
    sampleAxisZShiftFromBatchruntomoB.store(props);
    sampleXAxisTiltFromBatchruntomoA.store(props);
    sampleXAxisTiltFromBatchruntomoB.store(props);
    seedingDoneFromBatchruntomoA.store(props);
    seedingDoneFromBatchruntomoB.store(props);
    trackLightBeadsFromBatchruntomoA.store(props);
    trackLightBeadsFromBatchruntomoB.store(props);
    xcorrBlendmontWasRunFromBatchruntomoA.store(props);
    xcorrBlendmontWasRunFromBatchruntomoB.store(props);
    invalidEdgeFunctionsFromBatchruntomoA.store(props);
    invalidEdgeFunctionsFromBatchruntomoB.store(props);
    stackUserSizeToOutputInXandYFromBatchruntomoA.store(props);
    stackUserSizeToOutputInXandYFromBatchruntomoB.store(props);
    trimvolFlippedFromBatchruntomo.store(props);
    postProcTrimVolInputNRowsFromBatchruntomo.store(props);
    postProcTrimVolInputNColumnsFromBatchruntomo.store(props);
    postProcTrimVolInputNSectionsFromBatchruntomo.store(props);
    posSampleTypeFromBatchruntomoA.store(props);
    posSampleTypeFromBatchruntomoB.store(props);
  }
  ...
  public void load(Properties props, String prepend) {
    ...
    posSampleTypeA.reset();
    posSampleTypeB.reset();
    // batchruntomo settings
    imageRotationForAliStackFromBatchruntomo.reset();
    tomogramSizeColumnsFromBatchruntomoA.reset();
    tomogramSizeColumnsFromBatchruntomoB.reset();
    ...
    posSampleTypeA.load(props, prepend);
    posSampleTypeB.load(props, prepend);
    combineMatchMode =
      MatchMode.getInstance(props.getProperty(prepend + "." + COMBINE_MATCH_MODE_KEY));
    // backwards compatibility
    if (combineMatchMode == null) {
      String backCombineMatchMode = props.getProperty(COMBINE_MATCH_MODE_BACK_KEY);
      if (backCombineMatchMode != null) {
        combineMatchMode =
          MatchMode.getInstance(Boolean.valueOf(backCombineMatchMode).booleanValue());
      }
    }
    combineScriptsCreated.load(props, prepend);
    if (combineScriptsCreated.isNull()) {
      // backwards compatibility
      String backCombineScriptsCreated =
        props.getProperty(COMBINE_SCRIPTS_CREATED_BACK_KEY);
    ...
    // batchruntomo settings
    imageRotationForAliStackFromBatchruntomo.load(props);
    tomogramSizeColumnsFromBatchruntomoA.load(props);
    tomogramSizeColumnsFromBatchruntomoB.load(props);
    tomogramSizeRowsFromBatchruntomoA.load(props);
    tomogramSizeRowsFromBatchruntomoB.load(props);
    tomogramSizeSectionsFromBatchruntomoA.load(props);
    tomogramSizeSectionsFromBatchruntomoB.load(props);
    stackUseLinearInterpolationFromBatchruntomoA.load(props);
    stackUseLinearInterpolationFromBatchruntomoB.load(props);
    madeZFactorsFromBatchruntomoA.load(props);
    madeZFactorsFromBatchruntomoB.load(props);
    usedLocalAlignmentsFromBatchruntomoA.load(props);
    usedLocalAlignmentsFromBatchruntomoB.load(props);
    axisZShiftFromBatchruntomoA.load(props);
    axisZShiftFromBatchruntomoB.load(props);
    angleOffsetFromBatchruntomoA.load(props);
    angleOffsetFromBatchruntomoB.load(props);
    sampleAngleOffsetFromBatchruntomoA.load(props);
    sampleAngleOffsetFromBatchruntomoB.load(props);
    sampleAxisZShiftFromBatchruntomoA.load(props);
    sampleAxisZShiftFromBatchruntomoB.load(props);
    sampleXAxisTiltFromBatchruntomoA.load(props);
    sampleXAxisTiltFromBatchruntomoB.load(props);
    seedingDoneFromBatchruntomoA.load(props);
    seedingDoneFromBatchruntomoB.load(props);
    trackLightBeadsFromBatchruntomoA.load(props);
    trackLightBeadsFromBatchruntomoB.load(props);
    xcorrBlendmontWasRunFromBatchruntomoA.load(props);
    xcorrBlendmontWasRunFromBatchruntomoB.load(props);
    invalidEdgeFunctionsFromBatchruntomoA.load(props);
    invalidEdgeFunctionsFromBatchruntomoB.load(props);
    stackUserSizeToOutputInXandYFromBatchruntomoA.load(props);
    stackUserSizeToOutputInXandYFromBatchruntomoB.load(props);
    trimvolFlippedFromBatchruntomo.load(props);
    postProcTrimVolInputNRowsFromBatchruntomo.load(props);
    postProcTrimVolInputNColumnsFromBatchruntomo.load(props);
    postProcTrimVolInputNSectionsFromBatchruntomo.load(props);
    posSampleTypeFromBatchruntomoA.load(props);
    posSampleTypeFromBatchruntomoB.load(props);
  }
  ...
  public void setPosSampleType(final AxisID axisID, final PosSampleType input) {
    if (axisID == AxisID.SECOND) {
      if (input == null) {
        posSampleTypeB.reset();
      }
      else {
        posSampleTypeB.set(input.getValue());
      }
    }
    else if (input == null) {
      posSampleTypeA.reset();
      ...
      posSampleTypeA.set(input.getValue());
    }
  }

  public int getPosSampleType(final AxisID axisID) {
    if (axisID == AxisID.SECOND) {
      return posSampleTypeB.getInt();
    }
    return posSampleTypeA.getInt();
  }
  ...
  public boolean getBackwardCompatibleTrimvolFlipped() {
    ...
    File trimvolFile = new File(manager.getPropertyUserDir(),
      TrimvolParam.getOutputFileName(manager, AxisID.ONLY));
  ...
  public boolean getBackwardCompatibleUsedLocalAlignments(AxisID axisID) {
    ...
    String datasetName = manager.getName();
    File localXfFile =
      new File(userDir, datasetName + axisID.getExtension() + "local.xf");
    File transformFile =
      new File(userDir, datasetName + axisID.getExtension() + ".tltxf");
  ...
  public boolean getBackwardCompatibleMadeZFactors(AxisID axisID) {
    ...
    String datasetName = manager.getName();
    File zFactorFile =
      new File(userDir, TiltalignParam.getOutputZFactorFileName(datasetName, axisID));
