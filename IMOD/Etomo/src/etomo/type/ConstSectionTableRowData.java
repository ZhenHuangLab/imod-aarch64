...
public abstract class ConstSectionTableRowData implements Storable {
  public static final String rcsid = "$Id$";
   ...
   static final String VERSION_KEY = "SectionTableRowData.Version";
   static final String groupString = "SectionTableRow";
  static final String setupSectionString = "Section";
  // For conversion from version 1.0
   static final String setupXMaxString = "XMax";
   static final String setupYMaxString = "YMax";
   static final String setupZMaxString = "ZMax";
   static final double COS_X_Y_THRESHOLD = 0.5;

   final EtomoNumber rowNumber;// key in the .ejf file, not displayed
   final EtomoNumber sampleBottomStart;
   final EtomoNumber sampleBottomEnd;
   final EtomoNumber sampleTopStart;
   final EtomoNumber sampleTopEnd;
   final EtomoNumber setupFinalStart;
  final EtomoNumber setupFinalEnd;
   final EtomoNumber joinFinalStart;
   final EtomoNumber joinFinalEnd;
   final EtomoNumber rotationAngleX;
   final EtomoNumber rotationAngleY;
   final EtomoNumber rotationAngleZ;

   File setupSection = null;
   File joinSection = null;
   int setupXMax = EtomoNumber.INTEGER_NULL_VALUE;
   int joinXMax = EtomoNumber.INTEGER_NULL_VALUE;
   int setupYMax = EtomoNumber.INTEGER_NULL_VALUE;
   int joinYMax = EtomoNumber.INTEGER_NULL_VALUE;
   int setupZMax = EtomoNumber.INTEGER_NULL_VALUE;
   int joinZMax = EtomoNumber.INTEGER_NULL_VALUE;
  ...
  private boolean sectionExpanded = false;
   ...
   final EtomoBoolean2 inverted = new EtomoBoolean2("Inverted");
   ...
   * @param rowNumber
   */
   ConstSectionTableRowData(int rowNumber) {
    // construct
   ...
   */
   ConstSectionTableRowData(ConstSectionTableRowData constSectionTableRowData) {
    // deep copy
