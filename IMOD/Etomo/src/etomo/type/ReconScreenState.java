 ...
 * <p>Description: </p>
 * 
 * <p>Copyright: Copyright 2005 - 2016 by the Regents of the University of Colorado</p>
 * 
...
public class ReconScreenState extends BaseScreenState {
   ...
   * @deprecated
   */
  public static final String TOMO_GEN_NEWST_HEADER_GROUP =
    DialogType.TOMOGRAM_GENERATION.getStorableName() + ".Newst" + HEADER_GROUP;
  /**
   * @deprecated
   */
  public static final String TOMO_GEN_MTFFILTER_HEADER_GROUP =
    DialogType.TOMOGRAM_GENERATION.getStorableName() + ".Mtffilter" + HEADER_GROUP;
  public static final String STACK_NEWST_HEADER_GROUP =
    DialogType.FINAL_ALIGNED_STACK.getStorableName() + ".Newst" + HEADER_GROUP;
  public static final String STACK_MTFFILTER_HEADER_GROUP =
    DialogType.FINAL_ALIGNED_STACK.getStorableName() + ".Mtffilter" + HEADER_GROUP;
  public static final String STACK_CTF_CORRECTION_HEADER_GROUP =
    DialogType.FINAL_ALIGNED_STACK.getStorableName() + ".CtfCorrection" + HEADER_GROUP;
  public static final String TOMO_GEN_TILT_HEADER_GROUP =
    DialogType.TOMOGRAM_GENERATION.getStorableName() + ".Tilt" + HEADER_GROUP;
  public static final String TOMO_GEN_TRIAL_TILT_HEADER_GROUP =
    DialogType.TOMOGRAM_GENERATION.getStorableName() + ".TrialTilt" + HEADER_GROUP;

  private static final String SETUP_GROUP =
    DialogType.TOMOGRAM_COMBINATION.getStorableName() + ".Setup.";
  ...
  private static final String PATCHCORR_KERNEL_SIGMA_KEY =
    DialogType.TOMOGRAM_COMBINATION.getStorableName() + '.' + ProcessName.PATCHCORR + '.'
      + Patchcrawl3DParam.KERNEL_SIGMA_KEY;

  public static final String COMBINE_SETUP_TO_SELECTOR_HEADER_GROUP =
    SETUP_GROUP + "ToSelector." + HEADER_GROUP;
  public static final String COMBINE_SETUP_SOLVEMATCH_HEADER_GROUP =
    SETUP_GROUP + SOLVEMATCH_GROUP + HEADER_GROUP;
  public static final String COMBINE_SETUP_PATCHCORR_HEADER_GROUP =
    SETUP_GROUP + PATCHCORR_GROUP + HEADER_GROUP;
  public static final String COMBINE_SETUP_VOLCOMBINE_HEADER_GROUP =
    SETUP_GROUP + VOLCOMBINE_GROUP + HEADER_GROUP;
  public static final String COMBINE_SETUP_TEMP_DIR_HEADER_GROUP =
    SETUP_GROUP + "TempDir" + HEADER_GROUP;

  public static final String COMBINE_INITIAL_SOLVEMATCH_HEADER_GROUP =
    DialogType.TOMOGRAM_COMBINATION.getStorableName() + ".Initial." + SOLVEMATCH_GROUP
      + HEADER_GROUP;

  private static final String FINAL_GROUP =
    DialogType.TOMOGRAM_COMBINATION.getStorableName() + ".Final.";

  public static final String COMBINE_FINAL_PATCH_REGION_HEADER_GROUP =
    FINAL_GROUP + "PatchRegion" + HEADER_GROUP;
  public static final String COMBINE_FINAL_PATCHCORR_HEADER_GROUP =
    FINAL_GROUP + PATCHCORR_GROUP + HEADER_GROUP;
  public static final String COMBINE_FINAL_MATCHORWARP_HEADER_GROUP =
    FINAL_GROUP + "Matchorwarp" + HEADER_GROUP;
  public static final String COMBINE_FINAL_VOLCOMBINE_HEADER_GROUP =
    FINAL_GROUP + VOLCOMBINE_GROUP + HEADER_GROUP;
   ...
   * @deprecated
   */
  private final PanelHeaderState tomoGenMtffilterHeaderState =
    new PanelHeaderState(TOMO_GEN_MTFFILTER_HEADER_GROUP);
  /**
   * @deprecated
   */
  private final PanelHeaderState tomoGenNewstHeaderState =
    new PanelHeaderState(TOMO_GEN_NEWST_HEADER_GROUP);
  private final PanelHeaderState stackNewstHeaderState =
    new PanelHeaderState(STACK_NEWST_HEADER_GROUP);
  private final PanelHeaderState stackMtffilterHeaderState =
    new PanelHeaderState(STACK_MTFFILTER_HEADER_GROUP);
  private final PanelHeaderState stackCtfCorrectionHeaderState =
    new PanelHeaderState(STACK_CTF_CORRECTION_HEADER_GROUP);
  private final PanelHeaderState tomoGenTiltHeaderState =
    new PanelHeaderState(TOMO_GEN_TILT_HEADER_GROUP);
  private final PanelHeaderState tomoGenTrialTiltHeaderState =
    new PanelHeaderState(TOMO_GEN_TRIAL_TILT_HEADER_GROUP);
  ...
  private final PanelHeaderState combineSetupToSelectorHeaderState =
    new PanelHeaderState(COMBINE_SETUP_TO_SELECTOR_HEADER_GROUP);
  private final PanelHeaderState combineSetupSolvematchHeaderState =
    new PanelHeaderState(COMBINE_SETUP_SOLVEMATCH_HEADER_GROUP);
  private final PanelHeaderState combineSetupPatchcorrHeaderState =
    new PanelHeaderState(COMBINE_SETUP_PATCHCORR_HEADER_GROUP);
  private final PanelHeaderState combineSetupVolcombineHeaderState =
    new PanelHeaderState(COMBINE_SETUP_VOLCOMBINE_HEADER_GROUP);
  private final PanelHeaderState combineSetupTempDirHeaderState =
    new PanelHeaderState(COMBINE_SETUP_TEMP_DIR_HEADER_GROUP);

  private final PanelHeaderState combineInitialSolvematchHeaderState =
    new PanelHeaderState(COMBINE_INITIAL_SOLVEMATCH_HEADER_GROUP);

  private final PanelHeaderState combineFinalPatchRegionHeaderState =
    new PanelHeaderState(COMBINE_FINAL_PATCH_REGION_HEADER_GROUP);
  private final PanelHeaderState combineFinalPatchcorrHeaderState =
    new PanelHeaderState(COMBINE_FINAL_PATCHCORR_HEADER_GROUP);
  private final PanelHeaderState combineFinalMatchorwarpHeaderState =
    new PanelHeaderState(COMBINE_FINAL_MATCHORWARP_HEADER_GROUP);
  private final PanelHeaderState combineFinalVolcombineHeaderState =
    new PanelHeaderState(COMBINE_FINAL_VOLCOMBINE_HEADER_GROUP);
  private EtomoNumber patchcorrKernelSigma = null;
  private final EtomoVersion version = EtomoVersion.getDefaultInstance("1.1");

  private final PanelHeaderState stackEraseGoldNewstHeaderState =
    new PanelHeaderState(STACK_KEY + "." + ERASE_GOLD_KEY + "."
      + NEWSTACK_OR_BLENDMONT_KEY + "." + NEWST_KEY + "." + HEADER_KEY);

  private final PanelHeaderState stackFindBeads3dHeaderState =
    new PanelHeaderState(STACK_KEY + ".FindBeads3d" + HEADER_KEY);
  private final PanelHeaderState stackAlignAndTiltHeaderState =
    new PanelHeaderState(STACK_KEY + ".AlignAndTilt" + HEADER_KEY);
  ...
  public void setPatchcorrKernelSigma(String patchcorrKernelSigma) {
    if (this.patchcorrKernelSigma == null) {
      this.patchcorrKernelSigma =
        new EtomoNumber(EtomoNumber.Type.DOUBLE, PATCHCORR_KERNEL_SIGMA_KEY);
    }
