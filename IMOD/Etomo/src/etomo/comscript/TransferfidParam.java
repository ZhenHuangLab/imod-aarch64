...
public final class TransferfidParam implements Storable {
   static final String group = "Transferfid";
  ...
  // null => both, -1 => -90, 1=> +90
  private final EtomoNumber searchDirection =
    new EtomoNumber(EtomoNumber.Type.INTEGER, "SearchDirection");
  ...
  private final ScriptParameter numberViews =
    new ScriptParameter(EtomoNumber.Type.INTEGER, "NumberViews");
  ...
  public void setMirrorXaxis(ConstEtomoNumber input) {
    mirrorXaxis.set(input);
  }

  public MirrorInX getMirrorXaxis() {
    return MirrorInX.getInstance(mirrorXaxis);
  }
  ...
  private void setCenterViewResetValue(EtomoNumber centerView,
    ...
    centerView.setDisplayValue(
      Math.round(1 - tiltAngleSpec.getRangeMin() / tiltAngleSpec.getRangeStep()));
  }
