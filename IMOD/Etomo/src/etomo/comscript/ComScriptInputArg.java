...
class ComScriptInputArg {
   ...
   * Copy constructor
   */
  ComScriptInputArg(ComScriptInputArg src) {
   ...
   */
  void setArgument(String argument, boolean parseComments) {
    if (debug) {
   ...
   */
  void setArgument(FortranInputString arg) {
  ...
  boolean setDebug(boolean input) {
   ...
   */
  void addComments(String[] append) {
