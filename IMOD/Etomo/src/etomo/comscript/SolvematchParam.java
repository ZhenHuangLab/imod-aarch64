...
public class SolvematchParam extends ConstSolvematchParam implements CommandParam {
  ...
  public void parseComScriptCommand(ComScriptCommand scriptCommand)
    ...
    toFiducialFile =
      ParamUtilities.setParamIfPresent(scriptCommand, TO_FIDUCIAL_FILE, toFiducialFile);
    fromFiducialFile = ParamUtilities.setParamIfPresent(scriptCommand, FROM_FIDUCIAL_FILE,
      fromFiducialFile);
    ...
    maximumResidual =
      ParamUtilities.setParamIfPresent(scriptCommand, MAXIMUM_RESIDUAL, maximumResidual);
    centerShiftLimit.parse(scriptCommand);
    toMatchingModel =
      ParamUtilities.setParamIfPresent(scriptCommand, TO_MATCHING_MODEL, toMatchingModel);
    ...
    // set matchBToA
    // fiducial model parameters can be added regardless of the transfer coordinate file
    // mode,
    ...
    if (aFiducialModel == null) {
      ...
      matchBToA =
        !ParamUtilities.setParamIfPresent(scriptCommand, MATCHING_A_TO_B, !matchBToA);
    }
  }
   ...
   */
  void setMatchBToA(String aFiducialFilename) {
