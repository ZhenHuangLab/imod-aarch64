...
public class FortranInputString {
  ...
  public FortranInputString(int nParams) {
   ...
   FortranInputString(String key, int nParams) {
    this.key = key;
    initialize(nParams);
  }
   ...
   * Copy constructor
   */
   FortranInputString(FortranInputString src) {
    nParams = src.nParams;
   ...
   FortranInputString(double[] values) {
    if (values == null) {
      initialize(0);
      return;
    }
  ...
  public static FortranInputString getInstance(Properties props, String group)
   ...
   static FortranInputString getInstance(String list)
      throws FortranInputSyntaxException {
  ...
  public int size() {
   ...
   void updateScriptParameter(ComScriptCommand scriptCommand) {
  ...
  void resetDivider() {
   ...
   void validateAndSet(ComScriptCommand scriptCommand)
  ...
  public void set(int index, ConstEtomoNumber newValue) {
   ...
   void set(int index, FortranInputString newValue) {
    value[index] = new Double(newValue.getDouble(index));
  }

   void set(FortranInputString newValue) {
    for (int i = 0; i < nParams; i++) {
   ...
   */
   void setIntegerType(int index, boolean isInteger) {
