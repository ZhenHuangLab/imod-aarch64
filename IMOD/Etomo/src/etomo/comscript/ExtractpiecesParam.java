...
public class ExtractpiecesParam {
  ...
  private static boolean enableMdocMetadataFile = false;
  ...
  private final void buildCommand() {
    ...
    if (enableMdocMetadataFile) {
      command.add("-MdocMetadataFile");
    }
  ...
  public void setMdocMetadataFileEnabled(boolean cbMdocMetadataFile) {
    enableMdocMetadataFile = cbMdocMetadataFile;
  }
