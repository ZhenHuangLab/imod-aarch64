...
public class StringList {
  ...
  private boolean mConvertToSingleEntry = false;
   ...
   StringList(String key) {
    mElements = new String[0];
    this.mKey = key;
  }

   StringList(int nElements) {
   ...
   */
   void parseString(String newList) {
   ...
   */
   ...
   void parseString(StringList stringList) {
    if (stringList != null) {
   ...
   void parse(ComScriptCommand scriptCommand) throws InvalidParameterException {
   ...
   void updateComScript(ComScriptCommand scriptCommand)
