...
public final class TiltxcorrParam
  implements ConstTiltxcorrParam, CommandParam, ConstCommandParam {
  ...
  private ScriptParameter filterRadius2 =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, FILTER_RADIUS_2_KEY);
  private ScriptParameter filterSigma1 =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, FILTER_SIGMA1_KEY);
  private ScriptParameter filterSigma2 =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, FILTER_SIGMA_2_KEY);
  private final ScriptParameter angleOffset =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, "AngleOffset");
  ...
  private final ScriptParameter iterateCorrelations =
    new ScriptParameter(ITERATE_CORRELATIONS_KEY);
  ...
  private final StringParameter prealignmentTransformFile =
    new StringParameter("PrealignmentTransformFile");
  ...
  private final StringParameter viewsWithMagChanges =
    new StringParameter("ViewsWithMagChanges");
   ...
   */
  public void setPadsInXandY(final String padsInXandY)
    throws FortranInputSyntaxException {
