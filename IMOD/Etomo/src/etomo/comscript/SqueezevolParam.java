...
public final class SqueezevolParam implements ConstSqueezevolParam {
  ...
  private final EtomoNumber reductionFactorX =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "ReductionFactorX");
  private final EtomoNumber reductionFactorY =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "ReductionFactorY");
  private final EtomoNumber reductionFactorZ =
    new EtomoNumber(EtomoNumber.Type.DOUBLE, "ReductionFactorZ");
  ...
  public void load(final Properties props, String prepend) {
    ...
    linearInterpolation =
      Boolean.valueOf(props.getProperty(group + LINEAR_INTERPOLATION_STRING,
  ...
  private String getInputFileName(final String datasetName) {
    return TrimvolParam.getOutputFileName(manager, AxisID.ONLY);
  }
