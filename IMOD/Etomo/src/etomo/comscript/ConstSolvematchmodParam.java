...
public class ConstSolvematchmodParam {
  public static final String rcsid = "$Id$";
   ...
   String toFiducialCoordinatesFile;
   String fromFiducialCoordinatesFile;
   StringList fiducialMatchListA = new StringList(0);
   StringList fiducialMatchListB = new StringList(0);
   FortranInputString xAxistTilt = new FortranInputString(2);
   double residualThreshold;
   int nSurfaces;
   String toReconstructionFile;
   String toMatchingModel;
   String fromReconstructionFile;
   String fromMatchingModel;
   String outputTransformationFile;
