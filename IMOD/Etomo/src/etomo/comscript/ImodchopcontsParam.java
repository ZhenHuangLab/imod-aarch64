...
public final class ImodchopcontsParam implements CommandParam {
  ...
  private final ScriptParameter lengthOfPieces =
    new ScriptParameter(LENGTH_OF_PIECES_KEY);
  ...
  public static ImodchopcontsParam
    getBackwardCompatableInstance(final TiltxcorrParam tiltxcorrParam) {
