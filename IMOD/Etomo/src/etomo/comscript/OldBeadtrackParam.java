...
* @version $Revision$
*/
class OldBeadtrackParam extends OldConstBeadtrackParam implements CommandParam {
  ...
  void setPieceListFile(String pieceListFile) {
    this.pieceListFile = pieceListFile;
  }

  void setSeedModelFile(String seedModelFile) {
    this.seedModelFile = seedModelFile;
  }

  void setOutputModelFile(String outputModelFile) {
   ...
   * @param viewSkipList
   */
  void setViewSkipList(String viewSkipList) {
   ...
   * @param groupSize
   */
  void setTiltAngleGroupSize(int groupSize) {
   ...
   */
  void setTiltAngleGroups(String newTiltAngleGroups) throws FortranInputSyntaxException {
   ...
   * @param groupSize
   */
  void setMagnificationGroupSize(int groupSize) {
   ...
   * @throws FortranInputSyntaxException
   */
  void setMagnificationGroups(String newMagnificationGroups)
    throws FortranInputSyntaxException {
    magnificationGroups =
   ...
   * @param nMinViews
   */
  void setNMinViews(int nMinViews) {
   ...
   * @throws FortranInputSyntaxException
   */
  void setFiducialParams(String fiducialParams)
   ...
   * @throws FortranInputSyntaxException
   */
  void setTiltAngleMinRange(String tiltAngleMinRange)
    throws FortranInputSyntaxException, InvalidEtomoNumberException {
   ...
   */
  void setMaxFiducialsAvg(int maxFiducialsAvg) {
   ...
   */
  void setMinRescueDistance(int minRescueDistance) {
   ...
   */
  void setResidualDistanceLimit(double residualDistanceLimit) {
   ...
   * @throws FortranInputSyntaxException
   */
  void setSecondPassParams(String secondPassParams)
    throws FortranInputSyntaxException, InvalidEtomoNumberException {
  ...
  private ComScriptInputArg[] updateInputArgs(ComScriptInputArg[] inputArgs) {
    ...
    return (ComScriptInputArg[]) inputArgList
      .toArray(new ComScriptInputArg[inputArgList.size()]);
  }
