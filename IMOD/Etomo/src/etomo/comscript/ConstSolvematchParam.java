...
public class ConstSolvematchParam {
  ...
  boolean matchBToA = true;

  String outputFile = "";
  String toFiducialFile = "";
  String fromFiducialFile = "";
  StringList toCorrespondenceList = new StringList(0);
  StringList fromCorrespondenceList = new StringList(0);
  FortranInputString xAxistTilt = new FortranInputString(2);
  int surfacesOrModel = Integer.MIN_VALUE;
  double maximumResidual = Double.NaN;
  String toMatchingModel = "";
  String fromMatchingModel = "";
  String toTomogramOrSizeXYZ = "";
  String fromTomogramOrSizeXYZ = "";
  FortranInputString scaleFactors = new FortranInputString(2);
  String transferCoordinateFile = null;
  String aFiducialModel = null;
  String bFiducialModel = null;
  StringList usePoints = new StringList(0);
  ScriptParameter centerShiftLimit =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, CENTER_SHIFT_LIMIT_KEY);
