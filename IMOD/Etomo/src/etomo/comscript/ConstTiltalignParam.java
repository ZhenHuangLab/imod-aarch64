...
public class ConstTiltalignParam implements CommandDetails {
  ...
  private static final int[] optionValidValues =
    { FIXED_OPTION, ALL_OPTION, AUTOMAPPED_OPTION };
  private static final int[] tiltOptionValidValues =
    { FIXED_OPTION, TILT_ALL_OPTION, TILT_AUTOMAPPED_OPTION };
  private static final int[] distortionOptionValidValues =
    { FIXED_OPTION, AUTOMAPPED_OPTION };
  private static final int[] localOptionValidValues = { FIXED_OPTION, AUTOMAPPED_OPTION };
  private static final int[] localTiltOptionValidValues =
    { FIXED_OPTION, TILT_AUTOMAPPED_OPTION };
  private static final int[] rotOptionValidValues =
  ...
  final ScriptParameter fixedOrInitialBeamTilt =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, "FixedOrInitialBeamTilt");
  ...
  ScriptParameter kFactorScaling =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, K_FACTOR_SCALING_KEY);
  ...
  public ConstTiltalignParam(final BaseManager manager, final String datasetName,
    ...
    localRotOption.setValidValues(localOptionValidValues)
      .setDisplayValue(AUTOMAPPED_OPTION);
    ...
    localTiltOption.setValidValues(localTiltOptionValidValues)
      .setDisplayValue(TILT_AUTOMAPPED_OPTION);
    ...
    localMagOption.setValidValues(localOptionValidValues)
      .setDisplayValue(AUTOMAPPED_OPTION);
    ...
    xStretchOption.setValidValues(distortionOptionValidValues)
      .setDisplayValue(NONE_OPTION);
    ...
    localXStretchOption.setValidValues(localOptionValidValues)
      .setDisplayValue(AUTOMAPPED_OPTION);
    localXStretchDefaultGrouping =
  ...
  String validate() {
    ...
    if (!rotOption.isValid()) {
      invalidReason
        .append(rotOption.getDescription() + ": " + rotOption.getInvalidReason() + "\n");
    }
    ...
    if (!tiltOption.isValid()) {
      invalidReason.append(
        tiltOption.getDescription() + ": " + tiltOption.getInvalidReason() + "\n");
    }
    ...
    if (!magOption.isValid()) {
      invalidReason
        .append(magOption.getDescription() + ": " + magOption.getInvalidReason() + "\n");
    }
    ...
    if (!skewOption.isValid()) {
      invalidReason.append(
        skewOption.getDescription() + ": " + skewOption.getInvalidReason() + "\n");
    }
