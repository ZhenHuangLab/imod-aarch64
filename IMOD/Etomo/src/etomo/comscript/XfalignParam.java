...
public class XfalignParam implements Command {
  ...
  private void genFilterOptions(ArrayList options) {
    ScriptParameter sigmaLowFrequency =
      autoAlignmentMetaData.getSigmaLowFrequencyParameter();
    ScriptParameter cutoffHighFrequency =
      autoAlignmentMetaData.getCutoffHighFrequencyParameter();
    ScriptParameter sigmaHighFrequency =
      autoAlignmentMetaData.getSigmaHighFrequencyParameter();
    // optional
    if ((autoAlignmentMetaData.isSigmaLowFrequencyEnabled()
      && sigmaLowFrequency.isNotNullAndNotDefault())
      || (autoAlignmentMetaData.isCutoffHighFrequencyEnabled()
        && cutoffHighFrequency.isNotNullAndNotDefault())
      || (autoAlignmentMetaData.isSigmaHighFrequencyEnabled()
