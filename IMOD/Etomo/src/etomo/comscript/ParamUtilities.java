...
public class ParamUtilities {
   ...
   static final int INT_NOT_SET = Integer.MIN_VALUE;
   ...
   */
   ...
   static String[] valueOf(double[] values) {
   ...
   static String valueOf(FortranInputString[] valueArray) {
   ...
   */
   static FortranInputString[] parse(String value, boolean integerType,
   ...
   * @throws FortranInputSyntaxException
   */
   static FortranInputString[] parse(StringList stringList, boolean[] integerType,
      int inputStringSize) throws FortranInputSyntaxException {
   ...
   * @return
   */
   static int get(int value, int defaultValue) {
   ...
   * @throws FortranInputSyntaxException
   */
   static void set(String value, FortranInputString target)
      throws FortranInputSyntaxException {
    if (target == null) {
   ...
   static void set(String value, FortranInputString target, int index) {
    if (target == null) {
      throw new NullPointerException();
    }
    if (value == null) {
   ...
   static FortranInputString[] setParamIfPresent(ComScriptCommand scriptCommand,
   ...
   */
   static boolean setParamIfPresent(ComScriptCommand scriptCommand, String keyword,
   ...
   * @throws InvalidParameterException
   */
   static String setParamIfPresent(ComScriptCommand scriptCommand, String keyword,
   ...
   */
   static int setParamIfPresent(ComScriptCommand scriptCommand, String keyword,
   ...
   * @throws InvalidParameterException NumberFormatException 
   */
   static double setParamIfPresent(ComScriptCommand scriptCommand, String keyword,
   ...
   */
   static void setParamIfPresent(ComScriptCommand scriptCommand, String keyword,
   ...
   * @throws FortranInputSyntaxException, InvalidParameterException
   */
   static StringList setParamIfPresent(ComScriptCommand scriptCommand,
   ...
   * @throws BadComScriptException
   */
   static void updateScriptParameter(ComScriptCommand scriptCommand, String key,
   ...
   * @throws BadComScriptException
   */
   static void updateScriptParameterStrings(ComScriptCommand scriptCommand,
