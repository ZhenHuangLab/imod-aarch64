...
public final class TiltalignParam extends ConstTiltalignParam implements CommandParam {
  private static final int X_TILT_DEFAULT_GROUPING_DEFAULT = 2000;
  ...
  public void parseComScriptCommand(final ComScriptCommand scriptCommand)
    ...
    if (!scriptCommand.isKeywordValuePairs()) {
      ...
      localRotNondefaultGroup = ParamUtilities.setParamIfPresent(scriptCommand,
        LOCAL_ROT_NONDEFAULT_GROUP_KEY, nondefaultGroupSize, nondefaultGroupIntegerType);
      ...
      localTiltNondefaultGroup = ParamUtilities.setParamIfPresent(scriptCommand,
        LOCAL_TILT_NONDEFAULT_GROUP_KEY, nondefaultGroupSize, nondefaultGroupIntegerType);
      ...
      localMagNondefaultGroup = ParamUtilities.setParamIfPresent(scriptCommand,
        LOCAL_MAG_NONDEFAULT_GROUP_KEY, nondefaultGroupSize, nondefaultGroupIntegerType);
      ...
      xStretchNondefaultGroup = ParamUtilities.setParamIfPresent(scriptCommand,
        X_STRETCH_NONDEFAULT_GROUP_KEY, nondefaultGroupSize, nondefaultGroupIntegerType);
      ...
      localSkewNondefaultGroup = ParamUtilities.setParamIfPresent(scriptCommand,
        LOCAL_SKEW_NONDEFAULT_GROUP_KEY, nondefaultGroupSize, nondefaultGroupIntegerType);
      ...
      ParamUtilities.setParamIfPresent(scriptCommand, NUMBER_OF_LOCAL_PATCHES_X_AND_Y_KEY,
      ...
      ParamUtilities.setParamIfPresent(scriptCommand, MIN_FIDS_TOTAL_AND_EACH_SURFACE_KEY,
  ...
  public void setXTiltAutomapSameLargeGroup(final boolean input) {
    if (input) {
      ...
      if (z != null && !z.isNull() && xTiltDefaultGrouping.lt(z)) {
        xTiltDefaultGrouping.set(z);
      }
      else if (xTiltDefaultGrouping.isNull()) {
        xTiltDefaultGrouping.set(X_TILT_DEFAULT_GROUPING_DEFAULT);
      }
    }
    else {
  ...
  public boolean upgradeOldVersion(int correctionBinning, int currentBinning) {
    ...
    if (correctionBinning > 1) {
      buffer.append(
        "Multiplied binned " + axisZShift.getName() + " by " + correctionBinning + ".\n");
    }
