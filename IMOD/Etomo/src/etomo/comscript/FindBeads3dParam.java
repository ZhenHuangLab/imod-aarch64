...
public final class FindBeads3dParam implements ConstFindBeads3dParam, CommandParam {
  ...
  private final ScriptParameter beadSize =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, BEAD_SIZE_TAG);
  private final EtomoBoolean2 lightBeads = new EtomoBoolean2(LIGHT_BEADS_TAG);
  private final ScriptParameter minRelativeStrength =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, MIN_RELATIVE_STRENGTH_TAG);
  private final ScriptParameter thresholdForAveraging =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, THRESHOLD_FOR_AVERAGING_TAG);
  private final ScriptParameter storageThreshold =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, STORAGE_THRESHOLD_TAG);
  private final ScriptParameter minSpacing =
    new ScriptParameter(EtomoNumber.Type.DOUBLE, MIN_SPACING_TAG);
  ...
  public String getCommandName() {
    ...
    return ProcessName.FIND_BEADS_3D.getText();
  }
