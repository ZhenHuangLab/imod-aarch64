...
public class ConstSetParam {
  ...
  static final EtomoNumber.Type COMBINEFFT_REDUCTION_FACTOR_TYPE =
    EtomoNumber.Type.DOUBLE;
  public static final String COMBINEFFT_LOW_FROM_BOTH_RADIUS_NAME = "combinefft_lowboth";
  public static final EtomoNumber.Type COMBINEFFT_LOW_FROM_BOTH_RADIUS_TYPE =
    EtomoNumber.Type.DOUBLE;
  ...
  String name = "";
  EtomoNumber.Type type;
  EtomoNumber numericValue;
  String value;
  boolean numeric = false;
  boolean valid = true;

  ConstSetParam(String expectedName, EtomoNumber.Type type) {
    this.type = type;
