...
public final class RemapmodelParam implements Command {
  ...
  private ArrayList genOptions() {
    ...
    options.add(buildStartEndString(state.getJoinStartListWalker(trial),
      state.getJoinEndListWalker(trial)));
    options.add("-ToChunkLimits");
    options.add(buildStartEndString(state.getRefineStartListWalker(),
      state.getRefineEndListWalker()));
  ...
  private String buildStartEndString(IntKeyList.Walker startListWalker,
    ...
    while (startListWalker.hasNext()) {
      buffer.append(
        startListWalker.nextEtomoNumber() + "," + endListWalker.nextEtomoNumber());
