...
/*!
 * Sets an offset to subtract from indexes passed to the next call of
 * @@rsSortIndexedFloats@.  This can be used to sort a portion of an array;
 * [offset] should be the index at the start of that portion.
 */
