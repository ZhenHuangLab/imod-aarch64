...
[Field = DifferenceTextFile]
short = text
type = FN
usage = Output file for a copy of the difference statistics
tooltip = 
manpage = Output file for a copy of the difference statistics, which will
still be printed to standard out.  The file will include the header line and
"all" line.
...
[Field = FractionalValues]
short = frac
type = B
usage = Output summary statistics as fractions of the input data range
tooltip = 
manpage = Output an additional line expressing the summary statistics for 
all sections as fractions of the data range of the two input files.
