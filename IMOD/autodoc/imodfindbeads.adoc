...
number of counts.  The program will use successive type numbers and print a
...
option.  Use "-sym 0,0" and -ty "type1,type2" to show two curves, etc.  Add
the option "-ylog 1,10" to spread out the low parts of the histogram.
