...
comment = If 1, create a multiparticle reference. Otherwise, 
...
comment = If 1, use the initial reference at all 
...
comment =  an integer array giving the maximum distances 
...
comment =  an array giving the maximum angle (in degrees) 
...
[Field = flgAbsValue]
comment =  If 1 (default), maximize the absolute value of the 
...
comment = If 1 (default = 0), file names in the volume 
