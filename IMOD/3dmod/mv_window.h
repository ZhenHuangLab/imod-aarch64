...
enum {VFILE_MENU_LOAD, VFILE_MENU_SAVE, VFILE_MENU_SAVEAS, VFILE_MENU_SNAPRGB,
      ...
      VEDIT_MENU_MODELS, VEDIT_MENU_VIEWS, VEDIT_MENU_IMAGE, VEDIT_MENU_ISOSURFACE,
      VEDIT_MENU_SAVE_DOCK, VEDIT_MENU_REOPEN_DOCK,
      VVIEW_MENU_DB, VVIEW_MENU_BOUNDBOX, VVIEW_MENU_CURPNT, VVIEW_MENU_INVERTZ,
      VVIEW_MENU_TRANSBKGD, VVIEW_MENU_LIGHTING, VVIEW_MENU_WIREFRAME, VVIEW_MENU_LOWRES, 
      VVIEW_MENU_STEREO, VVIEW_MENU_DEPTH, VVIEW_MENU_SCALEBAR, VVIEW_MENU_RESIZE,
      VVIEW_MENU_LABELS, 
      VHELP_MENU_MENUS, VHELP_MENU_KEYBOARD, VHELP_MENU_MOUSE, VHELP_MENU_ABOUT,
      LAST_VMENU_ID};
...
class ImodvWindow : public QMainWindow
{
 ...
 public:
  ...
  void fakeResize(int width, int height);
