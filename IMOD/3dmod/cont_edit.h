...
class ContourFrame : public DialogFrame
{
 ...
 public:
  ContourFrame(DockingDialog *parent, int numButtons, const char *labels[], 
               const char *tips[], const char *name = NULL);
  ~ContourFrame() {};
...
class ContourMove : public ContourFrame
{
 ...
 public:
  ContourMove(DockingDialog *parent, const char *name = NULL);
  ~ContourMove() {};
  ...
  void convertAllToggled(bool state);
...
class ContourJoin : public ContourFrame
{
 ...
 public:
  ContourJoin(DockingDialog *parent, const char *name = NULL);
  ~ContourJoin() {};
...
class ContourBreak : public ContourFrame
{
 ...
 public:
  ContourBreak(DockingDialog *parent, const char *name = NULL);
  ~ContourBreak() {};
  void breakCont();
