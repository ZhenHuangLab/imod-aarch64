...
int autox_open(ImodView *vw)
{
  ...
  sTopWin = new DockingDialog(imodDialogManager.parent(IMOD_DIALOG), &imodDialogManager,
                              "Auto Contouring", "autox.html#TOP", 'a', Qt::Window);
  autoWindow = new AutoxWindow(sTopWin, 0);
  ...
  sTopWin->addWidgetToStack(autoWindow);
  sTopWin->setWindowTitle(imodCaption("Auto Cont"));
