 ...
 */
imodvViewsForm::imodvViewsForm(DockingDialog* parent, Qt::WindowFlags fl)
  : QWidget(parent, fl)
{
  mTopWin = parent;
  setupUi(this);
...
void imodvViewsForm::topCloseEvent( QCloseEvent * e )
{
  imodvViewsClosing();
  e->accept();
}
...
void imodvViewsForm::topChangeEvent(QEvent *e)
{
