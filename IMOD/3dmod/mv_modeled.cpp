...
void imodvModelEditDialog(ImodvApp *a, int state)
{
  ...
  sTopWin = new DockingDialog(imodvDialogManager.parent(IMODV_DIALOG), 
                              &imodvDialogManager, "Edit Models", 
                              "modvModelEdit.html#TOP", 'M', Qt::Window);
  med->dia = new imodvModeledForm(sTopWin, 0);
  sTopWin->addWidgetToStack(med->dia);
  setModvDialogTitle(sTopWin, "MV Models");
