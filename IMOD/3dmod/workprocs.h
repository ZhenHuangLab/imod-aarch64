...
class ImodWorkproc : public QObject
{
 ...
 public:
  ...
  void startMenuSwitch();
  void startDlgDockTimer(int dlgClass, int timeout);
  ...
  public slots:
    ...
    void switchMenuTimeout();
    void imodDockTimeout();
    void imodvDockTimeout();
 ...
 private:
  ...
  int mDisplayBusy;
  int mTimerFired;
  QTimer *mDlgDockTimers[2];
  QTime *mDlgDockRunTimes[2];
  int mLastDlgTimeout[2];
};
