 ...
 */
imodvMovieForm::imodvMovieForm(DockingDialog* parent, Qt::WindowFlags fl)
  : QWidget(parent, fl)
{
  mTopWin = parent;
  setupUi(this);
...
void imodvMovieForm::topCloseEvent( QCloseEvent * e )
{
  mvMovieClosing();
  e->accept();
}
...
void imodvMovieForm::topChangeEvent(QEvent *e)
{
