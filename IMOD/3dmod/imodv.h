...
typedef struct __imodv_struct
{
  ...
  int wantWinx, wantWiny;    /* Desired or default size in device pixels */
  ...
  int drawLabels;       /* Draw point labels */
  int linkToSlicer;     /* Flag to link to top slicer */
  int linkSlicerCenter; /* Flag to link center of rotation too */
  int syncObjedToCurObj; /* Flag to synchronize Object Edit obj with model current obj */
