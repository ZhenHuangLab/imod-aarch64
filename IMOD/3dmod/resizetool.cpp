 ...
 *
 *  Copyright (C) 2013-2019 by the Regents of the University of 
...

{
  ...
  diaMaximumWindowSize(deskWidth, deskHeight, Imodv->mainWin);
  XY_PIXEL_TO_DEVICE(Imodv->mainWin->m, deskWidth, deskHeight, deskWidth, deskHeight);
