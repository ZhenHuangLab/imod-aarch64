 ...
 */
MovieController::MovieController(DockingDialog* parent, Qt::WindowFlags fl)
  : QWidget(parent, fl)
{
  mTopWin = parent;
  setupUi(this);
...
void MovieController::topCloseEvent( QCloseEvent * e )
{
  imcClosing();
  e->accept();
}
...
void MovieController::topChangeEvent(QEvent *e)
{
