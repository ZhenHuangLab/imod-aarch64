 ...
 */
imodvControlForm::imodvControlForm(DockingDialog* parent, Qt::WindowFlags fl)
  : QWidget(parent, fl)
{
  mTopWin = parent;
  setupUi(this);
...
void imodvControlForm::topCloseEvent( QCloseEvent *e )
{
  imodvControlClosing();
  e->accept();
}
...
void imodvControlForm::topChangeEvent(QEvent *e)
{
